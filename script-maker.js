...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    var headerColab = [
        ...
        '  [6] QUALITY TAGS    : masterpiece, best quality, very aesthetic, absurdres  ← LUÔN Ở CUỐI',
        '',
        ...
        '',
        SEP50,
        'NEGATIVE PROMPT CHUẨN OFFICIAL:',
        SEP50,
        ...
        '',
        SEP80,
        'PHẦN 2 — TEMPLATE PROMPT DANBOORU (ANIMAGINE XL 3.1)',
        SEP80,
        '',
        'TEMPLATE CHUẨN:',
        ...
        '',
        '  [NEGATIVE: nsfw, lowres, (bad), text, error, fewer, extra, missing,',
        ...
        '  longsword, qi energy slash, dynamic combat stance,',
