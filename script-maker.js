...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    SEP50,
    '',
    '  [IMAGE PROMPT: 1boy, xianxia, wuxia, chinese fantasy,',
    '  black hair, medium length, half-tied, jade hairpin,',
    '  dark brown eyes, calm expression,',
    ...
    '  safe,',
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes,',
    '  lowres, blurry, worst quality, bad anatomy, bad hands,',
    '  extra fingers, missing fingers, deformed face, mutated limbs,',
    '  duplicate, watermark, logo, text, modern objects, chibi]',
    '',
    SEP50,
    'VÍ DỤ 2 — CHIẾN ĐẤU ĐƠN NHÂN VẬT (single combat):',
    SEP50,
    '',
    '  [IMAGE PROMPT: 1boy, xianxia, wuxia, chinese fantasy,',
    '  black hair, topknot, white hanfu, torn sleeve, flowing robes,',
    '  dark brown eyes, battle fury,',
    '  longsword, qi energy slash, sword energy trail,',
    '  dynamic_pose, mid-air, leaping forward,',
    '  stone ruins, broken pillars, debris mid-air,',
    '  speed_lines, motion_blur, qi aura,',
    '  golden backlight, volumetric dust,',
    '  wide shot, full body, dutch_angle, from_below,',
    '  diagonal_composition,',
    '  safe,',
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes,',
    '  portrait, standing still, looking at viewer, simple background,',
    '  upper body only, lowres, bad anatomy, watermark, chibi]',
    '',
    SEP50,
    'VÍ DỤ 3 — TIÊN CẢNH TU LUYỆN (cultivation scene):',
    SEP50,
    '',
    '  [IMAGE PROMPT: 1boy, xianxia, chinese cultivation,',
    '  black hair, long, loose, dark brown eyes, serene expression,',
    '  white hanfu, flowing robes, jade pendant,',
    '  lotus_position, floating, eyes closed,',
    '  mountain peak, sea of clouds, night sky, full moon,',
    '  aura, spiritual energy, glowing particles, light rays,',
    ...
    SEP50,
    '  hanfu / daoist robes / cultivation robes / light armor',
    ...
    '',
    '  VÍ DỤ NHẤT QUÁN:',
    '  Scene 1: 1boy, xianxia, black hair, dark brown eyes,',
    '           white hanfu, jade ring, standing, bamboo courtyard, safe, ...',
    '  Scene 2: 1boy, xianxia, black hair, dark brown eyes,',
    ...
    SEP50,
    '',
    '  ⚠️  LỖI PHỔ BIẾN: model tự ra nhân vật mặc armor đen/vàng kiểu RPG game',
    '  ⚠️  NGUYÊN NHÂN: thiếu tag ép style hanfu + thêm sai tag glowing armor',
    '',
    '  TAGS BẮT BUỘC — STYLE ÉP XIANXIA (THÊM VÀO ĐẦU CONTENT):',
    '    → Style : xianxia, hanfu, chinese fantasy, wuxia',
    '    → KHÔNG dùng: armor, battle armor, glowing eyes (gây RPG bias)',
    '',
    '  TAGS BẮT BUỘC — ĐƠN NHÂN VẬT COMBAT:',
    '    → Pose  : dynamic_pose, action_pose, mid-air / leaping / lunging',
    '    → Camera: wide shot, full body, dutch_angle, from_below',
    '    → FX    : speed_lines, motion_blur, qi energy, sword energy trail',
    '    → Bố cục: diagonal_composition',
    '',
    '  TAGS BẮT BUỘC — NHIỀU NHÂN VẬT / CHIẾN TRƯỜNG:',
    '    → Số lượng : 2boys / multiple boys / group of warriors / 6+boys',
    '    → Tương tác: versus, battle, clash, surrounded, attacking from all sides',
    '    → Chiến trường: battlefield, army, war scene, large scale battle',
    '    → Camera   : wide shot, panoramic, epic scale',
    '',
    '  TAGS BẮT BUỘC — RỐI CHIẾN ĐẤU (Từ Phàm puppet master):',
    '    → puppet master, string puppets, marionette warriors',
    '    → puppet army, multiple puppets, puppet combat formation',
    '    → puppets wielding swords, puppets surrounding beast',
    '    → KHÔNG dùng 1boy đơn độc — dùng: 1boy surrounded by puppets',
    '',
    '  TAGS BẮT BUỘC — THÚ VẬT / QUÁI VẬT:',
    '    → giant beast / demon beast / monster',
    '    → beast vs multiple fighters / surrounded by warriors',
    '    → claws / fangs / roaring / lunging beast',
    '    → KHÔNG dùng 1boy đơn độc — dùng: creature vs warrior',
    '',
    '  NEGATIVE BẮT BUỘC LOẠI A:',
    '    battle armor, metal armor, full armor, glowing eyes,',
    '    portrait, upper body only, standing still, looking at viewer,',
    '    facing viewer, simple background, centered composition,',
    '    single character (khi cần nhiều nhân vật)',
    '',
    '  VÍ DỤ A1 — ĐƠN NHÂN VẬT COMBAT CHUẨN XIANXIA:',
    '  [IMAGE PROMPT: 1boy, xianxia, wuxia, chinese fantasy,',
    '  black hair, topknot, white hanfu, torn sleeve, flowing robes,',
    '  dark brown eyes, battle fury,',
    '  longsword, qi energy slash, sword energy trail,',
    ...
    '  safe,',
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes, portrait,',
    '  standing still, looking at viewer, simple background,',
    '  upper body only, lowres, bad anatomy, watermark, chibi]',
    '',
    '  VÍ DỤ A2 — RỐI VÂY QUANH YÊU THÚ (puppet master scene):',
    '  [IMAGE PROMPT: xianxia, chinese fantasy, wuxia,',
    '  giant lion demon beast, roaring, center frame,',
    '  1boy, black hair, white hanfu, puppet master, controlling strings,',
    '  puppet army, 4 string puppets, marionette warriors,',
    '  puppets wielding sword spear blade,',
    '  attacking from all sides, surrounded, multi-directional assault,',
    '  dynamic_pose, wide shot, full body, action_pose,',
    '  ancient ruins battlefield, debris mid-air, dust clouds,',
    '  speed_lines, motion_blur, qi energy,',
    '  golden backlight, dramatic lighting, volumetric dust,',
    '  dutch_angle, from_below, diagonal_composition,',
    '  safe,',
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes,',
    '  single character, portrait, close-up face,',
    '  standing still, looking at viewer, simple background,',
    '  lowres, bad anatomy, watermark, chibi]',
    '',
    '  VÍ DỤ A3 — CHIẾN TRƯỜNG NHIỀU NGƯỜI (large scale battle):',
    '  [IMAGE PROMPT: xianxia, chinese fantasy, wuxia,',
    '  large scale battle, multiple warriors, group of fighters,',
    '  white hanfu army vs black robes army,',
    '  swords clashing, qi energy explosion, battle clash,',
    '  dynamic_pose, action_pose, attacking, surrounded,',
    '  mountain battlefield, war scene, epic scale,',
    '  speed_lines, motion_blur, dust clouds, debris,',
    '  dramatic backlight, golden hour, volumetric light,',
    '  wide shot, panoramic, aerial view, diagonal_composition,',
    '  safe,',
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes,',
    '  portrait, single character, close-up, standing still,',
    '  simple background, lowres, bad anatomy, watermark, chibi]',
    '',
    SEP50,
    'LOẠI B — DRAMATIC MOMENT (đối đầu, cao trào cảm xúc):',
    SEP50,
    '',
    '  TAGS BẮT BUỘC THÊM VÀO CONTENT:',
    '    → Style: xianxia, wuxia, hanfu (BẮT BUỘC — tránh RPG bias)',
    '    → Pose : tense stance, battle ready, facing away, clenched fist',
    '    → Camera: cowboy shot / medium shot, from_below / from_side',
    '    → FX   : emphasis_lines, qi aura, wind, hair blowing',
    '    → Bố cục: negative_space, depth of field',
    '',
    '  VÍ DỤ DRAMATIC:',
    '  [IMAGE PROMPT: 1boy, xianxia, wuxia, chinese fantasy,',
    '  black hair, long, windswept, dark brown eyes, cold expression,',
    '  white hanfu, silver embroidery, flowing robes,',
    '  tense stance, battle ready, sword at side, clenched fist,',
    '  cliff edge, stormy sky, lightning distant,',
    '  emphasis_lines, qi aura, hair blowing in wind,',
    '  from_below, cowboy shot, depth of field, negative_space,',
    '  safe,',
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes,',
    '  portrait, simple background, looking at viewer,',
    '  lowres, bad anatomy, watermark, chibi]',
    '',
    SEP50,
    ...
    '',
    '  VÍ DỤ EMOTION:',
    '  [IMAGE PROMPT: 1boy, xianxia, chinese fantasy,',
    '  black hair, dark brown eyes, sad expression, looking down,',
    '  white hanfu, flowing robes, jade ring,',
    ...
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes,',
    '  lowres, bad anatomy, watermark, chibi, nsfw]',
    '',
    SEP50,
    ...
    '    → FX   : qi aura, spiritual energy, glowing particles, light rays',
    ...
    '  lotus_position, floating, eyes closed,',
    '  mountain peak, sea of clouds, night sky, full moon,',
    '  qi aura, spiritual energy, glowing particles, light rays,',
    '  wide shot, full body, slightly below eye level,',
    '  safe,',
    '  year 2025, masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: battle armor, metal armor, glowing eyes,',
    ...
    '',
    'NGUYÊN TẮC VÀNG:',
    '  Loại A + B → LUÔN có: xianxia, hanfu, wide shot, full body, dynamic_pose',
    '  Loại A + B → LUÔN có trong NEGATIVE: battle armor, metal armor,',
    '               glowing eyes, portrait, standing still, looking at viewer',
    '',
    SEP80,
