...
var headerUniversal = [
    SEP80,
    '╔══════════════════════════════════════════════════════════════════════════════╗',
    '║     IMAGE PROMPT GENERATION FILE — UNIVERSAL VERSION v5.1 (77 TOKEN)         ║',
    ...
    '',
    SEP80,
    'PHẦN 2 — CẤU TRÚC PROMPT CHUẨN (GIỚI HẠN 77 TOKEN = ~65 TỪ ACTIVE)',
    SEP80,
    '',
    '⚠️ ANIMAGINE XL 3.1 CHỈ XỬ LÝ 75 TOKEN ĐẦU CÓ TRỌNG SỐ ĐẦY ĐỦ',
    '   Prompt dài hơn KHÔNG bị lỗi nhưng phần sau 75 token bị GIẢM TRỌNG SỐ.',
    '   Chiến lược: Đặt thông tin QUAN TRỌNG NHẤT vào 65 từ ĐẦU TIÊN.',
    '',
    'THỨ TỰ ƯU TIÊN BẮT BUỘC (tổng ~120-150 từ, KHÔNG vượt 150 từ):',
    '',
    '  [1] MODEL TAG (bắt buộc đầu tiên):',
    '      [MODEL:animagine]',
    '',
    '  [2] STYLE 3D TAGS (15-20 từ) ← ĐẶT NGAY SAU MODEL TAG:',
    '      Chinese xianxia CG art style, 3D render style,',
    '      cel shading with depth, volumetric lighting,',
    '      subsurface scattering on skin, vivid saturated colors',
    '',
    '  [3] SUBJECT + ACTION (15-20 từ):',
    '      Giới tính + tư thế + hành động cụ thể',
    '      ✅ ĐÚNG: "young male standing in dynamic battle-ready stance,',
    '      right arm extended gripping sword hilt"',
    '',
    '  [4] APPEARANCE — TỐI ĐA 20 TỪ (chỉ giữ các điểm nhận diện):',
    '      ✅ GIỮ: hair color+style, eye color, outfit color, 1 unique mark',
    '      ❌ BỎ: mọi tính từ bổ sung ("delicate", "graceful", "luminous"...)',
    '      ❌ BỎ: mô tả chi tiết vải, chất liệu, phụ kiện phức tạp',
    '',
    '  [5] SETTING (10-15 từ):',
    '      Địa điểm chính + thời gian/thời tiết — CHỈ từ khóa, không câu dài',
    '',
    '  [6] LIGHTING KEY (10-15 từ):',
    '      Chỉ giữ: nguồn sáng + hướng + 1 hiệu ứng chính + màu tương phản',
    '',
    '  [7] COMPOSITION (5-8 từ):',
    '      Camera angle + depth of field — cực ngắn gọn',
    '',
    '  [8] QUALITY + NO-TEXT (10-15 từ):',
    '      masterpiece, best quality, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    '      NO text, NO watermark, pure illustration only',
    '',
    'TỔNG MỤC TIÊU: 65-80 từ ACTIVE + 40-60 từ bổ sung (tổng ~120-150 từ)',
    '',
    SEP80,
    'PHẦN 2.5 — TỪ KHÓA ÁNH SÁNG 3D CHO ANIMAGINE (NGẮN GỌN HƠN)',
    SEP80,
    '',
    '★ ÁNH SÁNG QUYẾT ĐỊNH 70% CHẤT LƯỢNG ẢNH — MÔ TẢ TỐI ĐA 15 TỪ ★',
    '',
    'CÔNG THỨC ÁNH SÁNG 4 BƯỚC (RÚT GỌN):',
    '  B1: NGUỒN  → golden sunlight / cold moonlight / blue energy',
    '  B2: HƯỚNG  → from behind and above / from side / from below',
    '  B3: HIỆU ỨNG → volumetric god rays / rim lighting / deep shadows',
    '  B4: MÀU    → warm amber vs cool blue / vivid contrast',
    '',
    '✅ VÍ DỤ CHUẨN:',
    '  "volumetric god rays from behind, dramatic rim light halo, warm amber vs cool blue"',
    '',
    SEP80,
    'PHẦN 3 — VÍ DỤ MẪU ANIMAGINE 3D STYLE (CHUẨN 77 TOKEN)',
    SEP80,
    '',
    SEP50,
    'VÍ DỤ 1: TIÊN HIỆP TU LUYỆN (~73 từ active, tổng ~110 từ)',
    SEP50,
    '',
    ...
    'female cultivator sitting in lotus meditation pose on floating jade platform,',
    'young woman, long silver hair in high bun with golden phoenix pins,',
    'silver-white translucent immortal robes, jade pendant at chest,',
    'seated gracefully with both hands forming mudra at chest level,',
    'endless sea of clouds below, floating islands with jade pavilions in distance,',
    'transcendent ethereal atmosphere, volumetric god rays from behind and above,',
    'divine rim light halo around figure, cool blue ambient mixing with warm golden highlights,',
    'epic wide shot from slightly below, deep depth of field,',
    'thousands of glowing cyan spirit particles floating,',
    'masterpiece, best quality, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, pure illustration only]',
    '[NEGATIVE: lowres, flat shading, flat colors, soft watercolor wash,',
    'watercolor texture, pastel flat tones, bad anatomy, bad hands, text, error,',
    'worst quality, low quality, blurry, ugly, 2D flat art, dull colors]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP50,
    'VÍ DỤ 2: KIẾM HIỆP CHIẾN ĐẤU (~71 từ active, tổng ~110 từ)',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine]',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering on skin, vivid saturated colors,',
    'young male warrior in explosive mid-combat sword slash stance,',
    'medium black hair tied with white ribbon, dark brown eyes blazing with fury,',
    'white hanfu with blue embroidery trim, torn right sleeve, jade pendant glowing,',
    'right arm extended with gleaming silver longsword, crescent cyan qi energy blade,',
    'ancient stone ruins battlefield, cracked ground beneath feet, high-stakes battle atmosphere,',
    'intense volumetric light from golden sunlight through debris clouds right side,',
    'harsh rim light along figure edge, warm amber vs cool blue contrast,',
    'extreme low angle hero shot, diagonal dynamic composition, shallow depth of field,',
    'motion blur speed streaks on sword trajectory, cyan spirit particles exploding,',
    'masterpiece, best quality, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, pure illustration only]',
    '[NEGATIVE: lowres, flat shading, flat colors, soft watercolor wash,',
    'watercolor texture, pastel flat tones, bad anatomy, bad hands, text, error,',
    ...
    '',
    SEP50,
    'VÍ DỤ 3: CẢNH QUAN HOÀNH TRÁNG (~68 từ active, tổng ~105 từ)',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine]',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering, vivid saturated colors,',
    'breathtaking panoramic view of vast xianxia mountain world,',
    'hundreds of jagged jade-green peaks stretching to horizon,',
    'ancient sect buildings with golden curved rooftops on cliffsides,',
    'massive waterfalls cascading into mist-filled chasms,',
    'glowing spiritual energy veins pulsing blue-white through rock,',
    'enormous dragon soaring through golden clouds in distance,',
    'twilight sky with twin glowing moons rising, epic grand xianxia world-building atmosphere,',
    'volumetric god rays from twin suns piercing cloud formations from behind,',
    'warm golden-orange light on peaks, cool blue-purple shadows in valleys,',
    'epic ultra-wide panoramic aerial shot from high altitude, extreme deep depth of field,',
    'golden light particles and spirit wisps floating throughout,',
    'masterpiece, best quality, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, pure illustration only]',
    '[NEGATIVE: lowres, flat shading, flat colors, soft watercolor wash,',
    'watercolor texture, pastel flat tones, bad anatomy, text, error,',
    'worst quality, low quality, blurry, 2D flat art, overexposed white sky]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP80,
    'PHẦN 4 — HƯỚNG DẪN THEO CÁC THỂ LOẠI (RÚT GỌN TỪ KHÓA)',
    SEP80,
    '',
    'LUÔN BẮT ĐẦU VỚI:',
    '  "Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    '   volumetric lighting, subsurface scattering, vivid saturated colors"',
    '',
    'SAU ĐÓ THÊM 1-2 TỪ KHÓA ĐẶC TRƯNG TÙY THỂ LOẠI:',
    '• Tiên Hiệp: floating jade platforms, glowing spirit particles, ethereal aura',
    '• Kiếm Hiệp: dynamic action blur, visible qi energy trails, intense battle tension',
    '• Lãng mạn: soft golden hour light, gentle bokeh depth, warm vivid tones',
    '• Kinh dị: high contrast chiaroscuro, cold moonlight, deep dramatic shadows',
    '• Cyberpunk: vibrant neon lights, holographic glow, cyberpunk aesthetic',
    '',
    SEP80,
    'PHẦN 5 — QUY TẮC NHÂN VẬT NHẤT QUÁN (CHUẨN 77 TOKEN)',
    SEP80,
    '',
    'CHARACTER SHEET — XÂY 1 LẦN, DÙNG MÃI:',
    'Mỗi nhân vật cần 1 chuỗi APPEARANCE cố định tối đa 20 từ:',
    '',
    '  FORMAT: [gender], [hair: color+style], [eyes: color],',
    '          [outfit: color+material+1 detail], [1 unique mark]',
    '',
    '  VÍ DỤ TỐT (19 từ):',
    '  "young male, long silver hair in high ponytail, violet eyes,',
    '  white silk hanfu with blue trim, silver dragon scar on left cheek"',
    '',
    '  VÍ DỤ XẤU (quá dài — bị cắt):',
    '  "a young man with long flowing silver-white hair elegantly tied',
    '  in a high ponytail secured by golden hairpin, with deep violet eyes...',
    '',
    'QUY TẮC COPY-PASTE:',
    '  → Lần 1 xuất hiện: dùng đầy đủ 20 từ',
    '  → Lần 2 trở đi: COPY Y CHANG chuỗi 20 từ đó — CHỈ đổi action/pose',
    '  → TUYỆT ĐỐI KHÔNG paraphrase hay thay đồng nghĩa',
    '',
    '★ Nhất quán nhân vật = dùng CÙNG MỘT CHUỖI TỪ — không phải cùng ý nghĩa ★',
    '',
    SEP80,
    ...
    '  worst quality, low quality, blurry, ugly, 2D flat art, dull colors]',
    '',
    '━━ RULE 4: STYLE 3D LUÔN ĐỨNG ĐẦU ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Phải nằm NGAY SAU [MODEL:animagine]:',
    '  Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    '  volumetric lighting, subsurface scattering on skin, vivid saturated colors',
    '',
    '━━ RULE 5: ĐỘ DÀI PROMPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Mục tiêu: 65-80 từ ACTIVE (trong 75 token đầu) — tổng prompt 120-150 từ',
    '❌ KHÔNG vượt 150 từ — phần dư bị giảm trọng số, gây loãng style',
    '✅ Ưu tiên: Style Tags → Subject → Appearance (20 từ) → Setting → Lighting',
    '',
    SEP80,
    ...
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering on skin, vivid saturated colors,',
    '[SUBJECT + ACTION 15-20 từ: nhân vật + hành động cụ thể],',
    '[APPEARANCE max 20 từ: giới tính, tóc, mắt, trang phục, 1 đặc điểm],',
    '[SETTING 10-15 từ: địa điểm chính, thời gian, thời tiết],',
    '[LIGHTING 10-15 từ: nguồn sáng, hướng, hiệu ứng, màu tương phản],',
    '[COMPOSITION 5-8 từ: góc máy, depth of field],',
    'masterpiece, best quality, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, pure illustration only]',
    '[NEGATIVE: lowres, flat shading, flat colors, soft watercolor wash,',
    'watercolor texture, pastel flat tones, bad anatomy, bad hands, text, error,',
    ...
    SEP80,
    '',
    '━━ WORKFLOW A: GENSPARK AI AGENT / CHATGPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: Thay TẤT CẢ [MODEL:animagine] → [MODEL:gpt-image-2]',
    'B2: Paste lệnh + toàn bộ file TXT để AI tự động generate',
    '',
    '━━ WORKFLOW B: GEMINI ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: Thay TẤT CẢ model tag → [MODEL:imagen3]',
    'B2: Paste từng block và yêu cầu generate',
    '',
    '━━ WORKFLOW C: COLAB SDXL ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: GIỮ NGUYÊN [MODEL:animagine] trong file, upload lên Drive',
    'B2: Chạy Colab notebook, ảnh tự động lưu với tên đúng',
    '',
    SEP80,
    'TÓM TẮT NHANH — 5 ĐIỂM QUAN TRỌNG NHẤT v5.1 (77 TOKEN)',
    SEP80,
    '',
    '1. STYLE LÊN ĐẦU: "Chinese xianxia CG art..., vivid saturated colors" ngay sau Model',
    '2. NHÂN VẬT GỌN: Tối đa 20 từ cho ngoại hình, copy y chang cho các lần sau',
    '3. NGẮN GỌN: Tổng prompt KHÔNG QUÁ 150 từ, tập trung 75 token đầu',
    '4. ÁNH SÁNG CHẮT LỌC: Chỉ 10-15 từ (nguồn, hướng, hiệu ứng, màu)',
    '5. NEGATIVE RÚT GỌN: Bắt buộc có flat shading, watercolor, dull colors, 2D flat art',
    '',
    SEP80,
    'BẮT ĐẦU XỬ LÝ — ĐỌC TOÀN BỘ FILE, XÂY CHARACTER SHEET, VIẾT PROMPT THEO TEMPLATE',
    SEP80,
    ''
];
