...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    SEP80,
    '╔══════════════════════════════════════════════════════════════════════════════╗',
    '║      IMAGE PROMPT GENERATION FILE — UNIVERSAL VERSION v3.0                ║',
    ...
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  COLAB SDXL (hs-ultrahd-cg-ill-epic-sdxl / dreamshaper-xl):               │',
    '│    → GIỮ NGUYÊN tag [MODEL:epic] hoặc [MODEL:dream]                       │',
    ...
    '│    → Thay TẤT CẢ model tag → [MODEL:gpt-image-1]                         │',
    ...
    '├───────────────────────────────────┬────────────────────────────────────────┤',
    '│  [MODEL:epic]                     │  [MODEL:dream]                         │',
    '│  hs-ultrahd-cg-ill-epic-sdxl      │  dreamshaper-xl-1-0                    │',
    '│  (Illustrious-XL base — CG Art)   │  (SDXL base — Semi-realistic)          │',
    '├───────────────────────────────────┼────────────────────────────────────────┤',
    '│  Cảnh thiên nhiên / landscape     │  Portrait nhân vật cận cảnh            │',
    '│  Chiến đấu / battle scene         │  Lãng mạn / cảm xúc nội tâm           │',
    '│  Tiên hiệp / tu tiên              │  Cận cảnh khuôn mặt / biểu cảm        │',
    '│  Kiếm hiệp / đại cảnh wuxia       │  Đời thường / slice of life            │',
    '│  Dark fantasy / demon realm       │  Lãng mạn cổ trang / hiện đại         │',
    '│  Chiến tranh / sử thi             │  Portrait đơn độc / nhân vật chính     │',
    '│  Kinh dị / horror environment     │  Cảnh nhẹ nhàng / gia đình / học đường │',
    '│  Sci-fi / cyberpunk cityscape     │  Gặp gỡ / hội thoại giữa 2 người      │',
    '└───────────────────────────────────┴────────────────────────────────────────┘',
    '',
    ...
    SEP80,
    '',
    'MỖI PROMPT PHẢI CÓ ĐỦ 8 THÀNH PHẦN (viết thành 1 đoạn liền mạch):',
    '',
    '  [1] MODEL TAG      — Bắt buộc đầu tiên: [MODEL:epic] hoặc [MODEL:dream]',
    '  [2] SUBJECT        — Chủ thể: nhân vật, vật thể, hoặc cảnh quan',
    '  [3] ACTION/POSE    — Hành động, tư thế, biểu cảm',
    '  [4] APPEARANCE     — Tóc, mắt, trang phục, đặc điểm nhận diện',
    '  [5] SETTING        — Địa điểm, thời gian, thời tiết',
    '  [6] ATMOSPHERE     — Không khí, cảm xúc, ánh sáng, màu sắc chủ đạo',
    '  [7] COMPOSITION    — Góc máy, framing, độ sâu tiêu điểm',
    '  [8] STYLE+QUALITY  — Phong cách nghệ thuật + quality tags + NO text + NEGATIVE',
    '',
    '── VÍ DỤ — Kiếm hiệp chiến đấu (Colab: [MODEL:epic]) ───────────────────────────',
    '  [IMAGE PROMPT: [MODEL:epic] A young male warrior in explosive mid-combat stance,',
    '  right arm swinging silver longsword with visible sword energy qi slash arc,',
    '  medium-length black hair tied with white ribbon whipping violently in wind,',
    '  sharp determined dark brown eyes burning with battle focus, lean athletic build,',
    '  white hanfu with blue embroidery trim torn at sleeve from previous clash,',
    '  debris and dust clouds exploding outward, ancient stone ruins battlefield,',
    '  dramatic battle atmosphere, golden sunset light cutting through dust and smoke,',
    '  extreme low angle looking up, diagonal dynamic composition, subject dominant,',
    '  Chinese wuxia epic CG art, dramatic volumetric lighting, god rays,',
    '  strong light-shadow contrast, Illustrious XL CG style,',
    ...
    '  NO subtitles, NO UI elements, NO logo, NO signature]',
    ...
    '  signature, watermark, blurry, ugly, deformed face, extra limbs,',
    '  soft watercolor, flat lighting, overexposed white, bright clean tones]',
    '  [FILE: scene_04520.452s.jpg]',
    '',
    '── VÍ DỤ — Tiên hiệp tu luyện (Colab: [MODEL:epic]) ───────────────────────────',
    '  [IMAGE PROMPT: [MODEL:epic] A celestial female cultivator sitting cross-legged',
    '  on a floating jade island, in deep meditation, hands forming lotus seal mudra,',
    ...
    '  transcendent ethereal atmosphere, cool blue-white god rays with golden accents,',
    '  bird eye wide shot, vast sky composition, subject small against infinite heavens,',
    '  Chinese xianxia fantasy epic CG art, mystical celestial atmosphere,',
    '  glowing immortal qi energy, dramatic volumetric lighting, Illustrious XL CG style,',
    '  masterpiece, best quality, ultra-detailed, 8K resolution,',
    '  horizontal landscape orientation, 16:9 aspect ratio,',
    '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    '  NO subtitles, NO UI elements, NO logo, NO signature]',
    '  [NEGATIVE: lowres, bad anatomy, bad hands, text, error, cropped,',
    '  worst quality, low quality, jpeg artifacts, signature, watermark,',
    '  blurry, deformed face, extra limbs, bad proportions,',
    '  soft watercolor wash, flat lighting, bright clean tones, flat anime]',
    '  [FILE: scene_01230.500s.jpg]',
    '',
    '── VÍ DỤ — Kinh dị (Colab: [MODEL:epic]) ──────────────────────────────────────',
    '  [IMAGE PROMPT: [MODEL:epic] An abandoned Victorian mansion at dead road end,',
    '  all windows dark except one glowing pale green on the third floor,',
    '  bare twisted trees surrounding, thick fog crawling on ground,',
    '  small silhouette of child standing motionless at the gate,',
    '  suffocating dread supernatural atmosphere, cold blue-green moonlight through fog,',
    '  wide establishing shot, low horizon line, symmetrical composition,',
    '  dark gothic horror epic CG art, high contrast chiaroscuro,',
    '  dramatic volumetric fog, deep atmospheric depth, Illustrious XL CG style,',
    '  masterpiece, best quality, ultra-detailed, 8K resolution,',
    '  horizontal landscape orientation, 16:9 aspect ratio,',
    '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    '  NO subtitles, NO UI elements, NO logo, NO signature]',
    '  [NEGATIVE: lowres, text, error, cropped, worst quality, low quality,',
    '  jpeg artifacts, signature, watermark, daylight, bright colors,',
    '  cheerful, flat lighting, overexposed, soft watercolor]',
    '  [FILE: scene_00845.200s.jpg]',
    '',
    '── VÍ DỤ — Lãng mạn (Colab: [MODEL:dream]) ─────────────────────────────────',
    '  [IMAGE PROMPT: [MODEL:dream] A beautiful young woman sitting alone',
    '  at a rainy cafe window at night, chin resting on hand,',
    '  gazing melancholically at raindrops on the glass,',
    '  long straight dark brown hair, big expressive sad eyes,',
    '  wearing cream-colored oversized knit sweater,',
    '  warm amber cafe interior with bokeh city lights through window,',
    '  nostalgic bittersweet atmosphere, soft warm lighting with cool rain contrast,',
    '  medium close-up shot, shallow depth of field, subject slightly off-center,',
    '  dreamshaper style, semi-realistic portrait, cinematic soft lighting,',
    '  intricate detail, emotional depth, romantic color grading,',
    '  masterpiece, best quality, ultra-detailed, 8K resolution,',
    '  horizontal landscape orientation, 16:9 aspect ratio,',
    '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    '  NO subtitles, NO UI elements, NO logo, NO signature]',
    '  [NEGATIVE: lowres, bad anatomy, text, error, cropped, worst quality,',
    '  low quality, jpeg artifacts, signature, watermark, blurry,',
    '  deformed face, flat lighting, overexposed white]',
    '  [FILE: scene_02100.000s.jpg]',
    '',
    SEP80,
    ...
    'Colab model: [MODEL:epic] cho MỌI cảnh kiếm hiệp — chiến đấu lẫn phong cảnh',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Ngoại lệ portrait: [MODEL:dream] nếu chỉ cận mặt nhân vật đơn lẻ',
    'Art style: Chinese wuxia epic CG art, dynamic action lines, dramatic volumetric lighting,',
    '           god rays, strong light-shadow contrast, Illustrious XL CG style',
    'Màu sắc: đỏ thẫm, vàng đồng, xanh ngọc, trắng, đen — cinematic dark rich tones',
    'TRÁNH: bright clean tones, soft watercolor wash, flat anime style',
    ...
    'Đặc biệt: aura glow (khí công), sword energy slash, robes flowing in wind',
    '',
    SEP50,
    'B. TIÊN HIỆP / TU TIÊN (Xianxia / Cultivation)',
    SEP50,
    'Nhận biết: tu luyện, linh khí, đột phá cảnh giới, tiên giới, linh đan, tông môn',
    'Colab model: [MODEL:epic] cho MỌI cảnh tiên hiệp',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Ngoại lệ portrait: [MODEL:dream] nếu chỉ cận mặt tu sĩ/tiên nhân đơn lẻ',
    'Art style: Chinese xianxia fantasy epic CG art, mystical celestial atmosphere,',
    '           glowing immortal qi energy, dramatic volumetric lighting,',
    '           god rays, Illustrious XL CG style',
    'Màu sắc: xanh lam thiên thanh, vàng kim, trắng ngà, tím huyền bí — deep rich glow',
    'TRÁNH: soft watercolor wash, bright clean tones, flat 2D illustration',
    ...
    'Đặc biệt: linh khí xoáy vào đan điền, ngũ hành hào quang, đột phá thiên lôi',
    '',
    SEP50,
    'C. HỆ THỐNG / ISEKAI / NHẬP VÀO TRUYỆN',
    SEP50,
    'Nhận biết: hệ thống, level up, nhiệm vụ, rương thưởng, dị giới, dungeon',
    'Colab model: [MODEL:epic] isekai cảnh rộng/chiến đấu — [MODEL:dream] portrait nhân vật',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: epic CG illustration, fantasy digital art, dramatic cinematic lighting,',
    '           Illustrious XL CG style (epic) / dreamshaper semi-realistic (dream)',
    'Màu sắc: xanh điện holographic, vàng hệ thống, tím huyền, ánh sáng tương phản mạnh',
    ...
    'Đặc biệt: UI holographic window (NO số/chữ thực), skill glow, summoning circle',
    '',
    SEP50,
    'D. LÃNG MẠN / NGÔN TÌNH HIỆN ĐẠI',
    SEP50,
    'Nhận biết: CEO, tình yêu, hôn nhân, tình tam giác, ký ức, gặp lại người xưa',
    'Colab model: [MODEL:dream] cho portrait/cảm xúc — [MODEL:epic] cho cảnh nền đô thị',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: dreamshaper style, semi-realistic portrait, cinematic soft lighting,',
    '           bokeh background, romantic color grading, emotional depth',
    'Màu sắc: pastel ấm (hồng, be, vàng nhạt), bokeh lấp lánh, ánh hoàng hôn',
    'Trang phục: thời trang đô thị hiện đại, vest nam lịch lãm, váy nữ thanh lịch',
    'Bối cảnh: café, văn phòng cao tầng, công viên mùa anh đào, ban công thành phố',
    'Đặc biệt: sakura petals flying, bokeh city lights, rain on window, soft lens flare',
    '',
    SEP50,
    'E. CỔ ĐẠI / LỊCH SỬ / CUNG ĐẤU',
    SEP50,
    'Nhận biết: hoàng cung, hậu cung, phi tần, thái tử, âm mưu, tranh sủng',
    'Colab model: [MODEL:epic] cung điện/đại cảnh/chiến trường — [MODEL:dream] chân dung',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: Ancient Chinese historical epic CG art, imperial grandeur,',
    '           palatial architectural magnificence, dramatic cinematic lighting,',
    '           Illustrious XL CG style (epic) / dreamshaper portrait detail (dream)',
    'Màu sắc: đỏ cung đình, vàng hoàng gia, xanh ngọc bích, tím cao quý — rich deep tones',
    'Trang phục: phụng bào, long bào, trâm cài tóc, kiềng ngọc',
    'Bối cảnh: hậu cung lộng lẫy, thái hòa điện, vườn ngự, hành lang cột đỏ',
    'Đặc biệt: candle flame glow, incense smoke, peony petals falling, golden throne light',
    '',
    SEP50,
    'F. KINH DỊ / LIÊU TRAI / MA QUỶ',
    SEP50,
    'Nhận biết: hồn ma, ám ảnh, ngôi nhà bỏ hoang, bóng tối, thực thể không tên',
    'Colab model: [MODEL:epic] cho cảnh kinh dị — [MODEL:dream] chân dung nhân vật bị ám',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: dark gothic horror epic CG art, high contrast chiaroscuro,',
    '           dramatic volumetric fog, deep atmospheric depth, Illustrious XL CG style',
    'Màu sắc: xám tro, xanh lạnh tử thi, đỏ máu, trắng xương — KHÔNG pitch black vô chi tiết',
    'Trang phục: quần áo cũ rách, váy trắng ma nữ, đồ tang, áo mưa ướt',
    'Bối cảnh: nhà hoang Victorian, nghĩa địa sương mù, hành lang bệnh viện bỏ hoang',
    'Đặc biệt: shadow entity méo mó, bàn tay từ bóng tối, gương phản chiếu sai thực tế',
    '',
    SEP50,
    'G. HÀNH ĐỘNG / CHIẾN TRANH / QUÂN SỰ',
    SEP50,
    'Nhận biết: chiến trận, binh lính, vũ khí, chỉ huy, chiến lược, hy sinh',
    'Colab model: [MODEL:epic] cho MỌI cảnh chiến tranh — [MODEL:dream] chân dung tướng lĩnh',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: epic war cinematic CG art, massive battlefield scale,',
    '           dramatic fire and smoke atmosphere, Illustrious XL CG style',
    'Màu sắc: xám thép, nâu đất, đỏ lửa, khói đen — war-torn muted cinematic tones',
    'Trang phục: áo giáp kim loại hoặc quân phục, mũ giáp, vũ khí',
    ...
    'Colab model: [MODEL:epic] cảnh crime — [MODEL:dream] chân dung thám tử/nghi phạm',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: noir detective epic CG art, dramatic shadows, high contrast film noir,',
    '           cinematic dark atmosphere, Illustrious XL CG style',
    ...
    'Đặc biệt: single overhead light deep shadows, rain reflection wet pavement',
    '',
    SEP50,
    'I. KHOA HỌC VIỄN TƯỞNG / SCI-FI / CYBERPUNK',
    SEP50,
    'Nhận biết: tương lai, robot, AI, tàu vũ trụ, du hành thời gian, ngoài hành tinh',
    'Colab model: [MODEL:epic] sci-fi landscape/cityscape — [MODEL:dream] portrait cyborg',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: sci-fi epic CG concept art, futuristic technology grandeur,',
    '           bioluminescent atmosphere, Illustrious XL CG style (epic)',
    '           / dreamshaper cyberpunk portrait (dream)',
    ...
    'Đặc biệt: holographic interface, particle engine trails, nebula background',
    '',
    SEP50,
    'J. GIA ĐÌNH / ĐỜI THƯỜNG / SLICE OF LIFE',
    SEP50,
    'Nhận biết: gia đình, cuộc sống thường ngày, nấu ăn, học đường, tình cảm bình dị',
    'Colab model: [MODEL:dream] cho MỌI cảnh đời thường — [MODEL:epic] cảnh thiên nhiên',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: dreamshaper style, warm slice-of-life semi-realistic illustration,',
    '           soft cinematic lighting, cozy natural colors',
    ...
    'Colab model: [MODEL:epic] cho MỌI cảnh dark fantasy — [MODEL:dream] portrait pháp sư',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: dark fantasy epic CG art, dramatic magical volumetric lighting,',
    '           ominous demonic atmosphere, Illustrious XL CG style',
    'Màu sắc: đen tím thẫm, xanh đêm, ánh sáng ma thuật tương phản mạnh — deep dark tones',
    'Trang phục: áo choàng ma pháp dài với rune, mũ phù thủy, enchanted armor',
    'Bối cảnh: tháp ma thuật, nghi trận summoning, rừng chết cây khô, lâu đài vách đá',
    ...
    'Colab model: [MODEL:epic] cảnh tận thế — [MODEL:dream] portrait survivor',
    'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
    'Art style: post-apocalyptic epic CG art, gritty cinematic realism,',
    '           desaturated dramatic palette, Illustrious XL CG style',
    ...
    'Đặc biệt: overgrown vines on buildings, ash falling like snow, broken glass, distant fire',
    '',
    SEP80,
    'PHẦN 4 — HƯỚNG DẪN 14 LOẠI CẢNH VÀ GÓC MÁY',
    SEP80,
    '',
    '1.  GIỚI THIỆU NHÂN VẬT LẦN ĐẦU',
    '    → Full body shot, rõ ngoại hình đầu đến chân, pose ấn tượng khắc họa tính cách',
    '    → Mô tả đủ: màu tóc, màu mắt, chiều cao, trang phục, vũ khí/đạo cụ',
    '    Tag: full body portrait, character introduction shot, iconic pose',
    '',
    '2.  CHIẾN ĐẤU / HÀNH ĐỘNG CAO TRÀO',
    ...
    '    Tag: explosive action scene, dynamic diagonal composition, motion blur, impact shockwave',
    '',
    '3.  TÂM TÌNH / CẢM XÚC / NỘI TÂM',
    '    → Close-up hoặc medium close-up mặt, biểu cảm rõ ràng, ánh mắt là trọng tâm',
    '    → Shallow depth of field, bokeh background, soft lighting',
    '    Tag: emotional close-up portrait, expressive eyes, shallow depth of field',
    '',
    '4.  PHONG CẢNH / THIÊN NHIÊN / KHÔNG GIAN',
    '    → Wide panoramic shot, bầu trời chiếm 60% khung hình',
    '    → Nhân vật nhỏ so với cảnh quan, nhấn mạnh sự bé nhỏ trước thiên nhiên',
    '    Tag: epic landscape wide shot, panoramic view, dramatic sky, tiny figure',
    '',
    '5.  HỘI THOẠI / GẶP GỠ GIỮA CÁC NHÂN VẬT',
    '    → Two-shot framing, body language nói lên quan hệ hai người',
    '    → Khoảng cách nói lên thân thiết hay xa lạnh',
    '    Tag: two characters facing, over-the-shoulder framing, body language',
    '',
    '6.  BÍ ẨN / CÚ TWIST / LỘ DIỆN',
    '    → Dramatic rim lighting từ dưới hoặc bên cạnh, nhân vật che mặt hoặc quay lưng',
    '    Tag: mysterious reveal shot, dramatic rim lighting, half-shadow face',
    '',
    '7.  ĐỘT PHÁ / THĂNG CẤP / KHOẢNH KHẮC VĨ ĐẠI',
    '    → Light explosion từ nhân vật ra ngoài, low angle cực thấp nhìn lên',
    '    → Môi trường phản ứng: đất rung, cây cỏ bay, người xung quanh lùi lại',
    '    Tag: power awakening scene, radiant light burst, low angle, awe-inspiring',
    '',
    '8.  ĐAU THƯƠNG / BI KỊCH / TỬ VONG',
    '    → Mưa rơi hoặc tuyết rơi chậm, ánh sáng mờ nhạt, màu lạnh desaturated',
    '    Tag: tragic farewell scene, rain falling, cold desaturated tones, heartbreaking',
    '',
    '9.  HỒI ỨC / QUÁ KHỨ / KÝ ỨC',
    '    → Ánh sáng vàng ấm vintage, vignette viền tối, hiệu ứng hơi mờ nhẹ',
    '    Tag: nostalgic memory scene, warm golden vintage tone, dreamlike blur',
    '',
    '10. ÁC NHÂN / PHẢN DIỆN XUẤT HIỆN',
    '    → Camera thấp nhìn lên, darkness behind, evil glow chiếu từ dưới',
    '    → Nụ cười lạnh, ánh mắt tàn nhẫn, aura đen áp đảo',
    '    Tag: villain introduction, low angle intimidating, evil aura, dark atmosphere',
    '',
    '11. LÃNG MẠN / TÌNH YÊU',
    '    → Warm soft lighting, bokeh, hoa tươi hoặc cánh hoa bay',
    '    → Hai nhân vật gần nhau, ánh mắt nhìn nhau, không gian riêng tư',
    '    Tag: romantic intimate scene, warm soft lighting, floating petals',
    '',
    '12. HÀI HƯỚC / NHẸ NHÀNG',
    '    → Bright cheerful colors, expressive cartoony face reactions',
    '    Tag: lighthearted comedic scene, bright cheerful colors, expressive reactions',
    '',
    '13. THIÊN NHIÊN THUẦN TÚY (không có nhân vật)',
    '    → Focus 100% vào vẻ đẹp: rừng, biển, núi, bầu trời',
    '    Tag: breathtaking nature scenery, no characters, atmospheric photography',
    '',
    '14. VẬT PHẨM / VẬT THỂ ĐẶC BIỆT',
    '    → Close-up macro shot, dramatic lighting chiếu vào vật tạo hào quang',
    '    Tag: dramatic close-up of important item, macro detail shot, glowing',
    '',
    SEP80,
    ...
    '',
    '7 ĐIỂM GIỮ NHẤT QUÁN TUYỆT ĐỐI:',
    ...
    '  (3) Màu mắt                      : golden amber eyes / cold grey eyes',
    '  (4) Đặc điểm nhận diện           : sẹo, nốt ruồi, birthmark, tattoo',
    '  (5) Trang phục đặc trưng         : màu sắc, kiểu dáng, phụ kiện đặc biệt',
    '  (6) Vũ khí / đạo cụ              : silver-sheathed longsword at left hip',
    '  (7) Vóc dáng                     : tall and lean / petite / muscular',
    '',
    'QUY TRÌNH 4 BƯỚC:',
    '  B1: Đọc lướt toàn bộ file — liệt kê tất cả nhân vật xuất hiện trong văn bản',
    '  B2: Xây dựng character sheet riêng cho mỗi nhân vật',
    '  B3: Lần đầu xuất hiện → mô tả đầy đủ nhất cả 7 điểm',
    '  B4: Lần sau → COPY y chang 7 điểm, chỉ đổi action/pose/background',
    '',
    'VÍ DỤ ĐÚNG — nhân vật Minh qua 3 cảnh:',
    '  Cảnh 1: young male warrior, medium-length black hair tied with white ribbon,',
    '          sharp determined dark brown eyes, lean athletic build, white hanfu blue trim',
    '  Cảnh 2: same young male warrior, medium-length black hair untied flowing in wind,',
    '          sharp determined dark brown eyes blazing with intensity,',
    '          lean athletic build, white hanfu blue trim torn at sleeve',
    '  Cảnh 3: same young male warrior, medium-length black hair loose,',
    '          sharp dark brown eyes now carrying sadness,',
    '          lean athletic build, white hanfu blue trim',
    '',
    ...
    'Thêm dòng [NEGATIVE: ...] ngay SAU dòng [IMAGE PROMPT:] — Colab đọc, Genspark/GPT bỏ qua:',
    '  [NEGATIVE: lowres, bad anatomy, bad hands, text, error, missing fingers,',
    '  extra digit, fewer digits, cropped, worst quality, low quality,',
    '  normal quality, jpeg artifacts, signature, watermark, username, blurry,',
    '  ugly, duplicate, morbid, mutilated, out of frame, extra limbs,',
    '  bad proportions, gross proportions, deformed face, long neck,',
    '  soft watercolor wash, flat lighting, overexposed white background,',
    '  bright clean tones, flat anime style, pitch black without detail]',
    '',
    '━━ RULE 4: STYLE TAGS BẮT BUỘC — CHỐNG ẢNH PHẲNG ━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'KHI DÙNG [MODEL:epic] — LUÔN THÊM:',
    '  dramatic volumetric lighting, god rays, atmospheric depth fog,',
    '  cinematic color grading, strong light-shadow contrast, Illustrious XL CG style',
    'KHI DÙNG [MODEL:dream] — LUÔN THÊM:',
    '  dreamshaper style, cinematic soft lighting, intricate detail, emotional depth',
    'TUYỆT ĐỐI TRÁNH (cả 2 model):',
    '  soft watercolor wash, bright clean tones, flat lighting,',
    '  flat anime style, overexposed white background, minimal shadow',
    '',
    '━━ RULE 5: ĐỘ DÀI PROMPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Tối thiểu 80 words — lý tưởng 120-180 words — toàn bộ bằng tiếng Anh',
    '',
    SEP80,
    'PHẦN 7 — TEMPLATE PROMPT ĐỂ COPY',
    SEP80,
    '',
    '  [IMAGE PROMPT: [MODEL:epic hoặc dream] [SUBJECT],',
    '  [ACTION/POSE],',
    '  [APPEARANCE: tóc, mắt, đặc điểm, trang phục],',
    '  [SETTING: địa điểm, thời gian, thời tiết],',
    '  [ATMOSPHERE: không khí, ánh sáng, màu sắc],',
    '  [COMPOSITION: góc máy, framing, depth of field],',
    '  [ART STYLE phù hợp thể loại],',
    '  dramatic volumetric lighting, god rays, strong light-shadow contrast,',
    '  masterpiece, best quality, ultra-detailed, 8K resolution,',
    '  horizontal landscape orientation, 16:9 aspect ratio,',
    '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    ...
    '  blurry, ugly, deformed face, extra limbs, bad proportions,',
    '  soft watercolor wash, flat lighting, overexposed white, bright clean tones]',
    ...
    'B1: Thay TẤT CẢ [MODEL:epic] và [MODEL:dream] → [MODEL:gpt-image-1]',
    ...
    'B1: Thay TẤT CẢ model tag → [MODEL:gpt-image-1]',
    ...
    'B1: GIỮ NGUYÊN model tag [MODEL:epic] / [MODEL:dream] trong file',
    ...
    '    • [MODEL:epic]  → John6666/hs-ultrahd-cg-ill-epic-sdxl',
    '    • [MODEL:dream] → Lykon/dreamshaper-xl-1-0',
    ...
    SEP80,
    '',
    'INPUT (block trong file TXT):',
    '  [Dẫn Truyện]',
    '  startTime: 45.200s',
    '  → duration: 18.300s →',
    '  [IMAGE PROMPT: CHƯA TẠO]',
    '  [FILE: scene_04520.452s.jpg]',
    '  Minh đứng trên đỉnh núi, gió thổi tung vạt áo trắng,',
    '  nhìn xuống thành trì đang bốc khói. Lòng chàng nặng trĩu —',
    '  nơi đó, sư phụ đang bị giam cầm.',
    '',
    'OUTPUT CHUẨN (Colab — giữ nguyên [MODEL:epic]):',
    '  [IMAGE PROMPT: [MODEL:epic] A young male warrior standing alone',
    '  atop a jagged mountain peak, body slightly turned as fierce wind billows',
    '  white hanfu robe and hair dramatically,',
    '  medium-length black hair tied with white ribbon loosened by wind,',
    '  sharp determined dark brown eyes gazing with heavy sorrow at distant burning fortress,',
    '  lean athletic build, white hanfu with blue embroidery trim, silver sword at left hip,',
    '  stone fortress below with rising smoke and orange fire glow,',
    '  late afternoon storm clouds gathering, crimson and grey sky,',
    '  heavy resolve and painful duty atmosphere, cold mountain wind,',
    '  wide shot from behind-right, subject lower-left third, vast panoramic landscape,',
    '  Chinese wuxia epic CG art, dramatic volumetric lighting, god rays through smoke,',
    '  strong light-shadow contrast, Illustrious XL CG style,',
    '  masterpiece, best quality, ultra-detailed, 8K resolution,',
    '  horizontal landscape orientation, 16:9 aspect ratio,',
    '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    ...
    '  [NEGATIVE: lowres, bad anatomy, bad hands, text, error, missing fingers,',
    '  cropped, worst quality, low quality, jpeg artifacts, signature, watermark,',
    '  blurry, soft watercolor wash, flat lighting, bright clean tones]',
    '  [FILE: scene_04520.452s.jpg]',
    '',
    'OUTPUT CHO GENSPARK (đổi model tag trước khi paste):',
    '  [IMAGE PROMPT: [MODEL:gpt-image-1] A young male warrior... (nội dung như trên)]',
    '  [NEGATIVE: ...] ← Genspark tự bỏ qua dòng này',
    '  [FILE: scene_04520.452s.jpg]',
    '',
    SEP80,
    'BẮT ĐẦU XỬ LÝ — ĐỌC TOÀN BỘ FILE TRƯỚC, XÂY DỰNG CHARACTER SHEET, SAU ĐÓ VIẾT PROMPT',
    SEP80,
    ''
];
