...
var headerUniversal = [
    SEP80,
    '╔══════════════════════════════════════════════════════════════════════════════╗',
    '║   IMAGE PROMPT GENERATION FILE — PROFESSIONAL VERSION v6.0 (DUAL STYLE)      ║',
    '║   Compatible: Colab SDXL · Genspark · ChatGPT · Gemini                       ║',
    '║   🌟 ANIMAGINE XL 3.1 — DUAL STYLE: EPIC 3D CG + DARK FANTASY 🌟            ║',
    '╚══════════════════════════════════════════════════════════════════════════════╝',
    SEP80,
    '',
    '┌─────────────────────────────────────────────────────────────────────────────┐',
    '│  ★★★ PHIÊN BẢN MỚI: TỰ ĐỘNG CHỌN STYLE THEO NGỮ CẢNH ★★★                  │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  2 STYLE MODES:                                                              │',
    '│    📘 STYLE A: EPIC 3D CG (Bright/Vivid) - Cho cảnh thường, lãng mạn, hòa bình │',
    '│    📕 STYLE B: DARK FANTASY (Gritty/Dramatic) - Cho combat, kinh dị, epic battle │',
    '│                                                                              │',
    '│  Hệ thống TỰ ĐỘNG phân tích văn bản và chọn style phù hợp                   │',
    '└─────────────────────────────────────────────────────────────────────────────┘',
    '',
    '┌─────────────────────────────────────────────────────────────────────────────┐',
    '│  CHỌN NỀN TẢNG TẠO ẢNH                                                       │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  COLAB SDXL (Animagine XL 3.1):                                             │',
    '│    → GIỮ NGUYÊN tag [MODEL:animagine]                                       │',
    '│    → Colab tự đọc [STYLE:A] hoặc [STYLE:B] để load style preset           │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  GENSPARK AI AGENT / CHATGPT:                                               │',
    '│    → Thay [MODEL:animagine] → [MODEL:nano-banana-2]                        │',
    '│    → Style tags tự động apply trong prompt                                   │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  GEMINI (Imagen 3):                                                          │',
    ...
    '',
    SEP80,
    'PHẦN 1 — CẤU TRÚC FILE TXT',
    SEP80,
    '',
    'FILE TXT chứa các block [Dẫn Truyện]:',
    '',
    '  [Dẫn Truyện]',
    '  startTime: 0.000s',
    '  → duration: 12.500s →',
    ...
    '',
    'QUY TẮC:',
    '1. Đọc văn bản → Phân tích ngữ cảnh → Chọn STYLE A hoặc B',
    '2. Thay [IMAGE PROMPT: CHƯA TẠO] bằng prompt đầy đủ',
    '3. GIỮ NGUYÊN dòng [FILE: ...]',
    '4. Nhân vật phải NHẤT QUÁN xuyên suốt file',
    '',
    SEP80,
    'PHẦN 2 — DUAL STYLE SYSTEM (TỰ ĐỘNG CHỌN THEO NGỮ CẢNH)',
    SEP80,
    '',
    '┌─────────────────────────────────────────────────────────────────────────────┐',
    '│  📘 STYLE A: EPIC 3D CG (BRIGHT/VIVID) — 120-150 TỪ                        │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  KHI NÀO DÙNG:                                                               │',
    '│    • Cảnh đời thường, hòa bình, thiên nhiên đẹp                            │',
    '│    • Cảnh lãng mạn, tình cảm, gia đình                                      │',
    '│    • Giới thiệu nhân vật lần đầu                                            │',
    '│    • Tu luyện, meditation, breakthrough                                      │',
    '│    • Cảnh sáng sủa, tươi đẹp, heroic moments                                │',
    '│                                                                              │',
    '│  TỪ KHÓA BẮT BUỘC:                                                           │',
    '│    Chinese xianxia CG art style, 3D render style,                           │',
    '│    cel shading with depth, volumetric lighting,                             │',
    '│    subsurface scattering on skin, vivid saturated colors                    │',
    '│                                                                              │',
    '│  ÁNH SÁNG:                                                                   │',
    '│    • Soft ethereal mist, dramatic painted lighting                          │',
    '│    • Golden hour sunlight, warm amber tones                                 │',
    '│    • Luminous glow, gentle rim light                                        │',
    '│    • Bright clean tones, vivid colors                                       │',
    '│                                                                              │',
    '│  NEGATIVE:                                                                   │',
    '│    lowres, flat shading, soft watercolor wash, pastel flat tones,          │',
    '│    bad anatomy, text, worst quality, blurry, 2D flat art, dull colors      │',
    '└─────────────────────────────────────────────────────────────────────────────┘',
    '',
    '┌─────────────────────────────────────────────────────────────────────────────┐',
    '│  📕 STYLE B: DARK FANTASY (GRITTY/DRAMATIC) — 140-180 TỪ                   │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  KHI NÀO DÙNG:                                                               │',
    '│    • Cảnh chiến đấu intense, combat, boss fight                             │',
    '│    • Cảnh kinh dị, ma quỷ, bóng tối                                        │',
    '│    • Epic battle với sparks và debris                                        │',
    '│    • Cảnh tối tăm, nguy hiểm, apocalyptic                                   │',
    '│    • Moment đỉnh cao của trận chiến                                         │',
    '│                                                                              │',
    '│  TỪ KHÓA BẮT BUỘC:                                                           │',
    '│    Dark fantasy epic battle CG art, photorealistic 3D render,              │',
    '│    high-end cinematic quality, cel shading with depth,                      │',
    '│    volumetric lighting, subsurface scattering                               │',
    '│                                                                              │',
    '│  ÁNH SÁNG:                                                                   │',
    '│    • Dramatic high-contrast lighting                                         │',
    '│    • Explosive golden-yellow energy sparks bursting                         │',
    '│    • Volumetric fog and smoke filling scene                                 │',
    '│    • Harsh rim lighting, deep dramatic shadows                              │',
    '│    • Gritty desaturated color palette                                       │',
    '│    • Dark charcoal, metallic black, muddy brown tones                       │',
    '│                                                                              │',
    '│  HIỆU ỨNG ĐẶC BIỆT:                                                         │',
    '│    • White curved motion blur trails on weapons                             │',
    '│    • Floating stone debris suspended mid-air                                │',
    '│    • Explosive impact shockwave effects                                     │',
    '│    • Dark souls aesthetic, elden ring atmosphere                            │',
    '│                                                                              │',
    '│  NEGATIVE:                                                                   │',
    '│    lowres, flat shading, soft watercolor wash, bright cheerful colors,     │',
    '│    bad anatomy, text, worst quality, blurry, 2D flat art, pastel tones     │',
    '└─────────────────────────────────────────────────────────────────────────────┘',
    '',
    SEP80,
    'PHẦN 3 — DECISION TREE: CHỌN STYLE THEO KEYWORDS',
    SEP80,
    '',
    '🔍 ĐỌC VĂN BẢN TIẾNG VIỆT → TÌM CÁC TỪ KHÓA → QUYẾT ĐỊNH STYLE',
    '',
    '📕 DÙNG STYLE B (DARK FANTASY) NẾU VĂN BẢN CÓ:',
    '  • chiến đấu, đánh nhau, giao chiến, quyết chiến, hạ đòn',
    '  • vung kiếm, búa, đánh, đập, phá tan, nghiền nát, kết liễu',
    '  • máu, vết thương, torn, rách rưới, bloodstained',
    '  • tia lửa, sparks, bùng nổ, explosion, shockwave',
    '  • bóng tối, tối tăm, ám ảnh, kinh dị, ma quỷ',
    '  • boss, quái vật, ác thú, demon, undead',
    '  • storm clouds, sấm sét, apocalyptic, ruins',
    '  • intense, fierce, aggressive, desperate, fury',
    '',
    '📘 DÙNG STYLE A (EPIC 3D CG) NẾU VĂN BẢN CÓ:',
    '  • tu luyện, meditation, đột phá, breakthrough, ngộ đạo',
    '  • đẹp đẽ, bình yên, thanh tịnh, serene, peaceful',
    '  • tình yêu, lãng mạn, nhớ nhung, melancholic',
    '  • ánh sáng, mặt trời, golden hour, nắng ấm',
    '  • giới thiệu, xuất hiện lần đầu, character intro',
    '  • cười, vui vẻ, hạnh phúc, celebration',
    '  • tiên cảnh, thiên đường, floating islands, clouds',
    '',
    '⚖️ NẾU KHÔNG RÕ RÀNG:',
    '  → MẶC ĐỊNH dùng STYLE A (an toàn hơn)',
    '',
    SEP80,
    'PHẦN 4 — CẤU TRÚC PROMPT CHO TỪNG STYLE',
    SEP80,
    '',
    '═══ TEMPLATE STYLE A: EPIC 3D CG (120-150 TỪ) ═══',
    '',
    '[IMAGE PROMPT: [MODEL:animagine] [STYLE:A]',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering on skin, vivid saturated colors,',
    '',
    '[SUBJECT + ACTION 15-20 từ],',
    '[APPEARANCE 20 từ: gender, hair, eyes, outfit, 1 mark],',
    '[SETTING 10-15 từ: location, time, weather],',
    '[ATMOSPHERE 5-8 từ: mood, feeling],',
    '[LIGHTING 15-20 từ: soft/dramatic + nguồn + hướng + hiệu ứng + màu],',
    '[COMPOSITION 8-10 từ: camera angle, depth of field],',
    '[PARTICLES 5-8 từ: glowing particles, floating elements],',
    '',
    'masterpiece, best quality, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, pure illustration only]',
    '',
    '[NEGATIVE: lowres, flat shading, soft watercolor wash, pastel flat tones,',
    'bad anatomy, bad hands, text, error, worst quality, low quality, blurry,',
    'ugly, 2D flat art, dull colors]',
    '[FILE: scene_xxxxx.xxxs.jpg]',
    '',
    '',
    '═══ TEMPLATE STYLE B: DARK FANTASY (140-180 TỪ) ═══',
    '',
    '[IMAGE PROMPT: [MODEL:animagine] [STYLE:B]',
    'Dark fantasy epic battle CG art, photorealistic 3D render,',
    'high-end cinematic quality, cel shading with depth,',
    'volumetric lighting, subsurface scattering,',
    '',
    '[SUBJECT + ACTION 20-25 từ: aggressive, dynamic combat],',
    '[APPEARANCE 20-25 từ: battle-damaged, bloodstained, fierce],',
    '[SETTING 15-20 từ: apocalyptic, ruins, storm clouds],',
    '[COMBAT EFFECTS 15-20 từ: explosions, debris, shockwaves],',
    '',
    '[LIGHTING DARK 20-25 từ:',
    'dramatic high-contrast lighting, explosive golden-yellow energy sparks bursting,',
    'volumetric fog and smoke filling scene, harsh rim lighting,',
    'gritty desaturated color palette, dark charcoal, metallic black, muddy brown],',
    '',
    '[COMPOSITION 10-12 từ: extreme low angle, dynamic action, motion blur],',
    '[SPECIAL FX 10-15 từ: white motion trails, floating debris, impact effects],',
    '',
    'dark souls aesthetic, elden ring atmosphere, god of war intensity,',
    'masterpiece, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, pure cinematic illustration]',
    '',
    '[NEGATIVE: lowres, flat shading, soft watercolor wash, bright cheerful colors,',
    'bad anatomy, bad hands, text, error, worst quality, low quality, blurry,',
    'ugly, 2D flat art, pastel tones]',
    '[FILE: scene_xxxxx.xxxs.jpg]',
    '',
    SEP80,
    'PHẦN 5 — VÍ DỤ THỰC TẾ SO SÁNH 2 STYLES',
    SEP80,
    '',
    SEP50,
    'CẢNH 1: TU LUYỆN BÌNH YÊN → DÙNG STYLE A',
    SEP50,
    '',
    'VĂN BẢN: "Trên núi cao, Từ Phàm ngồi thiền định, linh khí xung quanh nhẹ nhàng xoay vần"',
    '',
    '[IMAGE PROMPT: [MODEL:animagine] [STYLE:A]',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering on skin, vivid saturated colors,',
    'adult male cultivator sitting in lotus meditation pose on mountain peak,',
    'adult male, long black hair in casual ponytail, dark eyes, white and blue daoist robes,',
    'high mountain peak with sea of clouds below, clear morning sky,',
    'transcendent peaceful atmosphere,',
    'soft ethereal mist rolling through scene, dramatic painted lighting',
    'with radiant golden dawn sunbeams from behind, gentle rim light halo,',
    'cool blue ambient mixing with warm golden highlights,',
    'wide shot from slightly below, deep depth of field,',
    'thousands of glowing cyan spirit particles floating around figure,',
    'masterpiece, best quality, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, pure illustration only]',
    '[NEGATIVE: lowres, flat shading, soft watercolor wash, pastel flat tones,',
    'bad anatomy, text, worst quality, blurry, 2D flat art, dull colors]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP50,
    'CẢNH 2: CHIẾN ĐẤU QUYẾT LIỆT → DÙNG STYLE B',
    SEP50,
    '',
    'VĂN BẢN: "Hùng Lực đập búa xuống, nghiền nát kiếm trận, tia lửa vàng bắn tung tóe"',
    '',
    '[IMAGE PROMPT: [MODEL:animagine] [STYLE:B]',
    'Dark fantasy epic battle CG art, photorealistic 3D render,',
    'high-end cinematic quality, cel shading with depth,',
    'volumetric lighting, subsurface scattering,',
    'massive muscular male warrior smashing flying swords with colossal war hammer',
    'in explosive mid-swing, impact moment captured,',
    'huge muscular male, short brown hair, fierce glowing amber eyes burning with rage,',
    'heavy dark metallic armor covered in battle scars and blood splatters,',
    'wielding gigantic dark iron war hammer crackling with energy,',
    'apocalyptic trial arena with crumbling fortress walls, storm clouds gathering,',
    'flying shattered sword fragments and stone debris exploding outward in all directions,',
    'explosive golden-yellow energy burst from impact point with white shockwave rings,',
    'volumetric dust clouds and smoke filling scene, debris suspended mid-air,',
    'dramatic high-contrast lighting with glowing golden sparks illuminating armor,',
    'harsh rim light on figure edges, gritty desaturated color palette',
    'with dark charcoal, metallic black, muddy brown tones,',
    'white curved motion blur trails on hammer trajectory showing velocity,',
    'extreme low angle camera looking up capturing epic scale and power,',
    'dark souls boss fight aesthetic, elden ring intensity, god of war atmosphere,',
    'masterpiece, ultra-detailed, 8K resolution, 16:9 aspect ratio,',
    'NO text, NO watermark, pure cinematic illustration]',
    '[NEGATIVE: lowres, flat shading, soft watercolor wash, bright cheerful colors,',
    'bad anatomy, text, worst quality, blurry, 2D flat art, pastel tones]',
    '[FILE: scene_00022.044s.jpg]',
    '',
    SEP80,
    'PHẦN 6 — CHARACTER CONSISTENCY (NHÂN VẬT NHẤT QUÁN)',
    SEP80,
    '',
    'CHARACTER SHEET — XÂY 1 LẦN, DÙNG MÃI (20 TỪ):',
    '',
    '  FORMAT:',
    '  [gender], [age appearance], [hair: color+style+accessory],',
    '  [eyes: color+expression], [outfit: color+material+detail],',
    '  [1 unique identifying mark]',
    '',
    '  VÍ DỤ NHÂN VẬT "TỪ PHÀM":',
    '  "adult male, long black hair in casual ponytail, dark eyes,',
    '  white and blue daoist robes, serene expression"',
    '',
    '  VÍ DỤ NHÂN VẬT "HÙNG LỰC":',
    '  "huge muscular male, short brown hair, fierce amber eyes,',
    '  heavy dark metallic armor, wielding massive dark iron war hammer"',
    '',
    'QUY TẮC:',
    '  ✅ COPY Y CHANG 20 từ này cho mọi cảnh cùng nhân vật',
    '  ✅ CHỈ đổi: action/pose, facial expression details',
    '  ❌ KHÔNG paraphrase hay thay đồng nghĩa',
    '',
    '★ Style A hay B đều DÙNG CÙNG 20 TỪ character description ★',
    '',
    SEP80,
    'PHẦN 7 — ÁNH SÁNG CHI TIẾT THEO STYLE',
    SEP80,
    '',
    '═══ LIGHTING CHO STYLE A (EPIC 3D CG) ═══',
    '',
    'CÔNG THỨC (15-20 từ):',
    '  [soft/dramatic] + [nguồn sáng] + [from direction] +',
    '  [hiệu ứng chính] + [màu warm vs cool]',
    '',
    'VÍ DỤ TỐT:',
    '  "soft ethereal mist rolling through scene, dramatic painted lighting',
    '  with radiant golden dawn sunbeams from behind and above,',
    '  creating divine rim light halo, cool blue ambient mixing',
    '  with warm golden highlights, bright clean tones"',
    '',
    'TỪ KHÓA:',
    '  • Soft: ethereal mist, gentle glow, delicate lighting',
    '  • Dramatic: god rays, rim light, volumetric beams',
    '  • Colors: golden/amber vs blue/cyan, vivid clean tones',
    '',
    '',
    '═══ LIGHTING CHO STYLE B (DARK FANTASY) ═══',
    '',
    'CÔNG THỨC (20-25 từ):',
    '  dramatic high-contrast + [explosive effect] +',
    '  volumetric fog/smoke + harsh rim lighting +',
    '  gritty desaturated palette + [specific dark colors]',
    '',
    'VÍ DỤ TỐT:',
    '  "dramatic high-contrast lighting, explosive golden-yellow energy',
    '  sparks bursting from impact point, volumetric dust clouds and smoke',
    '  filling scene, harsh rim lighting on armor edges, gritty desaturated',
    '  color palette with dark charcoal, metallic black, muddy brown tones"',
    '',
    'TỪ KHÓA BẮT BUỘC:',
    '  • Dramatic high-contrast lighting',
    '  • Explosive golden-yellow (or relevant color) sparks/energy',
    '  • Volumetric fog/smoke/dust',
    '  • Harsh rim lighting',
    '  • Gritty desaturated palette',
    '  • Dark charcoal, metallic black, muddy brown',
    '',
    SEP80,
    'PHẦN 8 — QUY TẮC CỨNG TUYỆT ĐỐI',
    SEP80,
    '',
    '━━ RULE 1: PHÂN TÍCH VĂN BẢN TRƯỚC KHI TẠO PROMPT ━━━━━━━━━━━━━━━━━━━━━━━━━',
    'ĐỌC văn bản tiếng Việt → TÌM keywords → CHỌN Style A hoặc B',
    'KHÔNG tạo prompt trước khi biết rõ style cần dùng',
    '',
    '━━ RULE 2: ĐỘ DÀI PROMPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Style A: 120-150 từ (ngắn gọn, tập trung vào beauty)',
    'Style B: 140-180 từ (chi tiết hơn cho combat effects)',
    '',
    '━━ RULE 3: CHARACTER DESCRIPTION CỐ ĐỊNH ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    '20 từ cho mỗi nhân vật — COPY Y CHANG cho mọi cảnh',
    'Chỉ đổi action/expression, KHÔNG đổi tóc/mắt/trang phục',
    '',
    '━━ RULE 4: NEGATIVE PROMPT THEO STYLE ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Style A: thêm "dull colors" vào negative',
    'Style B: thêm "bright cheerful colors" vào negative',
    '',
    ...
    '',
    SEP80,
    'PHẦN 9 — WORKFLOW THỰC TẾ',
    SEP80,
    '',
    'BƯỚC 1: ĐỌC VĂN BẢN TIẾNG VIỆT',
    '  → Xác định: Cảnh này peaceful hay combat?',
    '  → Có từ khóa chiến đấu/bạo lực không?',
    '  → Mood chung: sáng sủa hay tối tăm?',
    '',
    'BƯỚC 2: CHỌN STYLE',
    '  → Nếu có keywords Style B → dùng Dark Fantasy',
    '  → Nếu không rõ hoặc peaceful → dùng Epic 3D CG',
    '',
    'BƯỚC 3: LOAD TEMPLATE TƯƠNG ỨNG',
    '  → Copy template Style A hoặc B',
    '  → Điền thông tin từ văn bản',
    '',
    'BƯỚC 4: ĐIỀN CHARACTER DESCRIPTION',
    '  → Dùng 20 từ đã chuẩn bị sẵn',
    '  → Chỉ đổi action/expression',
    '',
    'BƯỚC 5: ĐIỀN LIGHTING PHÙ HỢP',
    '  → Style A: soft, ethereal, vivid colors',
    '  → Style B: dramatic, explosive, gritty desaturated',
    '',
    'BƯỚC 6: KIỂM TRA',
    '  → Đếm từ: Style A (120-150), Style B (140-180)',
    '  → Có đủ quality tags + NO text?',
    '  → Có [NEGATIVE:] phù hợp?',
    '',
    SEP80,
    'PHẦN 10 — CHECKLIST TRƯỚC KHI HOÀN TẤT',
    SEP80,
    '',
    '☑ Đã đọc và phân tích văn bản tiếng Việt?',
    '☑ Đã chọn đúng Style A hoặc B dựa trên ngữ cảnh?',
    '☑ Character description đúng 20 từ và nhất quán?',
    '☑ Lighting description chi tiết 15-25 từ?',
    '☑ Có composition (camera angle + depth of field)?',
    '☑ Đếm tổng từ: Style A (120-150) / Style B (140-180)?',
    '☑ Có quality tags đầy đủ?',
    '☑ Có "NO text, NO watermark" ở cuối?',
    '☑ Có [NEGATIVE:] phù hợp với style?',
    '☑ Giữ nguyên dòng [FILE: scene_xxxxx.xxxs.jpg]?',
    '',
    SEP80,
    'TÓM TẮT — 7 ĐIỂM QUAN TRỌNG NHẤT v6.0',
    SEP80,
    '',
    '1. 📘📕 PHÂN TÍCH NGỮ CẢNH: Đọc văn bản → Chọn Style A (bright) hoặc B (dark)',
    '2. 🎨 STYLE LÊN ĐẦU: Đặt style tags ngay sau [MODEL:animagine]',
    '3. 👤 NHÂN VẬT CỐ ĐỊNH: 20 từ character description, copy y chang mọi lần',
    '4. 💡 ÁNH SÁNG CHI TIẾT: A (15-20 từ soft/vivid), B (20-25 từ dramatic/gritty)',
    '5. 📏 ĐỘ DÀI CHUẨN: A (120-150 từ), B (140-180 từ)',
    '6. ⛔ NEGATIVE PHÙ HỢP: A (+ dull colors), B (+ bright cheerful)',
    '7. ✅ QUALITY + NO TEXT: Bắt buộc có ở cuối mọi prompt',
    '',
    SEP80,
    'BẮT ĐẦU XỬ LÝ — ĐỌC FILE → PHÂN TÍCH → CHỌN STYLE → TẠO PROMPT',
    SEP80,
    ''
];
