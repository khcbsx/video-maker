...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    // ══════════════════════════════════════════════════════════════════════════
    // HEADER UNIVERSAL - FULL VERSION (JUGGERNAUT EPIC CINEMATIC ONLY)
    // ══════════════════════════════════════════════════════════════════════════
    var headerUniversal = [
        SEP80,
        '╔══════════════════════════════════════════════════════════════════════════════╗',
        '║      IMAGE PROMPT GENERATION FILE — JUGGERNAUT EPIC CINEMATIC VERSION        ║',
        ...
        '├─────────────────────────────────────────────────────────────────────────────┤',
        '│  COLAB (Juggernaut XL):                                                      │',
        '│    → GIỮ NGUYÊN tag [MODEL:juggernaut] cho TẤT CẢ các cảnh                   │',
        ...
        '├──────────────────────────────────────────────────────────────────────────┤',
        '│  TOÀN BỘ 12 THỂ LOẠI TRUYỆN SẼ DÙNG DUY NHẤT: [MODEL:juggernaut]         │',
        '│  Đảm bảo chất lượng hình ảnh 3D siêu thực, điện ảnh, Epic Concept Art.   │',
        '└──────────────────────────────────────────────────────────────────────────┘',
        '',
        'NHIỆM VỤ: Viết IMAGE PROMPT tiếng Anh cho từng cảnh [Dẫn Truyện] trong file TXT',
        'MỤC ĐÍCH: Tạo ảnh minh họa EPIC SỬ THI / 3D DONGHUA cho video đọc truyện',
        '',
        SEP80,
        ...
        '',
        '  [1] MODEL TAG      — Bắt buộc đầu tiên: [MODEL:juggernaut]',
        ...
        '  [6] ATMOSPHERE     — Không khí, cảm xúc, ánh sáng (BẮT BUỘC có cường độ ánh sáng mạnh)',
        '  [7] COMPOSITION    — Góc máy, framing, độ sâu tiêu điểm',
        '  [8] STYLE+QUALITY  — Phong cách nghệ thuật + quality tags + NO text + NEGATIVE',
        '',
        '── VÍ DỤ — Kiếm hiệp chiến đấu (Colab: juggernaut) ─────────────────────────────',
        '  [IMAGE PROMPT: [MODEL:juggernaut] A young male warrior in explosive mid-combat stance,',
        ...
        '  epic cinematic dark fantasy atmosphere, intense dramatic lighting, volumetric fog,',
        '  extreme low angle looking up, diagonal dynamic composition, subject dominant,',
        '  3D Donghua style, hyper-realistic 3D render, epic wuxia concept art, unreal engine 5,',
        ...
        '  [NEGATIVE: lowres, 2D anime, flat shading, soft watercolor wash, flat lighting, bad anatomy, bad hands, text, error, missing fingers,',
        ...
        '',
        '── VÍ DỤ — Tiên hiệp tu luyện (Colab: juggernaut) ──────────────────────────────',
        '  [IMAGE PROMPT: [MODEL:juggernaut] A celestial female cultivator sitting cross-legged',
        ...
        '  transcendent ethereal atmosphere, dramatic rim lighting, intense golden god rays,',
        '  bird eye wide shot, vast sky composition, subject small against infinite heavens,',
        '  3D Donghua style, hyper-realistic 3D render, epic xianxia celestial concept art, ray tracing,',
        '  masterpiece, best quality, ultra-detailed, 8K resolution,',
        '  horizontal landscape orientation, 16:9 aspect ratio,',
        '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
        '  NO subtitles, NO UI elements, NO logo, NO signature]',
        '  [NEGATIVE: lowres, 2D anime, manga, soft watercolor wash, flat lighting, bad anatomy, bad hands, text, error, cropped,',
        ...
        '',
        '── VÍ DỤ — Kinh dị (Colab: juggernaut) ────────────────────────────────────────',
        '  [IMAGE PROMPT: [MODEL:juggernaut] An abandoned Victorian mansion at dead road end,',
        ...
        '  suffocating dread supernatural atmosphere, cold blue-green moonlight piercing through fog,',
        '  wide establishing shot, low horizon line, symmetrical composition,',
        '  dark gothic horror cinematic concept art, high contrast chiaroscuro, highly detailed,',
        '  masterpiece, best quality, ultra-detailed, 8K resolution,',
        '  horizontal landscape orientation, 16:9 aspect ratio,',
        '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
        '  NO subtitles, NO UI elements, NO logo, NO signature]',
        '  [NEGATIVE: lowres, 2D anime, text, error, cropped, worst quality, low quality,',
        '  jpeg artifacts, signature, watermark, daylight, bright colors, cheerful, soft lighting]',
        '  [FILE: scene_00845.200s.jpg]',
        '',
        '── VÍ DỤ — Lãng mạn hiện đại (Colab: juggernaut) ───────────────────────────────',
        '  [IMAGE PROMPT: [MODEL:juggernaut] A beautiful young woman sitting alone',
        ...
        '  warm amber cafe interior with cinematic neon reflections through wet window,',
        '  moody bittersweet atmosphere, intense dramatic lighting, volumetric glow,',
        '  medium close-up shot, shallow depth of field, sharp focus on eyes,',
        '  epic cinematic photography, photorealistic, highly detailed skin texture,',
        '  masterpiece, best quality, ultra-detailed, 8K resolution,',
        '  horizontal landscape orientation, 16:9 aspect ratio,',
        '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
        '  NO subtitles, NO UI elements, NO logo, NO signature]',
        '  [NEGATIVE: lowres, 2D anime, flat lighting, simple background, bad anatomy, text, error, cropped, worst quality,',
        '  low quality, jpeg artifacts, signature, watermark, blurry, deformed face]',
        ...
        SEP80,
        '',
        'LUÔN SỬ DỤNG [MODEL:juggernaut] VÀ PHONG CÁCH EPIC SỬ THI CHO MỌI THỂ LOẠI',
        '',
        SEP50,
        'A. KIẾM HIỆP / VÕ HIỆP (Wuxia)',
        SEP50,
        'Nhận biết: giang hồ, võ lâm, môn phái, kiếm pháp, nội công, đại hiệp, sư phụ',
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh kiếm hiệp',
        'Genspark/ChatGPT/Gemini: đổi tất cả thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: 3D Donghua style, hyper-realistic 3D render, epic wuxia fantasy concept art, Unreal Engine 5',
        'Màu sắc: đỏ thẫm, vàng đồng, xanh ngọc, trắng, đen — dramatic lighting',
        ...
        'Đặc biệt: aura glow (khí công), sword energy slash, robes flowing in wind, volumetric fog',
        '',
        SEP50,
        'B. TIÊN HIỆP / TU TIÊN (Xianxia / Cultivation)',
        SEP50,
        'Nhận biết: tu luyện, linh khí, đột phá cảnh giới, tiên giới, linh đan, tông môn',
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh tiên hiệp',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: 3D Donghua style, hyper-realistic 3D render, epic xianxia celestial concept art, ray tracing',
        ...
        'Đặc biệt: linh khí xoáy vào đan điền, ngũ hành hào quang, đột phá thiên lôi, glowing system interface',
        '',
        SEP50,
        'C. HỆ THỐNG / ISEKAI / NHẬP VÀO TRUYỆN',
        SEP50,
        'Nhận biết: hệ thống, level up, nhiệm vụ, rương thưởng, dị giới, dungeon',
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Epic cinematic concept art, hyper-realistic 3D render, vibrant colors',
        ...
        'Đặc biệt: UI holographic window (NO số/chữ thực), skill glow, summoning circle, intense dramatic lighting',
        '',
        SEP50,
        'D. LÃNG MẠN / NGÔN TÌNH HIỆN ĐẠI',
        SEP50,
        'Nhận biết: CEO, tình yêu, hôn nhân, tình tam giác, ký ức, gặp lại người xưa',
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh lãng mạn',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Epic cinematic photography, photorealistic, moody atmospheric lighting',
        'Màu sắc: pastel ấm (hồng, be, vàng nhạt), bokeh lấp lánh, ánh hoàng hôn rực rỡ',
        ...
        'Đặc biệt: sakura petals flying, bokeh city lights, rain on window, soft lens flare, highly detailed skin',
        '',
        SEP50,
        ...
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Epic ancient court cinematic photography, highly detailed architecture',
        'Màu sắc: đỏ cung đình, vàng hoàng gia, xanh ngọc bích, tím cao quý, dramatic shadows',
        'Trang phục: phụng bào, long bào, trâm cài tóc, kiềng ngọc',
        'Bối cảnh: hậu cung lộng lẫy, thái hòa điện, vườn ngự, hành lang cột đỏ',
        'Đặc biệt: candle flame glow, incense smoke, peony petals falling, volumetric lighting',
        '',
        SEP50,
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Dark gothic horror cinematic concept art, high contrast chiaroscuro',
        ...
        'Đặc biệt: shadow entity méo mó, bàn tay từ bóng tối, gương phản chiếu sai thực tế, eerie fog',
        '',
        SEP50,
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Epic hyper-realistic battle concept art, intense dramatic lighting, cinematic scale',
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Noir cinematic photography, deep dramatic shadows, photorealistic',
        ...
        'Đặc biệt: single overhead light deep shadows, rain reflection wet pavement, volumetric smoke',
        '',
        SEP50,
        ...
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Epic futuristic sci-fi concept art, neon cyberpunk lighting, photorealistic',
        ...
        'Đặc biệt: holographic interface, particle engine trails, nebula background, epic scale',
        '',
        SEP50,
        ...
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Cinematic photography, warm volumetric sunlight, photorealistic, highly detailed textures',
        ...
        'Colab model: [MODEL:juggernaut] cho tất cả cảnh',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Epic dark fantasy digital art, intense glowing magical lighting, high contrast',
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: Epic post-apocalyptic survival concept art, gritty cinematic realism',
        'Màu sắc: xám hoang tàn, nâu bụi đất, đỏ rỉ sét, xanh lạnh sấm sét, desaturated',
        ...
        'Đặc biệt: overgrown vines on buildings, ash falling like snow, broken glass, volumetric fog',
        '',
        SEP80,
        ...
        SEP80,
        '',
        '━━ RULE 1: ÉP CHUẨN ĐỒ HỌA 3D DONGHUA & EPIC CINEMATIC ━━━━━━━━━━━━━━━━━━━━━━━',
        'TOÀN BỘ CÁC CẢNH BẮT BUỘC CHÈN: "epic cinematic concept art, photorealistic, highly detailed, intense dramatic lighting".',
        'TUYỆT ĐỐI TRÁNH: soft watercolor wash, 2D anime, flat lighting, simple illustration.',
        '',
        ...
        '',
        '━━ RULE 3: TỶ LỆ 16:9 VÀ QUALITY TAGS BẮT BUỘC ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Luôn thêm: masterpiece, best quality, ultra-detailed, 8K resolution,',
        '           horizontal landscape orientation, 16:9 aspect ratio',
        '',
        '━━ RULE 4: NEGATIVE PROMPT BẮT BUỘC (cho Colab SDXL) ━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Thêm dòng [NEGATIVE: ...] ngay SAU dòng NO text — Colab đọc, Genspark/GPT bỏ qua:',
        '  [NEGATIVE: lowres, 2D anime, flat shading, soft watercolor wash, flat lighting, bad anatomy, bad hands, text, error, missing fingers,',
        ...
        '',
        '━━ RULE 5: MÀU SẮC BẮT BUỘC ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'LUÔN THÊM: bright clean tones, vivid colors, ultra sharp',
        'TUYỆT ĐỐI TRÁNH: dark muddy background, pitch black darkness, blurry faces',
        '',
        '━━ RULE 6: ĐỘ DÀI PROMPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        ...
        SEP80,
        '',
        '  [IMAGE PROMPT: [MODEL:juggernaut] [SUBJECT],',
        '  [ACTION/POSE],',
        '  [APPEARANCE: tóc, mắt, đặc điểm, trang phục],',
        '  [SETTING: địa điểm, thời gian, thời tiết],',
        '  [ATMOSPHERE: epic cinematic, volumetric fog, intense dramatic lighting, màu sắc],',
        '  [COMPOSITION: góc máy, framing, depth of field],',
        '  [ART STYLE phù hợp thể loại + 3D Donghua hyper-realistic HOẶC photorealistic],',
        '  masterpiece, best quality, ultra-detailed, 8K resolution,',
        '  horizontal landscape orientation, 16:9 aspect ratio,',
        '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
        ...
        'B1: Thay TẤT CẢ [MODEL:juggernaut] → [MODEL:gpt-image-1]',
        ...
        'B1: GIỮ NGUYÊN model tag [MODEL:juggernaut] trong file',
        ...
        '',
        'OUTPUT CHUẨN (Colab — giữ nguyên model tag):',
        '  [IMAGE PROMPT: [MODEL:juggernaut] A young male warrior standing alone',
        ...
        '  epic cinematic dark fantasy atmosphere, intense dramatic lighting,',
