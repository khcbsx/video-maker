...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
   ...
   var headerColab = [
    ...
    '  [3] SERIES/SOURCE   : tên bộ truyện ← BẮT BUỘC ngay sau [2] — ví dụ: xianxia',
    ...
    '  [6] QUALITY TAGS    : masterpiece, high score, great score, absurdres  ← LUÔN Ở CUỐI',
    '',
    ...
    SEP50,
    '  • CFG Scale   : 5  ← THAY ĐỔI (v3.1 dùng 7)',
    '  • Steps       : 28',
    ...
    '',
    SEP50,
    'NEGATIVE PROMPT CHUẨN OFFICIAL (v4.0 — ĐÃ ĐỔI SO VỚI v3.1):',
    SEP50,
    ...
    SEP50,
    '',
    '  [IMAGE PROMPT: scenery, no humans,',
    ...
    '  wide shot, cinematic composition, golden hour light,',
    '  volumetric god rays, dramatic sky,',
    '  safe,',
    '  masterpiece, high score, great score, absurdres]',
    '  [NEGATIVE: lowres, bad anatomy, bad hands, text, error, missing finger,',
    '  extra digits, fewer digits, cropped, worst quality, low quality,',
    ...
    '',
    SEP50,
    'VÍ DỤ 5 — CẢNH NỘI TÂM / CẢM XÚC (emotional scene):',
    SEP50,
    '',
    ...
    '  destroyed battlefield, ash falling, sunset glow,',
    ...
    '  dynamic pose / battle stance / relaxed pose / elegant pose',
    '  kneeling / floating / falling / leaping / spinning',
    '',
    SEP50,
    'SETTING — XIANXIA:',
    SEP50,
    ...
    '  fire glow / blue moonlight / energy aura / dark atmosphere',
    '',
    SEP50,
    'COMPOSITION TAGS:',
    SEP50,
    ...
    '  dutch angle / diagonal composition / dynamic angle',
    '',
    SEP80,
