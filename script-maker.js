...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    // ══════════════════════════════════════════════════════════════════════════
// HEADER UNIVERSAL v5.0 — CHỈ ANIMAGINE XL 3.1
// ══════════════════════════════════════════════════════════════════════════
var SEP80 = '================================================================================';
var SEP50 = '────────────────────────────────────────────────────';
...
var headerUniversal = [
    SEP80,
    '╔══════════════════════════════════════════════════════════════════════════════╗',
    '║      IMAGE PROMPT GENERATION FILE — UNIVERSAL VERSION v5.0                ║',
    '║   Compatible: Colab SDXL · Genspark Agent · ChatGPT · Gemini             ║',
    '║   🌟 CHỈ DÙNG ANIMAGINE XL 3.1 — 3D CG STYLE — EPIC VIVID COLORS 🌟     ║',
    '╚══════════════════════════════════════════════════════════════════════════════╝',
    SEP80,
    '',
    '┌─────────────────────────────────────────────────────────────────────────────┐',
    ...
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  COLAB SDXL (Animagine XL 3.1 — model duy nhất):                         │',
    '│    → GIỮ NGUYÊN tag [MODEL:animagine] trong mọi prompt                   │',
    '│    → Colab tự đọc [FILE:] để đặt tên ảnh đúng chuẩn                      │',
    '│    → Colab tự đọc [NEGATIVE:] để truyền vào SDXL pipeline                │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  GENSPARK AI AGENT hoặc CHATGPT:                                          │',
    '│    → Thay [MODEL:animagine] → [MODEL:gpt-image-2]                        │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  GEMINI (Imagen 3):                                                        │',
    '│    → Thay [MODEL:animagine] → [MODEL:imagen3]                            │',
    '└─────────────────────────────────────────────────────────────────────────────┘',
    '',
    '┌─────────────────────────────────────────────────────────────────────────────┐',
    '│  MODEL DUY NHẤT: [MODEL:animagine] → cagliostrolab/animagine-xl-3.1      │',
    '│  Dung lượng: 6.94 GB ✅ — Chạy ổn trên Colab T4 free                    │',
    '│  Style: Chinese xianxia CG art — 3D depth — Vivid epic colors            │',
    '│  Áp dụng cho: TẤT CẢ thể loại (tiên hiệp, kiếm hiệp, hiện đại, v.v.)   │',
    '└─────────────────────────────────────────────────────────────────────────────┘',
    '',
    '⚠️  TỪ KHÓA BẮT BUỘC DÙNG VỚI ANIMAGINE 3D STYLE:',
    '',
    '  ✅ LUÔN DÙNG (tạo chiều sâu 3D + màu sắc epic):',
    '     Chinese xianxia CG art style, 3D render style,',
    '     cel shading with depth, volumetric lighting,',
    '     subsurface scattering on skin, cinematic color grading,',
    '     dramatic depth of field, vivid saturated colors,',
    '     high contrast rim lighting, sharp crisp details',
    '',
    '  ❌ TUYỆT ĐỐI KHÔNG DÙNG (làm ảnh phẳng):',
    '     soft watercolor wash, watercolor texture,',
    '     flat shading, flat colors, pastel tones,',
    '     soft delicate brushwork, painted watercolor,',
    ...
    SEP80,
    '',
    'FILE TXT NÀY CHỈ CHỨA CÁC BLOCK [Dẫn Truyện] — không có lời thoại nhân vật.',
    'Mỗi block có cấu trúc như sau:',
    '',
    '  [Dẫn Truyện]',
    '  startTime: 0.000s',
    '  → duration: 12.500s →',
    ...
    '',
    SEP80,
    'PHẦN 2 — CẤU TRÚC PROMPT CHUẨN (150-200 TỪ)',
    SEP80,
    '',
    'MỖI PROMPT PHẢI CÓ ĐỦ 10 THÀNH PHẦN (viết thành 1 đoạn liền mạch):',
    '',
    '  [1] MODEL TAG    — Bắt buộc đầu tiên: [MODEL:animagine]',
    '',
    ...
    '                     ❌ SAI: "standing"',
    '                     ✅ ĐÚNG: "standing in dynamic battle-ready stance,',
    '                     right arm extended gripping sword hilt, body weight',
    '                     shifted forward onto front leg"',
    '',
    '  [4] APPEARANCE   — Mô tả ĐẦY ĐỦ 7 ĐIỂM (40-50 từ):',
    '                     (1) Tóc: màu + độ dài + kiểu tóc + phụ kiện',
    '                     (2) Mắt: màu + biểu cảm + hình dạng',
    '                     (3) Biểu cảm: cảm xúc cụ thể trên khuôn mặt',
    ...
    '                     • Thời gian: dawn/noon/dusk/night/golden hour',
    '                     • Thời tiết + yếu tố môi trường',
    '',
    '  [6] LIGHTING     — ★★★ CỰC KỲ QUAN TRỌNG ★★★ (30-40 từ):',
    '                     CÔNG THỨC 4 BƯỚC:',
    '                     B1: Nguồn sáng (sun/moon/fire/magic/neon)',
    '                     B2: Hướng sáng (from above/behind/below/side)',
    '                     B3: Hiệu ứng (volumetric lighting/rim light/god rays)',
    '                     B4: Màu sắc (warm amber/cool blue/vivid contrast)',
    '',
    '                     ✅ CHUẨN CHO ANIMAGINE 3D:',
    '                     "volumetric lighting from behind and above,',
    '                     dramatic god rays piercing through atmosphere,',
    '                     high contrast rim lighting outlining figure edge,',
    '                     warm amber highlights vs cool blue shadows,',
    '                     cinematic color grading, vivid saturated colors,',
    '                     sharp crisp details, deep rich tones"',
    '',
    '  [7] ATMOSPHERE   — Không khí tổng thể (10-15 từ)',
    '',
    '  [8] COMPOSITION  — Góc máy CỤ THỂ (15-20 từ):',
    '                     • Camera angle: wide/close-up/extreme low angle/bird eye',
    '                     • Framing: subject position',
    '                     • Depth: deep/shallow depth of field',
    '',
    '  [9] PARTICLE FX  — Hiệu ứng (10-15 từ):',
    '                     glowing spirit particles / embers / motion blur / mist',
    '',
    '  [10] STYLE+QUALITY — BẮT BUỘC CHO ANIMAGINE 3D (25-35 từ):',
    '                     "Chinese xianxia CG art style, 3D render style,',
    '                     cel shading with depth, volumetric lighting,',
    '                     subsurface scattering on skin,',
    '                     cinematic color grading, dramatic depth of field,',
    '                     vivid saturated colors, high contrast rim lighting,',
    '                     sharp crisp details,',
    '                     masterpiece, best quality, ultra-detailed,',
    '                     8K resolution, 16:9 aspect ratio,',
    '                     NO text, NO watermark, NO subtitles,',
    '                     NO UI elements, NO logo, NO signature,',
    '                     pure illustration only"',
    '',
    SEP80,
    'PHẦN 2.5 — TỪ KHÓA ÁNH SÁNG 3D CHO ANIMAGINE',
    SEP80,
    '',
    '★ ÁNH SÁNG QUYẾT ĐỊNH 70% CHẤT LƯỢNG ẢNH — MÔ TẢ 30-40 TỪ ★',
    '',
    '┌─────────────────────────────────────────────────────────────────────────┐',
    '│ TIÊN HIỆP / CẢNH THIÊN NHIÊN (Ethereal Epic)                          │',
    '├─────────────────────────────────────────────────────────────────────────┤',
    '│  • volumetric god rays piercing through mystical clouds from above     │',
    '│  • dramatic rim lighting creating glowing halo around figure           │',
    '│  • cool blue ambient light mixing with warm golden spiritual energy    │',
    '│  • deep atmospheric depth with layered fog and light shafts            │',
    '│  • subsurface scattering making skin glow from spiritual energy within │',
    '│  • cinematic color grading with vivid saturated tones                  │',
    '└─────────────────────────────────────────────────────────────────────────┘',
    '',
    '┌─────────────────────────────────────────────────────────────────────────┐',
    '│ CHIẾN ĐẤU / HÀNH ĐỘNG (Dramatic Combat)                               │',
    '├─────────────────────────────────────────────────────────────────────────┤',
    '│  • intense volumetric lighting from golden sunlight cutting through    │',
    '│    debris clouds, creating harsh sharp rim light on figure edge        │',
    '│  • warm amber energy highlights contrasting with cool blue shadows     │',
    '│  • explosive backlight creating dramatic silhouette with glow          │',
    '│  • deep shadows with vibrant energy color pops                         │',
    '│  • cinematic high contrast color grading, vivid saturated colors       │',
    '└─────────────────────────────────────────────────────────────────────────┘',
    '',
    '┌─────────────────────────────────────────────────────────────────────────┐',
    '│ LÃNG MẠN / NỘI TÂM (Soft Cinematic)                                   │',
    '├─────────────────────────────────────────────────────────────────────────┤',
    '│  • soft volumetric golden hour light from window or sky                │',
    '│  • gentle rim lighting outlining figure with warm glow                 │',
    '│  • bokeh background with warm ambient light                            │',
    '│  • cool blue shadows complementing warm golden highlights              │',
    '│  • cinematic color grading, vivid but soft tones                       │',
    '└─────────────────────────────────────────────────────────────────────────┘',
    '',
    '┌─────────────────────────────────────────────────────────────────────────┐',
    '│ KINH DỊ / TỐI TĂM (Dark Atmospheric)                                  │',
    '├─────────────────────────────────────────────────────────────────────────┤',
    '│  • cold blue-green moonlight filtering through fog                     │',
    '│  • single harsh upward lighting creating ominous face shadows          │',
    '│  • high contrast chiaroscuro with deep dramatic shadows                │',
    '│  • pale phosphorescent glow from unknown source                        │',
    '│  • desaturated palette with selective color pops                       │',
    '└─────────────────────────────────────────────────────────────────────────┘',
    '',
    'CÔNG THỨC ÁNH SÁNG 4 BƯỚC BẮT BUỘC:',
    '  B1: NGUỒN  → golden sunlight / cold moonlight / magical blue energy',
    '  B2: HƯỚNG  → from behind and above / from right side / from below',
    '  B3: HIỆU ỨNG → volumetric god rays / rim lighting / deep shadows',
    '  B4: MÀU    → warm amber + cool blue contrast / vivid saturated',
    '',
    SEP80,
    'PHẦN 3 — VÍ DỤ MẪU ANIMAGINE 3D STYLE (150-200 TỪ)',
    SEP80,
    '',
    SEP50,
    'VÍ DỤ 1: TIÊN HIỆP TU LUYỆN (ANIMAGINE 3D) — 190 từ',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine]',
    'A celestial female cultivator sitting gracefully in perfect lotus',
    'meditation posture on a massive floating jade platform suspended high',
    'above endless sea of clouds, both hands forming intricate ethereal',
    'lotus seal mudra at chest level, eyes gently closed in deep spiritual',
    'trance, serene expression with slight blissful smile,',
    'long flowing silver-white hair cascading down back like luminous waterfall,',
    'elaborate high bun secured by ornate golden phoenix hairpins inlaid with jade,',
    'delicate oval face with flawless luminous skin showing subtle inner glow,',
    'slender graceful immortal physique, wearing multiple layers of pristine',
    'white translucent immortal robes with intricate silver crane embroidery',
    'along flowing wide sleeves, silk fabric rippling gently in spiritual breeze,',
    'massive floating islands with jade pavilions visible in far distance,',
    'ancient sect mountain peaks barely visible through layered atmospheric mist,',
    'endless ocean of clouds stretching to horizon below,',
    'transcendent breakthrough cultivation atmosphere radiating divine serenity,',
    'volumetric god rays piercing majestically through mystical clouds from',
    'directly behind and above creating stunning divine rim light halo',
    'around entire figure, cool soft blue ambient light mixing beautifully',
    'with warm golden spiritual energy highlights on hair and robe edges,',
    'subsurface scattering making skin glow softly from spiritual energy within,',
    'cinematic color grading with vivid saturated blues and golds,',
    'deep rich atmospheric depth with layered mist and light shafts,',
    'epic wide establishing shot from slightly below eye level looking up,',
    'subject perfectly centered in frame, deep depth of field capturing',
    'vast infinite scale of heavenly realm,',
    'thousands of glowing cyan spirit particles floating like fireflies,',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering on skin,',
    'dramatic depth of field, vivid saturated colors, sharp crisp details,',
    ...
    'NO subtitles, NO UI elements, NO logo, NO signature, pure illustration only]',
    '[NEGATIVE: lowres, flat shading, flat colors, soft watercolor wash,',
    'watercolor texture, pastel flat tones, bad anatomy, bad hands,',
    'text, error, missing fingers, extra digit, fewer digits, cropped,',
    'worst quality, low quality, jpeg artifacts, signature, watermark,',
    'blurry, ugly, deformed face, long neck, extra limbs, bad proportions,',
    'dark muddy background, pitch black darkness, dull colors, 2D flat art]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP50,
    'VÍ DỤ 2: KIẾM HIỆP CHIẾN ĐẤU (ANIMAGINE 3D) — 185 từ',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine]',
    'A young male warrior in explosive mid-combat stance, right arm completing',
    'powerful horizontal sword slash with visible crescent-shaped cyan qi',
    'energy blade erupting from gleaming silver longsword, left arm extended',
    'back for perfect balance, body twisted in coiled spring combat form,',
    'medium-length jet-black hair tied with white silk ribbon whipping violently',
    'in self-generated wind pressure, loose strands covering half of intense face,',
    'sharp dark brown eyes blazing with absolute battle fury and laser focus,',
    'furrowed brow and clenched jaw showing warrior resolve,',
    'lean muscular athletic build with visible arm muscle definition,',
    'white flowing hanfu with blue geometric embroidery trim torn at right sleeve,',
    'fabric billowing dramatically from energy release shockwave,',
    'silver-sheathed longsword drawn and glowing with cyan energy,',
    'jade pendant emitting intense light at chest,',
    'ancient stone ruins battlefield with broken marble pillars and debris,',
    'stone ground cracking violently beneath feet from tremendous force impact,',
    'explosive debris radiating outward with suspended stone fragments mid-air,',
    'high-stakes battle atmosphere, adrenaline-fueled climax moment,',
    'intense volumetric lighting from golden sunlight cutting sharply through',
    'swirling debris clouds from right side, creating harsh sharp rim light',
    'along entire figure edge, warm amber energy highlights contrasting',
    'dramatically with cool blue shadow areas, explosive backlight creating',
    'dramatic depth and dimension, cinematic high contrast color grading,',
    'vivid saturated colors with deep rich shadows,',
    'extreme low angle camera looking up at 30-degree hero angle,',
    'diagonal dynamic composition, subject dominant in left-third frame,',
    'dramatic shallow depth of field with motion-blurred background,',
    'motion blur speed streaks on sword trajectory showing incredible velocity,',
    'glowing cyan spirit particles exploding outward from impact point,',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering on skin,',
    'dramatic depth of field, vivid saturated colors, sharp crisp details,',
    'masterpiece, best quality, ultra-detailed, 8K resolution,',
    ...
    '',
    SEP50,
    'VÍ DỤ 3: CẢNH QUAN HOÀNH TRÁNG (ANIMAGINE 3D) — 175 từ',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine]',
    'Breathtaking panoramic view of a vast Chinese xianxia world,',
    'hundreds of jagged jade-green mountain peaks of varying heights',
    'stretching infinitely to horizon, ancient sect buildings with curved',
    'golden rooftops perched dramatically on cliffsides connected by',
    'zigzagging stone staircases, massive waterfalls cascading thousands',
    'of meters into bottomless mist-filled chasms below,',
    'glowing spiritual energy veins pulsing blue-white through mountain rock,',
    'enormous dragon silhouette soaring majestically through distant golden clouds,',
    'dozens of tiny cultivator figures on flying swords visible as specks',
    'against vast mountain backdrop emphasizing incredible scale,',
    'twilight sky with twin glowing moons rising on horizon,',
    'epic grand atmospheric xianxia world-building scene,',
    'volumetric god rays from setting twin suns piercing magnificently through',
    'layered cloud formations from behind and above, illuminating entire',
    'mountain landscape with dramatic warm golden-orange light,',
    'deep atmospheric perspective with multiple distinct depth layers of mist,',
    'cool blue-purple shadows in mountain valleys contrasting with warm golden',
    'sunlit peaks, vibrant spiritual energy lines glowing cyan against deep',
    'blue sky, cinematic color grading with vivid rich saturated tones,',
    'dramatic deep atmospheric depth creating sense of infinite vast scale,',
    'epic ultra-wide panoramic aerial shot from high altitude,',
    'extreme deep depth of field keeping entire vast landscape crisp and sharp,',
    'thousands of golden light particles and spirit wisps floating throughout scene,',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering, dramatic depth of field,',
    'vivid saturated colors, sharp crisp details,',
    'masterpiece, best quality, ultra-detailed, 8K resolution,',
    'horizontal landscape orientation, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, NO words,',
    'NO Chinese characters, NO Japanese characters, NO Korean characters,',
    'NO subtitles, NO UI elements, NO logo, NO signature, pure illustration only]',
    '[NEGATIVE: lowres, flat shading, flat colors, soft watercolor wash,',
    'watercolor texture, pastel flat tones, bad anatomy,',
    'text, error, cropped, worst quality, low quality, jpeg artifacts,',
    'signature, watermark, blurry, dark muddy background,',
    'pitch black darkness, dull colors, 2D flat art, overexposed white sky]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP80,
    ...
    '',
    SEP50,
    'A. TIÊN HIỆP / TU TIÊN (Xianxia / Cultivation)',
    SEP50,
    'Nhận biết: tu luyện, linh khí, đột phá cảnh giới, tiên giới, linh đan, tông môn',
    'Model: [MODEL:animagine] — áp dụng cho TẤT CẢ cảnh tiên hiệp',
    '',
    'Style tags BẮT BUỘC:',
    '  Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    '  volumetric lighting, subsurface scattering on skin',
    '',
    'Màu sắc: xanh lam thiên thanh, vàng kim rực rỡ, trắng phát sáng, tím huyền bí',
    'Trang phục: tiên y nhiều lớp, đạo bào, áo trắng thêu hạc, mão quan',
    'Bối cảnh: tiên cảnh mây trắng, đảo nổi, đại điện ngọc, linh tuyền',
    'Đặc biệt: swirling spiritual energy ribbons, glowing spirit stones,',
    '          floating platforms, subsurface glowing skin from inner energy',
    '',
    'Ánh sáng chuẩn (copy & paste):',
    '  "volumetric god rays piercing through mystical clouds from behind and above,',
    '  dramatic divine rim lighting creating glowing halo around entire figure,',
    '  cool soft blue ambient light mixing beautifully with warm golden spiritual',
    '  energy highlights, subsurface scattering making skin glow from within,',
    '  cinematic color grading, vivid saturated blues and golds,',
    '  deep rich atmospheric depth"',
    '',
    SEP50,
    'B. KIẾM HIỆP / VÕ HIỆP (Wuxia)',
    SEP50,
    'Nhận biết: giang hồ, võ lâm, kiếm pháp, nội công, đại hiệp',
    'Model: [MODEL:animagine] — áp dụng cho TẤT CẢ cảnh kiếm hiệp',
    '',
    'Style tags BẮT BUỘC:',
    '  Chinese wuxia CG art style, 3D render style, cel shading with depth,',
    '  dynamic action composition, kinetic energy lines, cel shading with depth',
    '',
    'Màu sắc: đỏ thẫm, vàng đồng, xanh ngọc, trắng — vivid saturated',
    'Trang phục: hanfu chiến đấu, áo bào, giáp trụ, đai lưng, kiếm đeo hông',
    'Bối cảnh: núi hiểm trở, trúc lâm, đấu trường cổ, thác nước',
    'Đặc biệt: visible qi energy aura, sword energy trails, motion blur on weapons',
    '',
    'Ánh sáng chuẩn:',
    '  "intense volumetric lighting from golden sunlight cutting sharply through',
    '  debris clouds, creating harsh sharp rim light along entire figure edge,',
    '  warm amber energy highlights contrasting with cool blue shadow areas,',
    '  explosive backlight creating dramatic depth, cinematic high contrast',
    '  color grading, vivid saturated colors"',
    '',
    SEP50,
    'C. HỆ THỐNG / ISEKAI / NHẬP VÀO TRUYỆN',
    SEP50,
    'Nhận biết: hệ thống, level up, nhiệm vụ, dị giới, dungeon',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: fantasy RPG CG art style, 3D render style, cel shading with depth,',
    '            holographic UI aesthetic, vivid neon accent colors',
    'Màu sắc: xanh điện holographic, vàng hệ thống, tím huyền, trắng xanh',
    'Ánh sáng: magical holographic blue-green glow, dungeon torch firelight,',
    '          mystical particles in darkness, high contrast dramatic lighting',
    '',
    SEP50,
    'D. LÃNG MẠN / NGÔN TÌNH (Hiện đại + Cổ đại)',
    SEP50,
    'Nhận biết: tình yêu, CEO, hôn nhân, gặp lại người xưa, cung đấu lãng mạn',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: romantic CG illustration style, 3D render style,',
    '            cel shading with depth, cinematic color grading,',
    '            warm vivid tones, dramatic soft lighting',
    'Màu sắc: ấm áp vivid (vàng nắng, cam rực, hồng đậm, đỏ thẫm)',
    'Ánh sáng: soft volumetric golden light, warm rim lighting,',
    '          cool blue shadows vs warm golden highlights, bokeh depth effects',
    '',
    SEP50,
    'E. CỔ ĐẠI / LỊCH SỬ / CUNG ĐẤU',
    SEP50,
    'Nhận biết: hoàng cung, hậu cung, phi tần, thái tử, âm mưu',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: Chinese imperial court CG art style, 3D render style,',
    '            cel shading with depth, rich historical detail,',
    '            vivid royal color palette',
    'Màu sắc: đỏ cung đình rực, vàng hoàng gia, xanh ngọc bích, tím cao quý',
    'Ánh sáng: warm golden candlelight with flickering shadows,',
    '          volumetric incense smoke illuminated by light,',
    '          cool moonlight through palace window vs warm interior amber',
    '',
    SEP50,
    'F. KINH DỊ / MA QUỶ / LIÊU TRAI',
    SEP50,
    'Nhận biết: hồn ma, ám ảnh, ngôi nhà bỏ hoang, thực thể bóng tối',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: dark gothic CG art style, 3D render style,',
    '            high contrast chiaroscuro, cel shading with depth,',
    '            atmospheric horror lighting',
    'Màu sắc: xám tro, xanh lạnh tử thi, đỏ máu — desaturated với accent màu',
    'Ánh sáng: cold blue-green moonlight through fog, single pale phosphorescent',
    '          window glow, deep chiaroscuro shadows, upward harsh face lighting',
    '',
    SEP50,
    'G. CHIẾN TRANH / HÀNH ĐỘNG / QUÂN SỰ',
    SEP50,
    'Nhận biết: chiến trận, binh lính, vũ khí, chỉ huy, hy sinh',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: epic war CG art style, 3D render style, cel shading with depth,',
    '            cinematic battle composition, dramatic scale',
    'Màu sắc: xám thép, nâu đất, đỏ máu, khói đen — vivid accent colors',
    'Ánh sáng: volumetric smoke illuminated by dramatic backlight,',
    '          intense orange explosion light vs cold morning blue,',
    '          god rays through smoke clouds, high contrast battle lighting',
    '',
    SEP50,
    'H. TRINH THÁM / TỘI PHẠM / NOIR',
    SEP50,
    'Nhận biết: thám tử, vụ án, nghi phạm, điều tra, bí ẩn',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: noir detective CG art style, 3D render style,',
    '            high contrast dramatic shadows, cel shading with depth',
    'Màu sắc: đen trắng với accent đỏ/vàng, phản chiếu đường phố ướt',
    'Ánh sáng: single harsh overhead spotlight, deep face shadows,',
    '          neon reflections on wet pavement, cold blue-white fluorescent',
    '',
    SEP50,
    'I. KHOA HỌC VIỄN TƯỞNG / CYBERPUNK',
    SEP50,
    'Nhận biết: tương lai, robot, AI, tàu vũ trụ, ngoài hành tinh',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: futuristic sci-fi CG art style, 3D render style,',
    '            neon cyberpunk aesthetic, cel shading with depth,',
    '            holographic glow effects',
    'Màu sắc: neon cyan/magenta/yellow, trắng bạc lạnh',
    'Ánh sáng: vibrant neon lights reflecting on wet surfaces,',
    '          holographic billboard glow, high contrast colorful neon vs dark shadows',
    '',
    SEP50,
    'J. GIA ĐÌNH / ĐỜI THƯỜNG / SLICE OF LIFE',
    SEP50,
    'Nhận biết: gia đình, cuộc sống thường ngày, học đường, tình cảm bình dị',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: warm slice-of-life CG art style, 3D render style,',
    '            cel shading with depth, cozy natural lighting',
    'Màu sắc: ấm vivid (vàng nắng, cam, nâu gỗ, xanh trời)',
    'Ánh sáng: golden hour sunlight through curtains, dust particles in sunbeam,',
    '          warm cozy interior lighting, soft natural shadows',
    '',
    SEP50,
    'K. MA HỌC / DARK FANTASY',
    SEP50,
    'Nhận biết: pháp sư, ma thuật, nghi lễ, lời nguyền, bóng tối',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: dark fantasy CG art style, 3D render style,',
    '            dramatic magical lighting, cel shading with depth,',
    '            mystical atmosphere',
    'Màu sắc: đen tím thẫm, xanh đêm, ánh sáng ma thuật tương phản mạnh',
    'Ánh sáng: glowing ritual circle light from below, upward ominous face lighting,',
    '          dark shadow tendrils, vibrant magical energy glow vs deep darkness',
    '',
    SEP50,
    'L. ZOMBIE / TẬN THẾ / POST-APOCALYPTIC',
    SEP50,
    'Nhận biết: zombie, tận thế, sống sót, thế giới hoang tàn',
    'Model: [MODEL:animagine]',
    '',
    'Style tags: post-apocalyptic CG art style, 3D render style,',
    '            gritty cel shading with depth, harsh environmental lighting',
    'Màu sắc: xám hoang tàn, nâu bụi, đỏ rỉ sét, xanh lạnh',
    'Ánh sáng: harsh cold overcast light through ash atmosphere,',
    '          desaturated apocalyptic lighting, ash particles in air,',
    '          selective warm color pops from fire or emergency lights',
    '',
    SEP80,
    'PHẦN 5 — QUY TẮC NHÂN VẬT NHẤT QUÁN',
    SEP80,
    '',
    ...
    '  (1) Giới tính + tuổi ngoại hình',
    '  (2) Màu tóc + kiểu tóc + phụ kiện',
    '  (3) Màu mắt + biểu cảm đặc trưng',
    '  (4) Đặc điểm nhận diện (scar, tattoo, birthmark)',
    '  (5) Trang phục màu + chất liệu + chi tiết',
    '  (6) Vũ khí / đạo cụ cố định + vị trí',
    '  (7) Vóc dáng + thể hình',
    '',
    'QUY TRÌNH 4 BƯỚC:',
    '  B1: Đọc lướt toàn bộ file — liệt kê TẤT CẢ nhân vật',
    '  B2: Xây CHARACTER SHEET chi tiết cho từng nhân vật',
    '  B3: Lần đầu xuất hiện → mô tả ĐẦY ĐỦ cả 7 điểm (40-50 từ)',
    '  B4: Lần sau → COPY y chang 7 điểm, CHỈ đổi action/pose/expression',
    '',
    '★ Tóc, mắt, scar, vóc dáng, trang phục, vũ khí — KHÔNG BAO GIỜ ĐỔI ★',
    '',
    SEP80,
    'PHẦN 6 — QUY TẮC CỨNG TUYỆT ĐỐI',
    SEP80,
    '',
    ...
    '',
    '━━ RULE 2: TỶ LỆ + QUALITY TAGS BẮT BUỘC ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Luôn thêm: masterpiece, best quality, ultra-detailed, 8K resolution,',
    '           horizontal landscape orientation, 16:9 aspect ratio',
    '',
    '━━ RULE 3: NEGATIVE PROMPT BẮT BUỘC ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'DÙNG CHO MỌI PROMPT ANIMAGINE:',
    '  [NEGATIVE: lowres, flat shading, flat colors, soft watercolor wash,',
    '  watercolor texture, pastel flat tones, 2D flat art,',
    '  bad anatomy, bad hands, text, error, missing fingers, extra digit,',
    '  fewer digits, cropped, worst quality, low quality, normal quality,',
    '  jpeg artifacts, signature, watermark, username, blurry, ugly,',
    '  duplicate, mutilated, out of frame, extra limbs, bad proportions,',
    '  deformed face, long neck, dark muddy background,',
    '  pitch black darkness, dull colors, overexposed white]',
    '',
    '━━ RULE 4: STYLE 3D BẮT BUỘC — KHÔNG ĐƯỢC BỎ QUA ━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'LUÔN THÊM vào cuối mỗi prompt trước quality tags:',
    '  Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    '  volumetric lighting, subsurface scattering on skin,',
    '  cinematic color grading, dramatic depth of field,',
    '  vivid saturated colors, high contrast rim lighting, sharp crisp details',
    '',
    'TUYỆT ĐỐI KHÔNG DÙNG:',
    '  soft watercolor wash, watercolor texture, flat shading,',
    '  pastel tones, soft delicate brushwork, Unreal Engine 5,',
    '  ray tracing, photorealistic, 35mm film',
    '',
    '━━ RULE 5: ĐỘ DÀI PROMPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Tối thiểu 120 từ — Lý tưởng 150-200 từ — Toàn bộ tiếng Anh',
    '',
    '━━ RULE 6: ÁNH SÁNG PHẢI CỤ THỂ 30-40 TỪ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    '❌ SAI: "good lighting, dramatic"',
    '✅ ĐÚNG: "volumetric god rays from golden sunlight piercing through',
    'mystical clouds from behind and above, creating dramatic divine rim light',
    'halo around entire figure, cool blue ambient mixing with warm golden',
    'highlights, cinematic color grading, vivid saturated tones"',
    '',
    SEP80,
    ...
    '',
    '[IMAGE PROMPT: [MODEL:animagine]',
    '[SUBJECT 30-40 từ: nhân vật/cảnh quan + hành động + tư thế cụ thể],',
    '[APPEARANCE 40-50 từ: tóc, mắt, biểu cảm, vóc dáng, trang phục, vũ khí, đặc điểm],',
    '[SETTING 25-35 từ: địa điểm, thời gian, thời tiết, môi trường chi tiết],',
    '[ATMOSPHERE 10-15 từ: không khí và cảm xúc tổng thể],',
    '[LIGHTING 30-40 từ: B1-nguồn sáng, B2-hướng, B3-hiệu ứng, B4-màu+mood],',
    '[COMPOSITION 15-20 từ: góc máy, framing, depth of field],',
    '[PARTICLE FX 10-15 từ: hiệu ứng hạt và chuyển động],',
    'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
    'volumetric lighting, subsurface scattering on skin,',
    'cinematic color grading, dramatic depth of field,',
    'vivid saturated colors, high contrast rim lighting, sharp crisp details,',
    ...
    'signature, watermark, blurry, ugly, deformed face, long neck,',
    'extra limbs, bad proportions, dark muddy background,',
    'pitch black darkness, dull colors, overexposed white]',
    ...
    'B1: Thay TẤT CẢ [MODEL:animagine] → [MODEL:gpt-image-2]',
    'B2: Mở Genspark AI Agent — paste lệnh:',
    '    "Read this TXT carefully. For each [IMAGE PROMPT] block, generate an image',
    '    using GPT Image 2, save to AI Drive with EXACT filename from [FILE:] tag.',
    '    Process all scenes in order. Ignore all [NEGATIVE:] lines."',
    'B3: Paste toàn bộ nội dung TXT ngay sau lệnh',
    'B4: Chờ Agent tạo và lưu ảnh vào Drive tự động',
    '',
    '━━ WORKFLOW B: CHATGPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: Thay TẤT CẢ model tag → [MODEL:gpt-image-2]',
    'B2: Paste file TXT + yêu cầu generate image theo từng [IMAGE PROMPT] block',
    '',
    '━━ WORKFLOW C: GEMINI ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: Thay TẤT CẢ model tag → [MODEL:imagen3]',
    'B2: Paste từng block và đặt tên theo [FILE:] tag',
    '',
    '━━ WORKFLOW D: COLAB SDXL ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: GIỮ NGUYÊN [MODEL:animagine] trong file',
    'B2: Upload file TXT lên Google Drive',
    'B3: Chạy Colab notebook — tự đọc [MODEL:], [FILE:], [NEGATIVE:]',
    ...
    SEP80,
    '',
    '☑ Prompt có đủ 150-200 từ?',
    '☑ Ánh sáng mô tả CỤ THỂ 30-40 từ (nguồn + hướng + hiệu ứng + màu)?',
    '☑ Nhân vật mô tả ĐẦY ĐỦ 7 điểm (40-50 từ)?',
    '☑ Nhân vật NHẤT QUÁN xuyên suốt file?',
    '☑ Có style 3D tags: "3D render style, cel shading with depth,',
    '   volumetric lighting, subsurface scattering, cinematic color grading"?',
    '☑ KHÔNG có: watercolor, soft brushwork, flat shading, pastel tones?',
    '☑ Có "vivid saturated colors, sharp crisp details"?',
    '☑ Có góc máy CỤ THỂ + depth of field?',
    '☑ Có "NO text, NO watermark..." đầy đủ?',
    '☑ Có [NEGATIVE:] với đủ flat/watercolor/dull terms?',
    '☑ Có "16:9 aspect ratio"?',
    '☑ Dòng [FILE:] GIỮ NGUYÊN?',
    '',
    SEP80,
    'TÓM TẮT NHANH — 5 ĐIỂM QUAN TRỌNG NHẤT v5.0',
    SEP80,
    '',
    '1. MODEL: Chỉ dùng [MODEL:animagine] cho TẤT CẢ thể loại',
    '2. STYLE 3D: "Chinese xianxia CG art style, 3D render style,',
    '   cel shading with depth, volumetric lighting,',
    '   subsurface scattering on skin, cinematic color grading"',
    '3. ÁNH SÁNG: 30-40 từ — volumetric god rays + rim lighting +',
    '   warm/cool contrast + cinematic color grading',
    '4. NHÂN VẬT: 7 điểm nhất quán + vivid saturated colors + sharp crisp details',
    '5. NEGATIVE: Bắt buộc có flat shading, watercolor wash, dull colors,',
    '   2D flat art trong [NEGATIVE:]',
    '',
    SEP80,
