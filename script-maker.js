...
// ==============================================================================
// XUẤT 1 FILE TXT UNIVERSAL (COLAB + GENSPARK + CHATGPT + GEMINI)
// Chỉ xuất block [Dẫn Truyện] — bỏ hoàn toàn [Giọng Nam]/[Giọng Nữ]
// ==============================================================================
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    // ══════════════════════════════════════════════════════════════════════════
    // HEADER FILE 1 — COLAB (TỐI ƯU 77 TOKEN ANIMAGINE XL)
    // ══════════════════════════════════════════════════════════════════════════
    var headerColab = [
        SEP80,
        '╔══════════════════════════════════════════════════════════════════════════════╗',
        '║   IMAGE PROMPT — COLAB ANIMAGINE XL (77-TOKEN OPTIMIZED)                  ║',
        '║   ⚡ STYLE TAGS ĐẦU TIÊN → CHARACTER → SETTING → LIGHTING → NO TEXT       ║',
        '║   📖 ĐỌC CẢ [Giọng Nam] + [Giọng nữ] ĐỂ HIỂU NGỮ CẢNH — KHÔNG TẠO PROMPT║',
        '╚══════════════════════════════════════════════════════════════════════════════╝',
        SEP80,
        '',
        '⚡ NGUYÊN TẮC 77 TOKEN — ĐỌC KỸ TRƯỚC KHI VIẾT PROMPT',
        SEP50,
        'Animagine XL chỉ đọc hiệu quả 77 TOKEN ĐẦU TIÊN (~55-65 từ).',
        'Phần sau token 77 bị CẮT HOÀN TOÀN — không phải giảm trọng số mà là MẤT HẲN.',
        '',
        'THỨ TỰ BẮT BUỘC TRONG 77 TOKEN ĐẦU:',
        '  [TOKEN 1-15 ]  ← STYLE TAGS (quan trọng nhất — model nhận diện phong cách)',
        '  [TOKEN 16-25]  ← 1boy/1girl + tên nhân vật + độ tuổi',
        '  [TOKEN 26-45]  ← Appearance cốt lõi: tóc, mắt, trang phục (RÚT GỌN)',
        '  [TOKEN 46-58]  ← Action + Setting ngắn gọn',
        '  [TOKEN 59-68]  ← Lighting hint (nguồn + màu)',
        '  [TOKEN 69-77]  ← Quality + NO text + 16:9',
        '  [TOKEN 78+  ]  ← Vẫn viết thêm nhưng trọng số thấp hơn (bổ sung chi tiết)',
        '',
        'VÍ DỤ ĐÚNG — 68 từ active trong 77 token:',
        '  [MODEL:animagine] manhua comic style, clean anime linework,',
        '  xianxia character art, crisp cel shading, masterpiece, best quality,',
        '  1boy, Xu Fan, adult male cultivator, jet-black hair half-tied jade clasp,',
        '  calm dark brown eyes beauty mark, white pale-blue daoist robes silver embroidery,',
        '  standing relaxed teasing smile raised hand, bamboo courtyard afternoon,',
        '  warm golden rim light cool green shadows, bright vivid ultra sharp,',
        '  NO text NO watermark pure illustration 16:9,',
        '  [TOKEN 78+] quiet bamboo-shadowed courtyard polished flagstones low tea table...',
        '',
        SEP80,
        'PHẦN 1 — CẤU TRÚC FILE VÀ QUY TẮC ĐỌC',
        SEP80,
        '',
        'FILE NÀY CHỨA 3 LOẠI BLOCK:',
        '',
        '  [Dẫn Truyện] → CÓ [IMAGE PROMPT] → BẮT BUỘC VIẾT PROMPT',
        '  [Giọng Nam]  → KHÔNG có [IMAGE PROMPT] → CHỈ ĐỌC ĐỂ HIỂU NGỮ CẢNH',
        '  [Giọng nữ]   → KHÔNG có [IMAGE PROMPT] → CHỈ ĐỌC ĐỂ HIỂU NGỮ CẢNH',
        '',
        'CÁCH ĐỌC ĐÚNG:',
        '  1. Đọc [Giọng Nam]/[Giọng nữ] trước/sau để hiểu:',
        '     • Nhân vật đang nói gì → xác định biểu cảm chính xác',
        '     • Cảm xúc thật sự: vui/buồn/tức/ngạc nhiên/xúc động',
        '     • Mức độ căng thẳng của scene: gay cấn/nhẹ nhàng/hài hước',
        '  2. Chỉ viết prompt cho block [Dẫn Truyện] có [IMAGE PROMPT: CHƯA TẠO]',
        '  3. KHÔNG viết prompt cho [Giọng Nam] hay [Giọng nữ]',
        '',
        'VÍ DỤ ĐỌC NGỮ CẢNH:',
        '  [Dẫn Truyện]: Từ Phàm nhìn Trảm Linh...',
        '  [Giọng Nam]: "Ngươi dám phản bội ta?!"',
        '  → Prompt cần: furious expression, pointing accusatory gesture, intense angry eyes',
        '  → KHÔNG viết: calm relaxed expression (sai hoàn toàn với lời thoại)',
        '',
        'CẤU TRÚC MỖI BLOCK [Dẫn Truyện]:',
        '',
        '  [Dẫn Truyện]',
        '  startTime: 0.000s',
        '  → duration: 12.500s →',
        '  [IMAGE PROMPT: CHƯA TẠO]   ← THAY THẾ DÒNG NÀY',
        '  [FILE: scene_00000.000s.jpg]   ← GIỮ NGUYÊN 100%',
        '  Văn bản tường thuật...',
        '',
        'QUY TẮC CỨNG:',
        '  ✅ Thay [IMAGE PROMPT: CHƯA TẠO] bằng prompt tiếng Anh',
        '  ✅ GIỮ NGUYÊN dòng [FILE: scene_xxxxx.xxxs.jpg]',
        '  ✅ GIỮ NGUYÊN toàn bộ dòng [Giọng Nam] và [Giọng nữ]',
        '  ❌ KHÔNG xóa, KHÔNG sửa bất kỳ dòng nào khác',
        '  ❌ KHÔNG dùng markdown hay ngoặc kép trong prompt',
        '',
        SEP80,
        'PHẦN 2 — CẤU TRÚC PROMPT 77-TOKEN OPTIMIZED',
        SEP80,
        '',
        'TEMPLATE CHUẨN (55-65 từ active, thêm 50-80 từ bổ sung sau):',
        '',
        '  [MODEL:animagine] [STYLE TAGS 10-15 từ],',
        '  masterpiece, best quality,',
        '  [1boy/1girl], [tên nhân vật], [độ tuổi + nghề],',
        '  [tóc: màu + kiểu], [mắt: màu], [trang phục: màu + loại],',
        '  [action ngắn gọn 5-8 từ], [setting ngắn gọn 5-8 từ],',
        '  [lighting: nguồn + màu 8-10 từ],',
        '  bright vivid ultra sharp, NO text NO watermark 16:9,',
        '  [TOKEN 78+: chi tiết bổ sung không giới hạn]',
        '',
        'STYLE TAGS THEO THỂ LOẠI (đặt ĐẦU TIÊN — token 1-15):',
        '',
        '  Tiên hiệp sáng  → manhua comic style, clean anime linework, xianxia art, cel shading',
        '  Tiên hiệp tối   → dark fantasy xianxia, dramatic CG art, gritty cel shading',
        '  Chiến đấu epic  → Chinese fantasy game cinematic, Honor of Kings art, dramatic 3D',
        '  Phong cảnh      → Chinese xianxia matte painting, epic fantasy landscape, ethereal',
        '  Cảm xúc/thoại  → manhua portrait style, expressive linework, soft cel shading',
        '  Kinh dị         → dark gothic horror illustration, high contrast chiaroscuro',
        '  Lãng mạn        → soft romantic webtoon style, dreamy bokeh, pastel tones',
        '  Hiện đại        → cinematic urban photography, realistic, modern setting',
        '',
        'LIGHTING NGẮN GỌN CHO 77 TOKEN (8-12 từ — đặt token 59-68):',
        '',
        '  Ngày sáng   → warm golden sunlight rim light cool blue shadows',
        '  Chiều tà    → orange-amber sunset backlight dramatic rim',
        '  Đêm         → cool moonlight silver glow deep shadows',
        '  Ma thuật    → cyan spiritual glow warm golden accents',
        '  Chiến đấu   → explosive sparks backlight harsh rim dark smoke',
        '  Buổi sáng   → soft dawn light misty golden rays',
        '',
        'CHARACTER 20 TỪ CỐ ĐỊNH (copy y chang mọi scene):',
        '  Xây 1 lần: [giới tính + tuổi], [tóc: màu+kiểu], [mắt: màu],',
        '             [trang phục: màu+loại], [1 đặc điểm nhận diện]',
        '  VD Từ Phàm: adult male cultivator, jet-black hair half-tied jade clasp,',
        '              calm dark brown eyes beauty mark, white pale-blue daoist robes',
        '',
        'SCENE TYPE → STYLE SELECTION:',
        '',
        '  Cảnh sáng + đối thoại nhẹ   → manhua comic style, clean anime linework',
        '  Cảnh tối + chiến đấu intense → dark fantasy cinematic, dramatic 3D CG',
        '  Cảnh phong cảnh rộng         → xianxia matte painting, epic landscape',
        '  Cảnh cảm xúc mạnh            → expressive portrait, soft cel shading',
        '  Cảnh đêm + bí ẩn             → atmospheric dark, moonlight chiaroscuro',
        '',
        SEP80,
        'PHẦN 3 — VÍ DỤ CHUẨN 77 TOKEN',
        SEP80,
        '',
        SEP50,
        'VÍ DỤ 1: CẢNH ĐỐI THOẠI NHẸ NHÀNG (BAN NGÀY)',
        SEP50,
        '',
        '[IMAGE PROMPT: [MODEL:animagine] manhua comic style, clean anime linework,',
        'xianxia character art, crisp cel shading, masterpiece, best quality,',
        '1boy, Xu Fan, adult male cultivator, jet-black hair half-tied jade clasp,',
        'calm dark brown eyes beauty mark under left eye, white pale-blue daoist robes',
        'silver cloud embroidery, standing relaxed teasing smile raised hand,',
        'bamboo courtyard afternoon, warm golden rim light cool green shadows,',
        'bright vivid ultra sharp, NO text NO watermark pure illustration 16:9,',
        'quiet bamboo-shadowed courtyard polished flagstones low tea table curved railings',
        'pale blossoms cloud sea visible beyond pavilion, playful relaxed atmosphere,',
        'medium shot eye level subject left-third shallow depth of field,',
        'floating dust motes drifting leaf shadows faint spirit particles in sunlight]',
        '[NEGATIVE: lowres, bad anatomy, bad hands, text, watermark, blurry,',
        'deformed face, extra limbs, dark muddy background, dull colors, flat lighting]',
        '[FILE: scene_00033.212s.jpg]',
        '',
        SEP50,
        'VÍ DỤ 2: CẢNH CHIẾN ĐẤU TỐI (ĐÊM/DRAMATC)',
        SEP50,
        '',
        '[IMAGE PROMPT: [MODEL:animagine] Chinese fantasy game cinematic art,',
        'Honor of Kings character design, dramatic 3D illustration, bold rim lighting,',
        'masterpiece, best quality,',
        '1boy, Xu Fan, adult male cultivator, jet-black hair loose battle-disheveled,',
        'fierce dark brown eyes blazing fury beauty mark, torn white daoist robes',
        'silver embroidery battle-damaged, dynamic sword-strike mid-combat stance,',
        'stone ruins battlefield dusk, explosive golden sparks harsh backlight dark smoke,',
        'bright vivid ultra sharp, NO text NO watermark pure illustration 16:9,',
        'ancient crumbling stone battlefield broken marble pillars scattered weapons,',
        'explosive high-stakes battle atmosphere adrenaline-fueled climax,',
        'extreme low angle 30-degree hero shot subject left-third shallow DOF,',
        'motion blur sword trajectory flying debris dust clouds erupting]',
        '[NEGATIVE: lowres, bad anatomy, text, watermark, blurry, deformed face,',
        'soft lighting, pastel colors, static pose, flat shading]',
        '[FILE: scene_00062.488s.jpg]',
        '',
        SEP50,
        'VÍ DỤ 3: CẢNH PHONG CẢNH KHÔNG NHÂN VẬT',
        SEP50,
        '',
        '[IMAGE PROMPT: [MODEL:animagine] Chinese xianxia matte painting,',
        'epic fantasy landscape concept art, ethereal soft brushwork, luminous glow,',
        'masterpiece, best quality,',
        'grand Hidden Spirit Sect sprawling across jade-green mountain peaks,',
        'ancient pagodas golden roofs cliff faces waterfalls cascading cloud sea,',
        'pine forests floating islands jade pavilions distant silhouettes,',
        'dramatic golden-hour sunset warm amber god rays cool teal-blue shadows,',
        'bright vivid ultra sharp, NO text NO watermark pure illustration 16:9,',
        'ultra-wide panoramic establishing shot aerial three-quarter view,',
        'extreme depth of field dense volumetric fog cloud sea glowing runes gates,',
        'majestic serene spiritually tranquil otherworldly immortal realm atmosphere]',
        '[NEGATIVE: people in foreground, close-up, flat lighting, oversaturated,',
        'text, watermark, blurry, worst quality, dull tones]',
        ...
        SEP80,
        '',
        '━━ RULE 1: STYLE TAGS PHẢI Ở TOKEN 1-15 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        '❌ SAI: 1boy, Xu Fan... [rồi mới đến] manhua comic style',
        '✅ ĐÚNG: manhua comic style, clean linework... [rồi mới đến] 1boy, Xu Fan',
        '',
        '━━ RULE 2: CHỌN STYLE THEO ÁNH SÁNG CẢNH ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Cảnh SÁNG/NHẸ NHÀNG  → manhua comic style, clean anime linework',
        'Cảnh TỐI/CHIẾN ĐẤU   → Chinese fantasy game cinematic, dramatic 3D CG',
        'Cảnh PHONG CẢNH      → xianxia matte painting, epic fantasy landscape',
        '',
        '━━ RULE 3: CHARACTER 20 TỪ — COPY Y CHANG ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Xây character sheet lần đầu → copy y chang mọi cảnh → chỉ đổi action/expression',
        '',
        '━━ RULE 4: LIGHTING NGẮN GỌN CHO TOKEN 59-68 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Chỉ 8-12 từ trong vùng token ưu tiên, chi tiết hơn đặt sau token 77',
        '',
        '━━ RULE 5: QUALITY TAGS + NO TEXT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Luôn có: masterpiece, best quality, bright vivid ultra sharp,',
        '         NO text NO watermark pure illustration 16:9',
        '',
        SEP80,
        'BẮT ĐẦU XỬ LÝ — ĐỌC THOẠI → CHỌN STYLE → STYLE TAGS ĐẦU TIÊN → VIẾT PROMPT',
        SEP80,
        ''
    ];

    // ══════════════════════════════════════════════════════════════════════════
    // HEADER FILE 2 — BANANA (KHÔNG GIỚI HẠN TOKEN - 150-200 TỪ)
    // ══════════════════════════════════════════════════════════════════════════
    var headerBanana = [
        SEP80,
        '╔══════════════════════════════════════════════════════════════════════════════╗',
        '║   IMAGE PROMPT — BANANA / GENSPARK / CHATGPT (FULL DETAIL 150-200 WORDS)  ║',
        '║   🌟 12 STYLES × 8 GENRES — TỰ ĐỘNG CHỌN STYLE THEO CẢNH 🌟              ║',
        '║   📖 ĐỌC CẢ [Giọng Nam] + [Giọng nữ] ĐỂ HIỂU NGỮ CẢNH — KHÔNG TẠO PROMPT║',
        '╚══════════════════════════════════════════════════════════════════════════════╝',
        SEP80,
        '',
        '┌─────────────────────────────────────────────────────────────────────────────┐',
        '│  FILE NÀY DÙNG CHO: Banana · Genspark Agent · ChatGPT · Gemini            │',
        '│  KHÔNG GIỚI HẠN TOKEN — Viết đầy đủ 150-200 từ mỗi prompt                │',
        '│  Model tag: [MODEL:animagine] giữ nguyên hoặc đổi theo nền tảng           │',
        '└─────────────────────────────────────────────────────────────────────────────┘',
        '',
        SEP80,
        'PHẦN 1 — CẤU TRÚC FILE VÀ QUY TẮC ĐỌC',
        ...
        'FILE NÀY CHỨA 3 LOẠI BLOCK:',
        '',
        '  [Dẫn Truyện] → CÓ [IMAGE PROMPT] → BẮT BUỘC VIẾT PROMPT 150-200 TỪ',
        '  [Giọng Nam]  → KHÔNG có [IMAGE PROMPT] → CHỈ ĐỌC ĐỂ HIỂU NGỮ CẢNH',
        '  [Giọng nữ]   → KHÔNG có [IMAGE PROMPT] → CHỈ ĐỌC ĐỂ HIỂU NGỮ CẢNH',
        '',
        'CÁCH ĐỌC NGỮ CẢNH TỪ LỜI THOẠI:',
        '  • [Giọng Nam]/[Giọng nữ] cho biết cảm xúc thật của nhân vật',
        '  • Lời thoại tức giận → furious expression, clenched jaw, intense glare',
        '  • Lời thoại vui vẻ   → warm smile, relaxed posture, bright eyes',
        '  • Lời thoại buồn     → downcast eyes, slumped shoulders, trembling lips',
        '  • Lời thoại ra lệnh  → authoritative stance, commanding gesture',
        '',
        SEP80,
        'PHẦN 2 — DECISION TREE: TỰ ĐỘNG CHỌN STYLE',
        SEP80,
        '',
        'BƯỚC 1: PHÁT HIỆN ÁNH SÁNG CẢNH (quan trọng nhất)',
        '',
        '  CẢNH SÁNG/BAN NGÀY/NHẸ NHÀNG:',
        '    → manhua comic style, clean precise anime linework, xianxia character art,',
        '       crisp cel shading with soft shadows, detailed face rendering',
        '',
        '  CẢNH TỐI/ĐÊM/CHIẾN ĐẤU INTENSE:',
        '    → Chinese fantasy game cinematic art style, Honor of Kings character design,',
        '       dramatic 3D rendered illustration, bold dynamic composition,',
        '       intense rim lighting, volumetric fire and energy effects',
        '',
        '  CẢNH PHONG CẢNH RỘNG (không nhân vật):',
        ...
        '',
        '  CẢNH CẢM XÚC MẠNH/CHÂN DUNG:',
        '    → Expressive portrait style, soft anime linework, emotional close-up,',
        '       detailed face rendering, shallow depth of field',
        '',
        'BƯỚC 2: PHÁT HIỆN THỂ LOẠI (genre)',
        '',
        '  Tiên hiệp/Tu tiên  → Style A (xianxia)',
        '  Chiến đấu epic     → Style B (game cinematic)',
        '  Tình cảm/Lãng mạn  → Style C (romantic soft)',
        '  Kinh dị/Huyền bí   → Style D (dark atmospheric)',
        '  Hiện đại/Đô thị    → Style E (urban realistic)',
        '  Cung đấu/Cổ trang  → Style F (palace drama)',
        '  Sci-fi/Cyberpunk   → Style G (futuristic)',
        '  Hành động/Phiêu lưu→ Style H (action adventure)',
        '',
        SEP80,
        'PHẦN 3 — 8 STYLE TEMPLATES CHI TIẾT',
        SEP80,
        '',
        SEP50,
        'STYLE A: XIANXIA (Tiên hiệp — Cảnh sáng, đối thoại, tu luyện)',
        SEP50,
        'STYLE TAGS: manhua comic style, clean precise anime linework, xianxia character art,',
        '            crisp cel shading with soft shadows, detailed face rendering, expressive eyes',
        'LIGHTING:   warm golden sunlight + cool blue ambient shadows + rim light on robes',
        'EFFECTS:    floating spirit particles, glowing jade elements, billowing robes',
        'NEGATIVE:   lowres, bad anatomy, text, watermark, blurry, deformed face,',
        '            dark muddy background, dull colors, flat lighting, 3D render',
        '',
        SEP50,
        'STYLE B: GAME CINEMATIC (Chiến đấu epic, cảnh tối, boss fight)',
        SEP50,
        'STYLE TAGS: Chinese fantasy game cinematic art style, Honor of Kings character design,',
        '            dramatic 3D rendered illustration, bold dynamic composition,',
        '            intense rim lighting, volumetric fire and energy effects, detailed armor',
        'LIGHTING:   explosive golden sparks + harsh backlight + dark volumetric smoke',
        'EFFECTS:    flying debris, motion blur, energy trails, shockwave distortion',
        'NEGATIVE:   lowres, bad anatomy, text, watermark, soft lighting, pastel colors,',
        '            static pose, flat shading, cartoon, 2D anime',
        '',
        SEP50,
        'STYLE C: ROMANTIC SOFT (Tình cảm, lãng mạn, khoảnh khắc ngọt ngào)',
        SEP50,
        'STYLE TAGS: soft romantic webtoon art style, dreamy film photography bokeh aesthetic,',
        '            pastel soft colors, warm golden hour tones, luminous skin rendering',
        'LIGHTING:   soft diffused golden-hour sunlight + gentle rim glow + dreamy bokeh',
        'EFFECTS:    falling flower petals, bokeh circles, soft focus halo, light leaks',
        'NEGATIVE:   harsh lighting, dark tones, dramatic shadows, cold colors,',
        '            text, watermark, action poses, battle elements',
        '',
        SEP50,
        'STYLE D: DARK ATMOSPHERIC (Kinh dị, huyền bí, đêm tối)',
        SEP50,
        'STYLE TAGS: dark atmospheric horror concept art, high contrast chiaroscuro,',
        '            painterly gothic texture, supernatural atmosphere, dramatic shadows',
        'LIGHTING:   cold blue-green moonlight + sickly phosphorescent glow + deep shadows',
        'EFFECTS:    volumetric fog, ghostly apparitions, glowing eyes in darkness',
        'NEGATIVE:   bright cheerful colors, daylight, happy atmosphere, text, watermark',
        '',
        SEP50,
        'STYLE E: URBAN REALISTIC (Hiện đại, đô thị, realistic)',
        SEP50,
        'STYLE TAGS: cinematic urban photography, realistic modern commercial photography,',
        '            natural lighting, photorealistic details, cinematic color grading',
        'LIGHTING:   natural daylight or neon city lights + rain reflections + lens flare',
        'EFFECTS:    motion blur, rain droplets, reflections, depth of field',
        'NEGATIVE:   fantasy elements, anime style, magical effects, text, watermark',
        '',
        SEP50,
        'STYLE F: PALACE DRAMA (Cung đấu, cổ trang, hoàng gia)',
        SEP50,
        'STYLE TAGS: luxurious Chinese palace drama cinematography, period drama style,',
        '            royal red-gold-purple palette, rich silk textures, jade green accents',
        'LIGHTING:   warm candlelight flickering + soft ambient glow + jewelry sparkle',
        'EFFECTS:    incense smoke rising, silk fabric sheen, gold accent glints',
        'NEGATIVE:   casual modern clothing, harsh lighting, text, watermark',
        '',
        SEP50,
        'STYLE G: SCI-FI CYBERPUNK (Tương lai, neon city)',
        SEP50,
        'STYLE TAGS: cyberpunk digital art, blade runner aesthetic,',
        '            neon cyan-magenta-yellow palette, dark urban blacks, metallic silver',
        'LIGHTING:   bright neon reflections on wet streets + holographic glow + harsh contrast',
        'EFFECTS:    holographic UI overlays, rain drops, neon reflections, digital glitches',
        'NEGATIVE:   natural landscape, medieval, soft pastel, text, watermark',
        '',
        SEP50,
        'STYLE H: ACTION ADVENTURE (Phiêu lưu, hành động outdoor)',
        SEP50,
        'STYLE TAGS: cinematic action film style, adventure movie photography,',
        '            high contrast saturated colors, earthy tones, dramatic skies',
        'LIGHTING:   dramatic outdoor sunlight + storm lighting + dynamic rim lighting',
        'EFFECTS:    motion blur, dust clouds, water splashes, wind-blown, explosions',
        'NEGATIVE:   static pose, soft lighting, indoor studio, plain background, text, watermark',
        '',
        SEP80,
        'PHẦN 4 — CẤU TRÚC PROMPT 150-200 TỪ (10 THÀNH PHẦN)',
        SEP80,
        '',
        'MỖI PROMPT PHẢI CÓ ĐỦ 10 THÀNH PHẦN:',
        '',
        '  [1] MODEL TAG    → [MODEL:animagine] — bắt buộc đầu tiên',
        '  [2] STYLE TAGS   → 15-20 từ theo style đã chọn',
        '  [3] SUBJECT      → 1boy/1girl + mô tả nhân vật/cảnh (10-15 từ)',
        '  [4] APPEARANCE   → 7 điểm: tóc, mắt, biểu cảm, vóc dáng, trang phục,',
        '                     vũ khí/phụ kiện, đặc điểm nhận diện (40-50 từ)',
        '  [5] ACTION/POSE  → hành động cụ thể (15-20 từ)',
        '  [6] SETTING      → địa điểm, thời gian, thời tiết (20-25 từ)',
        '  [7] ATMOSPHERE   → không khí tổng thể (8-12 từ)',
        '  [8] LIGHTING     → nguồn + hướng + hiệu ứng + màu (25-35 từ)',
        '  [9] COMPOSITION  → góc máy + framing + DOF (12-18 từ)',
        ' [10] QUALITY+FX   → effects + quality tags + NO text (20-25 từ)',
        '',
        'PHÂN BỔ TỪ:',
        '  Style tags:  15-20 từ',
        '  Character:   40-50 từ',
        '  Setting:     20-25 từ',
        '  Lighting:    25-35 từ',
        '  Composition: 12-18 từ',
        '  Quality/FX:  20-25 từ',
        '  ─────────────────',
        '  TỔNG:        150-200 từ ← MỤC TIÊU',
        '',
        'LIGHTING 25-35 TỪ THEO STYLE (công thức 4 bước):',
        '  B1: Nguồn sáng (sun/moon/fire/magic/neon/explosion)',
        '  B2: Hướng chiếu (from above/behind/left side/below)',
        '  B3: Hiệu ứng (god rays/rim light/volumetric fog/harsh shadows)',
        '  B4: Màu + mood (warm amber/cool blue/vivid/desaturated)',
        '',
        'CHARACTER 40-50 TỪ CỐ ĐỊNH — COPY Y CHANG MỌI SCENE:',
        '  Xây 1 lần duy nhất, dùng cho toàn bộ file:',
        '  [giới tính + tuổi], [tóc: màu+kiểu+phụ kiện], [mắt: màu+biểu cảm],',
        '  [đặc điểm nhận diện], [vóc dáng], [trang phục: màu+chất liệu+chi tiết],',
        '  [vũ khí/phụ kiện cố định]',
        '  → Chỉ đổi: action, pose, facial expression chi tiết theo ngữ cảnh thoại',
        '',
        SEP80,
        'PHẦN 5 — VÍ DỤ MẪU 150-200 TỪ',
        SEP80,
        '',
        SEP50,
        'VÍ DỤ 1: STYLE A — CẢNH ĐỐI THOẠI NHẸ NHÀNG (158 từ)',
        SEP50,
        '',
        '[IMAGE PROMPT: [MODEL:animagine] manhua comic style, clean precise anime linework,',
        'xianxia character art, crisp cel shading with soft shadows, detailed face rendering,',
        'expressive eyes, masterpiece, best quality,',
        '1boy, Xu Fan, adult male cultivator late twenties, long jet-black hair half-tied',
        'high knot jade clasp loose strands framing face, calm deep dark brown eyes',
        'intelligent warmth beauty mark beneath left eye, easy amused smile relaxed expression,',
        'tall lean build white pale-blue daoist robes silver cloud embroidery wide sleeves,',
        'jade ring right hand, standing courtyard relaxed teasing right hand raised',
        'casual speaking gesture body posture loose unthreatening,',
        'quiet bamboo-shadowed courtyard polished flagstones low tea table curved railings',
        'pale blossoms cloud sea visible beyond pavilion bright afternoon,',
        'playful relaxed friendly atmosphere,',
        'warm golden afternoon sunlight filtering through bamboo leaves from above and right',
        'delicate rim light on hair and robe folds cool green-blue ambient shadows balancing',
        'warm highlights bright clean tones vivid colors ultra sharp,',
        'medium shot eye level subject left-third shallow depth of field,',
        'floating dust motes drifting leaf shadows faint spirit particles in sunlight,',
        'NO text NO watermark NO letters NO logo pure illustration only 16:9 aspect ratio]',
        '[NEGATIVE: lowres, bad anatomy, bad hands, text, watermark, blurry, deformed face,',
        'extra limbs, dark muddy background, dull colors, flat lighting, 3D render]',
        '[FILE: scene_00033.212s.jpg]',
        '',
        SEP50,
        'VÍ DỤ 2: STYLE B — CHIẾN ĐẤU EPIC TỐI (172 từ)',
        SEP50,
        '',
        '[IMAGE PROMPT: [MODEL:animagine] Chinese fantasy game cinematic art style,',
        'Honor of Kings character design, dramatic 3D rendered illustration,',
        'bold dynamic composition, intense rim lighting, volumetric energy effects,',
        'detailed armor rendering, masterpiece, best quality,',
        '1boy, Xu Fan, adult male cultivator late twenties, jet-black hair loose',
        'battle-disheveled strands flying, fierce dark brown eyes blazing absolute fury',
        'beauty mark beneath left eye barely visible, jaw clenched teeth gritted',
        'desperate determination, lean muscular build white daoist robes silver embroidery',
        'torn at right shoulder battle-damaged fabric billowing energy shockwave,',
        'both hands gripping glowing spirit sword overhead completing devastating downward',
        'cleave releasing massive cyan energy wave, towering demon boss collapsing backward',
        'chest shattered golden light spilling from wound,',
        'ancient stone ruins arena crumbling pillars mid-collapse debris suspended mid-air',
        'storm sky rolling dark thunderclouds dramatic dusk,',
        'climactic victory battle atmosphere raw power unleashed,',
        'explosive golden sparks erupting from sword impact illuminating entire scene',
        'harsh backlight from energy release creating intense rim light on figure edge',
        'dark volumetric smoke and dust contrasting warm amber energy glow cool shadow side',
        'bright vivid ultra sharp,',
        'extreme low angle 30-degree hero shot subject centered dominant frame deep DOF,',
        'motion blur on sword massive energy wave shockwave rings expanding outward',
        'stone debris frozen mid-explosion,',
        'NO text NO watermark NO letters NO logo pure illustration only 16:9 aspect ratio]',
        '[NEGATIVE: lowres, bad anatomy, text, watermark, blurry, deformed face,',
        'soft lighting, pastel colors, static pose, flat shading, cartoon, 2D anime]',
        '[FILE: scene_00062.488s.jpg]',
        '',
        SEP50,
        'VÍ DỤ 3: STYLE A — PHONG CẢNH TIÊN CẢNH (145 từ)',
        SEP50,
        '',
        '[IMAGE PROMPT: [MODEL:animagine] Chinese xianxia illustration style,',
        'soft delicate brushwork, hand-painted watercolor details, luminous ethereal glow,',
        'epic fantasy matte painting, masterpiece, best quality,',
        'grand Hidden Spirit Sect sprawling across multiple jade-green mountain peaks',
        'shrouded in endless sea of ethereal white clouds, ancient Chinese pagodas',
        'golden upturned roofs perched on sheer cliff faces, stone staircases carved',
        'into mountain sides ascending through cloud layers, silver waterfalls cascading',
        'from peak to peak disappearing into cloud sea below, ancient pine forests',
        'clinging to vertical slopes, few floating islands with smaller jade pavilions',
        'drifting serenely in middle distance, distant peaks barely visible as dark',
        'silhouettes through layered morning mist,',
        'majestic serene spiritually transcendent atmosphere,',
        'dramatic golden-hour sunset warm orange-amber sunlight illuminating western peaks',
        'volumetric god rays piercing through cloud layers from behind high contrast',
        'warm lit areas versus cool teal-blue shadowed valleys ethereal ambient mist glow',
        'bright clean tones vivid watercolor colors ultra sharp,',
        'ultra-wide panoramic establishing shot aerial three-quarter view',
        'extreme depth of field capturing infinite scale of immortal realm,',
        'dense volumetric fog cloud sea mist subtle glowing golden runes on sect gates,',
        'NO text NO watermark NO letters NO logo pure illustration only 16:9 aspect ratio]',
        '[NEGATIVE: people in foreground, close-up, flat lighting, oversaturated,',
        'text, watermark, blurry, worst quality, dull tones, modern elements]',
        '[FILE: scene_00000.000s.jpg]',
        '',
        SEP80,
        'PHẦN 6 — CHARACTER CONSISTENCY (NHẤT QUÁN NHÂN VẬT)',
        SEP80,
        '',
        'XÂY CHARACTER SHEET 1 LẦN — DÙNG TOÀN BỘ FILE:',
        '',
        'FORMAT 40-50 TỪ:',
        '  [giới tính + độ tuổi ngoại hình],',
        '  [tóc: màu + độ dài + kiểu + phụ kiện tóc],',
        '  [mắt: màu + đặc điểm],',
        '  [đặc điểm nhận diện: scar/birthmark/tattoo],',
        '  [vóc dáng: cao/thấp + thể hình],',
        '  [trang phục: màu chính + chất liệu + chi tiết thêu/họa tiết],',
        '  [vũ khí/phụ kiện cố định]',
        '',
        'QUY TẮC VÀNG:',
        '  ✅ COPY Y CHANG 40-50 từ này cho MỌI CẢNH có nhân vật đó',
        '  ✅ CHỈ đổi: action/pose, facial expression chi tiết',
        '  ✅ Facial expression phải match với lời thoại [Giọng Nam]/[Giọng nữ]',
        '  ❌ KHÔNG paraphrase, KHÔNG thay đồng nghĩa',
        '  ❌ KHÔNG bao giờ đổi màu tóc, màu mắt, màu trang phục cơ bản',
        '',
        SEP80,
        'PHẦN 7 — QUY TẮC CỨNG',
        SEP80,
        '',
        '━━ RULE 1: ĐỌC THOẠI TRƯỚC KHI VIẾT PROMPT ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        '[Giọng Nam]/[Giọng nữ] → xác định biểu cảm → viết facial expression phù hợp',
        '',
        '━━ RULE 2: CHỌN STYLE THEO ÁNH SÁNG CẢNH ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Cảnh sáng/nhẹ → Style A (manhua)  |  Cảnh tối/epic → Style B (game cinematic)',
        '',
        '━━ RULE 3: ĐỘ DÀI 150-200 TỪ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'KHÔNG dưới 120 từ — lý tưởng 150-200 từ — toàn bộ tiếng Anh',
        '',
        '━━ RULE 4: LIGHTING 25-35 TỪ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'Bắt buộc: nguồn + hướng + hiệu ứng + màu mood — KHÔNG được viết ngắn hơn',
        '',
        '━━ RULE 5: QUALITY TAGS BẮT BUỘC ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        'masterpiece, best quality, ultra-detailed, 8K resolution,',
        'NO text NO watermark NO letters NO logo pure illustration only,',
        'horizontal landscape orientation, 16:9 aspect ratio',
        '',
        SEP80,
        'BẮT ĐẦU XỬ LÝ — ĐỌC THOẠI → CHỌN STYLE → VIẾT PROMPT 150-200 TỪ',
        SEP80,
        ''
    ];
    ...
    var txtBanana = headerBanana.slice();

    // ── Gom các entry theo nhóm: mỗi nhóm bắt đầu bằng [Dẫn Truyện]
    // ── kèm theo các [Giọng Nam]/[Giọng nữ] liền kề phía sau ──
    var i = 0;
    while (i < timestampLog.length) {
        var entry = timestampLog[i];
        var voiceLower = (entry.voice || '').toLowerCase();

        // ── Chỉ bắt đầu nhóm khi gặp [Dẫn Truyện] ──
        if (voiceLower.indexOf('dẫn truyện') < 0) {
            i++;
            continue;
        }

        // ── Tạo tên file ảnh từ startTime ──
        ...
        // ── Gom các [Giọng Nam]/[Giọng nữ] liền kề phía sau ──
        var dialogueLines = [];
        var j = i + 1;
        while (j < timestampLog.length) {
            var nextVoice = (timestampLog[j].voice || '').toLowerCase();
            // Dừng khi gặp [Dẫn Truyện] tiếp theo
            if (nextVoice.indexOf('dẫn truyện') >= 0) break;
            // Lấy [Giọng Nam] và [Giọng nữ]
            if (nextVoice.indexOf('giọng') >= 0 ||
                nextVoice.indexOf('nam')   >= 0 ||
                nextVoice.indexOf('nữ')    >= 0) {
                dialogueLines.push('[' + timestampLog[j].voice + ']: ' + timestampLog[j].text);
            }
            j++;
        }
        ...
        // ── Ghép vào từng file ──
        // File COLAB
        for (var k = 0; k < narratorBlock.length; k++) {
            txtColab.push(narratorBlock[k]);
        }
        if (dialogueLines.length > 0) {
            for (var d = 0; d < dialogueLines.length; d++) {
                txtColab.push(dialogueLines[d]);
            }
            txtColab.push('');
        }

        // File BANANA
        for (var k2 = 0; k2 < narratorBlock.length; k2++) {
            txtBanana.push(narratorBlock[k2]);
        }
        if (dialogueLines.length > 0) {
            for (var d2 = 0; d2 < dialogueLines.length; d2++) {
                txtBanana.push(dialogueLines[d2]);
            }
            txtBanana.push('');
        }

        i = j; // nhảy đến [Dẫn Truyện] tiếp theo
    }

    // ── Footer ──
    var footer = '=== TỔNG THỜI LƯỢNG: ' + runningTime.toFixed(3) + 's ===';
    txtColab.push(footer);
    txtBanana.push(footer);
    ...
    // Download file COLAB trước, BANANA sau 800ms
    downloadTxt(txtColab,  'ImagePrompt_COLAB_'  + safeTaskId + '.txt');
    setTimeout(function () {
        downloadTxt(txtBanana, 'ImagePrompt_BANANA_' + safeTaskId + '.txt');
        console.log('✅ Đã xuất 2 file TXT:');
        console.log('   → ImagePrompt_COLAB_'  + safeTaskId + '.txt (77-token optimized)');
        console.log('   → ImagePrompt_BANANA_' + safeTaskId + '.txt (150-200 từ full detail)');
    }, 800);
}
