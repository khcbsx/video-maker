...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    var headerUniversal = [
        SEP80,
        '╔══════════════════════════════════════════════════════════════════════════════╗',
        '║      IMAGE PROMPT GENERATION FILE — UNIVERSAL VERSION                     ║',
        ...
        '├──────────────────────────────────┬─────────────────────────────────────┤',
        '│  [MODEL:juggernaut]             │  [MODEL:animagine]                 │',
        '├──────────────────────────────────┼─────────────────────────────────────┤',
        ...
        '  Chinese wuxia manhua art style, dynamic action lines, motion blur on weapon,',
        ...
        '  [IMAGE PROMPT: [MODEL:animagine] A celestial female cultivator sitting cross-legged',
        ...
        '  Chinese xianxia illustration style, soft watercolor wash, luminous glow,',
        '  masterpiece, best quality, ultra-detailed, 8K resolution,',
        '  horizontal landscape orientation, 16:9 aspect ratio,',
        '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
        '  NO subtitles, NO UI elements, NO logo, NO signature]',
        ...
        '  jpeg artifacts, signature, watermark, daylight, bright colors, cheerful]',
        '  [FILE: scene_00845.200s.jpg]',
        '',
        '── VÍ DỤ — Lãng mạn hiện đại (Colab: animagine) ───────────────────────────────',
        '  [IMAGE PROMPT: [MODEL:animagine] A beautiful young woman sitting alone',
        ...
        '  modern Korean webtoon art style, soft brushwork, romantic color grading,',
        '  masterpiece, best quality, ultra-detailed, 8K resolution,',
        '  horizontal landscape orientation, 16:9 aspect ratio,',
        '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
        '  NO subtitles, NO UI elements, NO logo, NO signature]',
        ...
        'Colab model: [MODEL:juggernaut] phong cảnh/nhân vật — [MODEL:juggernaut] chiến đấu',
        ...
        'Art style: Chinese xianxia illustration style, luminous glow, soft watercolor wash',
        ...
        'Colab model: [MODEL:juggernaut] isekai fantasy — [MODEL:juggernaut] isekai action',
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: modern Korean webtoon art style, soft pastel colors, romantic lighting',
        ...
        'Đặc biệt: candle flame glow, incense smoke, peony petals falling',
        '',
        SEP50,
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: hyper-realistic digital painting style, dramatic lighting, cinematic',
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: futuristic sci-fi concept art, neon cyberpunk or hard sci-fi cinematic',
        ...
        'Genspark/ChatGPT/Gemini: đổi thành [MODEL:gpt-image-1] hoặc [MODEL:imagen3]',
        'Art style: dark fantasy digital art style, dramatic magical lighting, painterly effects',
        ...
        SEP80,
        '',
        '  [IMAGE PROMPT: [MODEL:animagine hoặc juggernaut] [SUBJECT],',
        '  [ACTION/POSE],',
        ...
        'B1: Thay TẤT CẢ [MODEL:animagine] và [MODEL:juggernaut] → [MODEL:gpt-image-1]',
