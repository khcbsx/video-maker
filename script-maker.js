...
// HEADER UNIVERSAL v5.1 — CHUẨN 77 TOKEN CHO ANIMAGINE XL 3.1
// ══════════════════════════════════════════════════════════════════════════
var SEP80 = '================================================================================';
var SEP50 = '────────────────────────────────────────────────────';
 ...
 var headerUniversal = [
    SEP80,
    '╔══════════════════════════════════════════════════════════════════════════════╗',
    '║      IMAGE PROMPT GENERATION FILE — UNIVERSAL VERSION (ENHANCED)          ║',
    '║   Compatible: Colab SDXL · Genspark Agent · ChatGPT · Gemini             ║',
    '║   🌟 PHIÊN BẢN NÂNG CẤP: Prompts Chi Tiết Cực Độ 150-200 từ 🌟          ║',
    '╚══════════════════════════════════════════════════════════════════════════════╝',
    SEP80,
    '',
    '┌─────────────────────────────────────────────────────────────────────────────┐',
    ...
    '├─────────────────────────────────────────────────────────────────────────────┤',
    '│  COLAB (Animagine XL / animagine XL):                                    │',
    '│    → GIỮ NGUYÊN tag [MODEL:animagine] hoặc [MODEL:animagine]             │',
    '│    → Colab tự đọc [FILE:] để đặt tên ảnh đúng chuẩn                      │',
    '│    → Colab tự đọc [NEGATIVE:] để truyền vào SDXL pipeline                │',
    '├─────────────────────────────────────────────────────────────────────────────┤',
    ...
    '',
    '┌──────────────────────────────────────────────────────────────────────────┐',
    '│  BẢNG CHỌN MODEL TAG — CHỈ ÁP DỤNG KHI DÙNG COLAB SDXL               │',
    '├──────────────────────────────────┬─────────────────────────────────────┤',
    '│  [MODEL:animagine]               │  [MODEL:animagine]                 │',
    '├──────────────────────────────────┼─────────────────────────────────────┤',
    ...
    '',
    '🌟 PHIÊN BẢN MỚI: Prompts CỰC KỲ CHI TIẾT 150-200 từ thay vì 45-80 từ',
    ...
    SEP80,
    '',
    'FILE TXT NÀY CHỈ CHỨA CÁC BLOCK [Dẫn Truyện] — các BLOCK [Giọng nam] và [Giọng nữ] sẽ có hiển thị và giữ nguyên nội dung nhưng không làm cấu trúc như dẫn truyện chỉ giữ nguyên lời thoại.',
    'Mỗi block [Dẫn truyện] có cấu trúc như sau:',
    '',
    '  [Dẫn Truyện]',
    '  startTime: 0.000s',
    '  → duration: 12.500s →',
    ...
    '  Văn bản tường thuật của cảnh này...',
    '',
    'QUY TẮC XỬ LÝ:',
    '1. Mỗi block = 1 ảnh cần tạo — đọc văn bản bên dưới [FILE:] để hiểu nội dung',
    '2. Chỉ thay [IMAGE PROMPT: CHƯA TẠO] bằng prompt tiếng Anh — không đổi gì khác',
    '3. Đọc các block trước/sau để giữ nhân vật nhất quán xuyên suốt file',
    '4. Dòng [FILE: scene_xxxxx.xxxs.jpg] — KHÔNG XÓA, KHÔNG SỬA, giữ nguyên 100%',
    '5. KHÔNG thêm dòng mới, KHÔNG xóa dòng nào, KHÔNG dùng markdown hay ngoặc kép , không tạo pormt các block [Giọng Nam] và [Giọng Nữ]',
    '',
    SEP80,
    ...
    '',
    '  [1] MODEL TAG       — Bắt buộc đầu tiên: [MODEL:animagine] hoặc [MODEL:animagine]',
    '',
    ...
    '',
    '┌─────────────────────────────────────────────────────────────────────────┐',
    '│ ÁNH SÁNG CHO ANIMAGINE (Soft, Ethereal, Painterly)                    │',
    '├─────────────────────────────────────────────────────────────────────────┤',
    '│ SÁNG/TRUNG TÍNH:                                                        │',
    '│  • soft ethereal mist rolling through scene                            │',
    ...
    '',
    '┌─────────────────────────────────────────────────────────────────────────┐',
    '│ ÁNH SÁNG CHO animagine (Realistic, Dramatic, Cinematic)              │',
    '├─────────────────────────────────────────────────────────────────────────┤',
    '│ HÀNH ĐỘNG/CHIẾN ĐẤU:                                                    │',
    ...
    '',
    SEP50,
    'VÍ DỤ 1: KIẾM HIỆP CHIẾN ĐẤU (animagine) — 185 từ',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine] A young male warrior frozen in explosive',
    ...
    'violently in self-generated wind pressure, loose strands covering half of',
    'intense battle-hardened face, sharp determined dark brown eyes blazing with',
    'absolute battle fury and laser focus, pupils contracted showing peak concentration,',
    'furrowed brow and clenched jaw revealing warrior resolve, lean muscular',
    'athletic warrior build with visible arm muscle tension and definition,',
    'traditional white flowing hanfu with intricate blue geometric embroidery trim',
    'along collar and cuffs torn dramatically at right sleeve revealing bandaged',
    'forearm from previous intense clash, fabric billowing outward from energy',
    'release shockwave, debris explosion radiating outward in all directions',
    'with stone fragments suspended mid-air, ground cracking violently beneath',
    'feet from tremendous force impact, dust clouds erupting upward,',
    'ancient crumbling stone ruins battlefield littered with broken marble pillars',
    'and scattered rusted weapons half-buried in earth, explosive high-stakes',
    'battle atmosphere capturing adrenaline-fueled climax moment,',
    'volumetric dust and smoke particles illuminated dramatically by backlight,',
    'intense dramatic lighting with golden late-afternoon sunlight cutting sharply',
    'through swirling dust clouds and smoke from right side creating harsh rim',
    'light along figure edge, warm amber highlights contrasting dramatically with',
    'cool blue shadow side, bright clean tones, vivid colors, ultra sharp focus',
    'on character, extreme low angle camera looking up at 30-degree hero angle,',
    'diagonal dynamic composition, subject dominant in left-third frame,',
    'shallow depth of field with motion-blurred background emphasizing subject,',
    'motion blur speed streaks on sword trajectory showing incredible velocity,',
    'Chinese wuxia manhua digital art style, dynamic action illustration,',
    'bold ink-wash brush accents, kinetic energy lines radiating from impact,',
    'masterpiece, best quality, ultra-detailed, 8K resolution,',
    'horizontal landscape orientation, 16:9 aspect ratio,',
    ...
    '[NEGATIVE: lowres, 2D anime, flat shading, soft watercolor wash, flat lighting,',
    ...
    'watermark, username, blurry, ugly, duplicate, morbid, mutilated, out of frame,',
    'extra limbs, bad proportions, gross proportions, deformed face, long neck,',
    'dark muddy background, pitch black darkness, static boring pose]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP50,
    'VÍ DỤ 2: TIÊN HIỆP TU LUYỆN (ANIMAGINE) — 195 từ',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine] A celestial female cultivator sitting gracefully',
    'in perfect cross-legged lotus meditation position on a massive floating',
    'jade-green meditation platform suspended impossibly high above endless sea',
    'of fluffy white clouds, both delicate hands gracefully forming intricate',
    'ethereal lotus seal mudra at chest level with fingers precisely positioned',
    'creating mystical hand gesture, eyes gently closed in deep spiritual trance',
    'state showing complete inner peace, serene peaceful expression with slight',
    'blissful smile, long flowing silver-white hair cascading down back and sides',
    'like luminous waterfall, elaborate hairstyle with high elegant bun secured',
    'by ornate golden phoenix-shaped hairpins inlaid with jade, delicate oval',
    'face with flawless porcelain skin and slightly rosy cheeks, slender graceful',
    'immortal physique radiating otherworldly ethereal beauty, wearing multiple',
    'layers of pristine white translucent immortal cultivation robes with intricate',
    'silver crane and cloud motif embroidery along flowing wide sleeves, silk',
    'fabric so thin it appears semi-transparent like morning mist, rippling gently',
    'in spiritual breeze, surrounded by dozens of swirling cyan and white spiritual',
    'energy ribbons spiraling upward in elegant helical patterns from glowing',
    'blue-white spirit stones carefully arranged in perfect geometric ritual circle',
    'around platform edge, endless ocean of fluffy white clouds stretching infinitely',
    'to horizon below like cottony landscape creating vast ethereal heavenly',
    'atmosphere, distant floating mountain peaks barely visible as dark silhouettes',
    'through morning mist, few other floating islands with jade pavilions tiny',
    'in far distance, transcendent peaceful breakthrough cultivation atmosphere',
    'radiating divine serenity and cosmic harmony, soft ethereal volumetric mist',
    'rolling through entire scene like silk, dramatic ethereal painted lighting',
    'with radiant golden dawn sunbeams piercing majestically through clouds from',
    'behind and above creating stunning divine rim light halo around entire figure,',
    'cool soft blue ambient light from clouds mixing beautifully with warm golden',
    'highlights on hair and robe edges creating magical color temperature contrast,',
    'bright clean tones, vivid watercolor colors, ultra sharp, epic wide establishing',
    'shot from slightly below eye level looking up reverently, subject perfectly',
    'centered in frame, deep depth of field capturing vast infinite scale of',
    'heavenly realm, tiny figure against cosmic backdrop emphasizing divine insignificance,',
    'thousands of tiny glowing cyan spirit particles floating everywhere like fireflies,',
    ...
    'NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    'NO Japanese characters, NO Korean characters, NO subtitles, NO UI elements,',
    'NO logo, NO signature, pure illustration only]',
    '[NEGATIVE: lowres, 2D anime, flat shading, soft watercolor wash, flat lighting,',
    'bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits,',
    'cropped, worst quality, low quality, normal quality, jpeg artifacts, signature,',
    'watermark, username, blurry, ugly, duplicate, morbid, mutilated, out of frame,',
    'extra limbs, bad proportions, gross proportions, deformed face, long neck,',
    'dark muddy background, pitch black darkness, dull colors]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP50,
    'VÍ DỤ 3: KINH DỊ MA QUỶ (animagine) — 170 từ',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine] An abandoned three-story Victorian mansion',
    'standing ominously at dead-end road surrounded by rusted iron fence with',
    'broken gates hanging crooked, decaying grey wooden exterior with peeling paint',
    'and cracked windows, all windows pitch black except one on third floor glowing',
    'with sickly pale green phosphorescent light, bare twisted dead trees with',
    'gnarled branches surrounding property like skeletal hands, thick supernatural',
    'fog crawling slowly along ground obscuring lower half of building, small',
    'silhouette of young child standing completely motionless at rusted gate staring',
    'directly at viewer with unnatural stillness, suffocating dread supernatural',
    'atmosphere heavy with malevolent presence, cold blue-green moonlight filtering',
    'weakly through fog creating long ominous shadows, volumetric mist illuminated',
    'by eerie green window glow, high contrast chiaroscuro lighting with deep',
    'dramatic shadows, minimal lighting creating maximum fear through darkness,',
    'cold desaturated color palette with green and blue tones, wide establishing',
    'shot with low horizon line, symmetrical composition centering mansion,',
    'deep depth of field keeping everything sharp and threatening, dark gothic',
    'horror illustration style, painterly brush texture, high contrast dramatic',
    'shadows, masterpiece, best quality, ultra-detailed, 8K resolution,',
    'horizontal landscape orientation, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    'NO Japanese characters, NO Korean characters, NO subtitles,',
    'NO UI elements, NO logo, NO signature, pure illustration only]',
    ...
    'blurry, daylight, bright cheerful colors, happy atmosphere, people visible]',
    '[FILE: scene_00000.000s.jpg]',
    '',
    SEP50,
    'VÍ DỤ 4: LÃNG MẠN HIỆN ĐẠI (ANIMAGINE) — 160 từ',
    SEP50,
    '',
    '[IMAGE PROMPT: [MODEL:animagine] A beautiful young woman in early twenties',
    'sitting alone gracefully at cozy wooden cafe table next to large rain-streaked',
    'window at night, chin resting delicately on her right hand with elbow on table,',
    'gazing melancholically through rain-covered glass at glowing city lights outside',
    'with distant wistful expression, long straight dark brown hair falling gently',
    'over shoulders, big expressive sad brown eyes reflecting window lights showing',
    'inner emotional turmoil, delicate features with slight frown, slender graceful',
    'build, wearing oversized cream-colored knit sweater with rolled-up sleeves,',
    'warm amber cafe interior with soft bokeh background from hanging Edison bulbs',
    'and blurred bar counter, outside window showing blurred colorful city lights',
    'and neon signs creating beautiful bokeh through rain, nostalgic bittersweet',
    'longing atmosphere heavy with unspoken emotion, soft warm indoor lighting',
    'from overhead pendant lamp creating gentle glow on her face and hair, cool',
    'blue night light from window contrasting beautifully with warm interior,',
    'raindrops on glass catching and refracting lights, medium close-up shot',
    'from slightly right side, shallow depth of field with heavily blurred background,',
    'subject slightly off-center following rule of thirds, modern Korean webtoon',
    'art style, soft delicate brushwork, romantic pastel color grading, luminous',
    'skin rendering, masterpiece, best quality, ultra-detailed, 8K resolution,',
    'horizontal landscape orientation, 16:9 aspect ratio,',
    'NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    'NO Japanese characters, NO Korean characters, NO subtitles,',
    'NO UI elements, NO logo, NO signature, pure illustration only]',
    ...
    'Colab model: [MODEL:animagine] phong cảnh/nhân vật — [MODEL:animagine] chiến đấu',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    ...
    '',
    'Ánh sáng ANIMAGINE:',
    '  "soft ethereal mist rolling through bamboo forest, dramatic painted lighting',
    '  with warm golden hour sunlight filtering through leaves, delicate rim light',
    '  outlining character, cool blue shadows contrasting warm highlights"',
    '',
    'Ánh sáng animagine:',
    '  "volumetric dust particles illuminated by dramatic backlight, intense lighting',
    '  with golden afternoon sunlight cutting sharply through debris clouds,',
    '  harsh rim light on figure edge, warm amber vs cool blue high contrast"',
    '',
    SEP50,
    'B. TIÊN HIỆP / TU TIÊN (Xianxia / Cultivation)',
    SEP50,
    'Nhận biết: tu luyện, linh khí, đột phá cảnh giới, tiên giới, linh đan, tông môn',
    'Colab model: [MODEL:animagine] cho tất cả cảnh tiên hiệp',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    ...
    'Colab model: [MODEL:animagine] isekai fantasy — [MODEL:animagine] isekai action',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    ...
    'Colab model: [MODEL:animagine] cho tất cả cảnh lãng mạn',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    ...
    'Đặc biệt: sakura petals floating in air, bokeh city lights background,',
    '          rain droplets on window glass, soft lens flare romantic effect',
    '',
    'Ánh sáng:',
    '  "soft warm indoor lighting from overhead pendant lamp creating gentle glow',
    '  on face and hair, cool blue night light from window contrasting beautifully',
    '  with warm amber interior, raindrops catching lights, dreamy bokeh effect"',
    '',
    SEP50,
    'E. CỔ ĐẠI / LỊCH SỬ / CUNG ĐẤU',
    SEP50,
    'Nhận biết: hoàng cung, hậu cung, phi tần, thái tử, âm mưu, tranh sủng',
    'Colab model: [MODEL:animagine] hậu cung/cảm xúc — [MODEL:animagine] chiến trường',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    ...
    'Đặc biệt: candle flame glow creating intimate atmosphere, incense smoke',
    '          rising gracefully, peony petals falling slowly',
    '',
    'Ánh sáng:',
    '  "warm golden candlelight from ornate bronze lamp holders casting soft',
    '  flickering shadows on silk curtains, gentle rim light from moonlight through',
    '  window, intimate palace atmosphere, warm amber tones"',
    '',
    SEP50,
    'F. KINH DỊ / LIÊU TRAI / MA QUỶ',
    SEP50,
    'Nhận biết: hồn ma, ám ảnh, ngôi nhà bỏ hoang, bóng tối, thực thể không tên',
    'Colab model: [MODEL:animagine] cho tất cả cảnh kinh dị',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    ...
    'Màu sắc: xám tro, xanh lạnh tử thi, đỏ máu, trắng xương — KHÔNG pitch black',
    ...
    'Đặc biệt: shadow entity with distorted form, pale green phosphorescent glow,',
    ...
    '  glowing with sickly pale green phosphorescent light, high contrast chiaroscuro',
    '  with deep dramatic shadows, minimal lighting creating maximum dread"',
    '',
    SEP50,
    'G. HÀNH ĐỘNG / CHIẾN TRANH / QUÂN SỰ',
    SEP50,
    'Nhận biết: chiến trận, binh lính, vũ khí, chỉ huy, chiến lược, hy sinh',
    'Colab model: [MODEL:animagine] cho tất cả cảnh chiến tranh',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    'Art style: hyper-realistic digital painting style, dramatic cinematic lighting,',
    '          photorealistic details, epic scale, war documentary aesthetic',
    'Màu sắc: xám thép, nâu đất, đỏ máu, khói đen, sáng sớm lạnh lẽo',
    'Trang phục: áo giáp kim loại hoặc quân phục, mũ giáp, vũ khí hiện đại/cổ',
    'Bối cảnh: chiến trường tan hoang, pháo đài bị vây, biển người xung trận',
    'Đặc biệt: explosion debris flying mid-air, motion blur on charging soldiers,',
    '          god-ray sunlight piercing through smoke, battlefield carnage',
    '',
    'Ánh sáng:',
    ...
    '  through smoke clouds, high contrast battle lighting"',
    '',
    SEP50,
    'H. TRINH THÁM / TỘI PHẠM / GIẬT GÂN',
    SEP50,
    'Nhận biết: thám tử, vụ án, manh mối, nghi phạm, điều tra, bí ẩn, lật mặt',
    'Colab model: [MODEL:animagine] cho tất cả cảnh trinh thám',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    ...
    'Đặc biệt: single overhead interrogation light creating deep face shadows,',
    '          rain reflecting neon lights on wet pavement, cigarette smoke',
    '',
    'Ánh sáng:',
    '  "single harsh overhead spotlight creating deep dramatic shadows across face,',
    '  cold blue-white fluorescent interrogation room lighting, high contrast',
    ...
    'Colab model: [MODEL:animagine] sci-fi sáng — [MODEL:animagine] cyberpunk tối',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    'Art style: futuristic sci-fi concept art style, neon cyberpunk aesthetic',
    '          or clean hard sci-fi cinematic rendering',
    'Màu sắc: neon xanh/tím/hồng (cyberpunk) hoặc trắng bạc lạnh (hard sci-fi)',
    'Trang phục: exo-suit, bộ đồ chiến đấu tương lai, áo lab scientist, kính AR',
    'Bối cảnh: thành phố tương lai siêu cao, trạm vũ trụ, hành lang tàu không gian',
    'Đặc biệt: holographic interface panels (NO actual text), particle engine trails,',
    '          neon light reflecting on wet surfaces, nebula star background',
    '',
    'Ánh sáng CYBERPUNK:',
    '  "vibrant neon lights in cyan, magenta, and yellow reflecting on wet rainy',
    '  streets, harsh artificial lighting from holographic billboards, high contrast',
    '  colorful glow against dark urban shadows"',
    '',
    'Ánh sáng HARD SCI-FI:',
    '  "cold sterile white-blue lighting from overhead LED panels, clean clinical',
    '  atmosphere, minimal shadows, futuristic clean aesthetic"',
    '',
    SEP50,
    'J. GIA ĐÌNH / ĐỜI THƯỜNG / SLICE OF LIFE',
    SEP50,
    'Nhận biết: gia đình, cuộc sống thường ngày, nấu ăn, học đường, tình cảm bình dị',
    'Colab model: [MODEL:animagine] cho tất cả cảnh đời thường',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    'Art style: warm slice-of-life anime illustration style, soft lighting,',
    ...
    'Đặc biệt: golden hour sunlight streaming through curtains, steam rising from',
    '          hot food, dust particles visible in sunbeam, cozy domestic details',
    '',
    'Ánh sáng:',
    '  "warm golden hour sunlight streaming through window creating long soft shadows,',
    '  dust particles floating visibly in sunbeam, gentle natural lighting,',
    '  cozy warm atmosphere, soft shadows"',
    '',
    SEP50,
    'K. MA HỌC / PHÉP THUẬT / DARK FANTASY',
    SEP50,
    'Nhận biết: pháp sư, ma thuật, nghi lễ, lời nguyền, tháp pháp sư, bóng tối',
    'Colab model: [MODEL:animagine] dark magic — [MODEL:animagine] light magic',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    'Art style: dark fantasy digital art style, dramatic magical lighting,',
    '          painterly effects, mystical atmosphere',
    'Màu sắc: đen tím thẫm, xanh đêm, ánh sáng ma thuật tương phản mạnh',
    'Trang phục: áo choàng ma pháp dài với rune, mũ phù thủy, enchanted armor',
    'Bối cảnh: tháp ma thuật, nghi trận summoning, rừng chết cây khô, lâu đài',
    'Đặc biệt: glowing magical ritual circle on floor, dark shadow tendrils,',
    '          spell light burst, mystical runes floating, magical particle effects',
    '',
    'Ánh sáng DARK MAGIC:',
    '  "glowing purple-black magical energy illuminating ritual circle from below,',
    '  harsh upward lighting creating ominous shadows on face, dark tendrils of',
    '  shadow magic swirling, high contrast mystical atmosphere"',
    '',
    'Ánh sáng LIGHT MAGIC:',
    '  "radiant white-gold divine magic glow emanating from spell, soft ethereal',
    '  lighting illuminating surroundings, holy light particles floating"',
    '',
    SEP50,
    'L. ZOMBIE / TẬN THẾ / POST-APOCALYPTIC',
    SEP50,
    'Nhận biết: zombie, tận thế, sống sót, nhóm sinh tồn, thế giới hoang tàn, bunker',
    'Colab model: [MODEL:animagine] cho tất cả cảnh tận thế',
    'Genspark/ChatGPT: đổi thành [MODEL:gpt-image-2]',
    'Gemini: đổi thành [MODEL:imagen3]',
    '',
    'Art style: post-apocalyptic survival art style, gritty realism,',
    '          desaturated palette, harsh environmental storytelling',
    'Màu sắc: xám hoang tàn, nâu bụi đất, đỏ rỉ sét, xanh lạnh sấm sét',
    'Trang phục: quần áo rách nát tự may vá, giáp tự chế từ phế liệu, balo sinh tồn',
    'Bối cảnh: thành phố đổ nát cây leo, siêu thị bỏ hoang, đường cao tốc xe bỏ',
    'Đặc biệt: overgrown vines covering buildings, ash particles falling like snow,',
    '          broken glass everywhere, distant smoke from fires, abandoned vehicles',
    '',
    'Ánh sáng:',
    '  "harsh cold overcast daylight filtering through ash-filled atmosphere,',
    ...
    '  (1) Giới tính + tuổi ngoại hình : young male warrior / teenage female cultivator',
    '  (2) Màu tóc + kiểu tóc + phụ kiện: medium-length jet-black hair tied in high',
    '                                     topknot with ornate jade hairpin',
    '  (3) Màu mắt + biểu cảm          : sharp determined dark brown eyes blazing',
    '                                     with battle fury and laser focus',
    '  (4) Đặc điểm nhận diện           : thin scar crossing left eyebrow, beauty mark',
    '  (5) Trang phục màu + chi tiết    : white flowing hanfu with intricate blue',
    '                                     geometric embroidery trim along collar and cuffs',
    '  (6) Vũ khí / đạo cụ cố định      : silver-sheathed longsword at left hip,',
    '                                     jade pendant glowing at chest',
    '  (7) Vóc dáng                     : lean muscular athletic warrior build',
    '',
    'QUY TRÌNH 4 BƯỚC BẮT BUỘC:',
    '  B1: Đọc lướt toàn bộ file TXT — liệt kê TẤT CẢ nhân vật xuất hiện',
    '  B2: Xây dựng CHARACTER SHEET chi tiết cho từng nhân vật (viết ra giấy nháp)',
    ...
    '',
    'VÍ DỤ ĐÚNG — nhân vật Minh Thiên qua 3 cảnh:',
    '',
    'Cảnh 1 (giới thiệu đầy đủ):',
    '  "A young male warrior in mid-twenties, medium-length jet-black hair tied in',
    '  high topknot with white silk ribbon, sharp determined dark brown eyes showing',
    '  unwavering resolve, thin scar crossing left eyebrow, lean muscular athletic',
    '  warrior build with broad shoulders, wearing traditional white flowing hanfu',
    '  with intricate blue geometric embroidery trim along collar and cuffs,',
    '  silver-sheathed longsword at left hip, jade pendant at chest"',
    '',
    'Cảnh 2 (chiến đấu — GIỮ NGUYÊN 7 điểm, đổi action):',
    '  "The same young male warrior, medium-length jet-black hair tied in high topknot',
    '  with white silk ribbon now loosened and whipping in wind, sharp determined',
    '  dark brown eyes blazing with intense battle fury, thin scar crossing left',
    '  eyebrow more visible, lean muscular athletic warrior build with visible arm',
    '  tension, white flowing hanfu with blue geometric embroidery trim torn at',
    '  right sleeve from combat, silver-sheathed longsword drawn and glowing,',
    '  jade pendant emitting faint light"',
    '',
    'Cảnh 3 (sau trận — GIỮ NGUYÊN 7 điểm, đổi emotion):',
    '  "The same young male warrior, medium-length jet-black hair tied in high topknot',
    '  with white silk ribbon, sharp dark brown eyes now carrying deep sadness and',
    '  exhaustion, thin scar crossing left eyebrow, lean muscular athletic warrior',
    '  build showing fatigue, white flowing hanfu with blue geometric embroidery',
    '  trim bloodstained and torn, silver-sheathed longsword back at left hip,',
    '  jade pendant dimly glowing"',
    '',
    '★ CHÚ Ý: Tóc, mắt, scar, vóc dáng, trang phục, vũ khí — KHÔNG BAO GIỜ ĐỔI MÀU/VỊ TRÍ ★',
    '',
    'VÍ DỤ SAI — TUYỆT ĐỐI KHÔNG LÀM:',
    '  Cảnh 1: "black hair, dark eyes, white robe"',
    '  Cảnh 2: "brown hair, blue eyes, blue robe"  ← SAI HOÀN TOÀN! Đổi màu tóc, mắt, áo',
    '  Cảnh 3: "blonde hair, green robe"            ← SAI NẶng NỀ! Nhân vật hoàn toàn khác',
    '',
    SEP80,
    ...
    '           horizontal landscape orientation, 16:9 aspect ratio',
    '',
    '━━ RULE 3: NEGATIVE PROMPT BẮT BUỘC (cho Colab SDXL) ━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Thêm dòng [NEGATIVE: ...] ngay SAU dòng NO text:',
    '',
    'ANIMAGINE:',
    '  [NEGATIVE: lowres, 2D anime, flat shading, soft watercolor wash, flat lighting,',
    '  bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits,',
    ...
    '  watermark, username, blurry, ugly, duplicate, morbid, mutilated, out of frame,',
    '  extra limbs, bad proportions, gross proportions, deformed face, long neck,',
    '  dark muddy background, pitch black darkness]',
    '',
    '━━ RULE 4: MÀU SẮC BẮT BUỘC ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'LUÔN THÊM: bright clean tones, vivid colors, ultra sharp',
    'CHỈ TRỪ: Cảnh kinh dị/zombie có thể dùng "desaturated colors, cold tones"',
    'TUYỆT ĐỐI TRÁNH: dark muddy background, pitch black darkness (trừ horror)',
    '',
    '━━ RULE 5: ĐỘ DÀI PROMPT (NÂNG CẤP) ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'Tối thiểu 120 words — lý tưởng 150-200 words — toàn bộ bằng tiếng Anh',
    '',
    'PHÂN BỔ CHI TIẾT:',
    '  • Subject + Action: 30-40 từ (nhân vật/cảnh quan + hành động cụ thể)',
    '  • Appearance: 40-50 từ (7 điểm: tóc, mắt, biểu cảm, vóc dáng, trang phục, vũ khí)',
    '  • Setting: 25-35 từ (địa điểm cụ thể, thời gian, thời tiết, môi trường)',
    '  • Lighting: 30-45 từ (★ QUAN TRỌNG NHẤT ★ nguồn + hướng + hiệu ứng + màu)',
    '  • Composition: 15-20 từ (góc máy, framing, depth of field)',
    '  • Style + Quality: 25-35 từ (art style + quality tags + NO text + aspect ratio)',
    'TỔNG: 165-225 từ là mức LÝ TƯỞNG',
    '',
    ...
    'lighting with radiant golden dawn sunbeams breaking majestically through clouds',
    'from behind and above, creating divine rim light halo around figure, cool soft',
    'blue ambient light mixing with warm golden highlights, bright clean tones"',
    '',
    SEP80,
    'PHẦN 7 — TEMPLATE PROMPT ĐỂ COPY',
    SEP80,
    '',
    '  [IMAGE PROMPT: [MODEL:animagine hoặc animagine] [SUBJECT CỤ THỂ 30-40 từ:',
    '  nhân vật/cảnh quan với mô tả chi tiết hành động và tư thế],',
    '  [APPEARANCE 40-50 từ: tóc (màu+kiểu+phụ kiện), mắt (màu+biểu cảm),',
    '  biểu cảm khuôn mặt, vóc dáng, trang phục (màu+chất liệu+chi tiết+trạng thái),',
    '  phụ kiện/vũ khí (vị trí cụ thể), đặc điểm nhận diện],',
    '  [SETTING 25-35 từ: địa điểm cụ thể với chi tiết kiến trúc/địa hình,',
    '  thời gian trong ngày, thời tiết, yếu tố môi trường xung quanh],',
    '  [ATMOSPHERE 10-15 từ: không khí và cảm xúc tổng thể của cảnh],',
    '  [LIGHTING 30-45 từ: ★ CỰC KỲ QUAN TRỌNG ★',
    '  B1-nguồn sáng cụ thể, B2-hướng sáng và góc chiếu,',
    '  B3-hiệu ứng ánh sáng (god rays/rim light/volumetric fog/shadows),',
    '  B4-màu sắc ánh sáng và mood (warm/cold/contrasting tones),',
    '  bright clean tones, vivid colors, ultra sharp],',
    '  [COMPOSITION 15-20 từ: góc máy cụ thể (wide/close-up/low angle/etc),',
    '  framing và vị trí subject, depth of field (deep/shallow)],',
    '  [PARTICLE FX 10-15 từ: hiệu ứng hạt và chuyển động nếu có],',
    '  [ART STYLE phù hợp thể loại + brushwork/texture details],',
    '  masterpiece, best quality, ultra-detailed, 8K resolution,',
    '  horizontal landscape orientation, 16:9 aspect ratio,',
    '  NO text, NO watermark, NO letters, NO words, NO Chinese characters,',
    '  NO Japanese characters, NO Korean characters, NO subtitles,',
    '  NO UI elements, NO logo, NO signature, pure illustration only]',
    '  [NEGATIVE: lowres, 2D anime, flat shading, bad anatomy, bad hands, text,',
    '  error, missing fingers, cropped, worst quality, low quality, jpeg artifacts,',
    '  signature, watermark, blurry, ugly, deformed face, extra limbs, bad proportions,',
    '  dark muddy background, pitch black darkness (cho animagine thêm: dull colors)]',
    ...
    'B1: Thay TẤT CẢ [MODEL:animagine] và [MODEL:animagine] → [MODEL:gpt-image-2]',
    ...
    '    then save it to AI Drive with the EXACT filename from [FILE:] tag below it.',
    ...
    'B7: Upload ảnh + MP3 vào app Video Maker',
    '',
    '━━ WORKFLOW B: CHATGPT (GPT Image) ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: Thay TẤT CẢ model tag → [MODEL:gpt-image-2]',
    'B2: Mở ChatGPT (GPT-4o có khả năng tạo ảnh)',
    'B3: Paste file TXT + yêu cầu: "Generate image for each [IMAGE PROMPT] block,',
    '    name each image exactly as the [FILE:] tag. Ignore [NEGATIVE:] lines."',
    'B4: Download ảnh, đổi tên đúng theo [FILE:] tag nếu cần',
    '',
    '━━ WORKFLOW C: GEMINI (Imagen 3) ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: Thay TẤT CẢ model tag → [MODEL:imagen3]',
    'B2: Mở Gemini Advanced (Google One AI Premium)',
    'B3: Paste từng block [IMAGE PROMPT] + yêu cầu đặt tên theo [FILE:]',
    'B4: Download và đổi tên thủ công theo [FILE:] tag',
    '',
    '━━ WORKFLOW D: COLAB SDXL ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
    'B1: GIỮ NGUYÊN model tag [MODEL:animagine] / [MODEL:animagine] trong file',
    'B2: Upload file TXT lên Google Drive',
    'B3: Chạy Colab notebook — tự đọc [MODEL:] chọn model, [FILE:] đặt tên ảnh,',
    '    [NEGATIVE:] truyền vào SDXL pipeline',
    'B4: Ảnh lưu vào Drive với đúng tên scene_xxxxx.xxxs.jpg',
    'B5: Download ảnh → Upload vào app Video Maker cùng với MP3',
    '',
    SEP80,
    ...
    '☑ Có góc máy CỤ THỂ (wide/close-up/low angle/etc)?',
    '☑ Có depth of field (deep/shallow)?',
    '☑ Có kết thúc "NO text, NO watermark..." đầy đủ?',
    '☑ Có [NEGATIVE: ...] phù hợp với model?',
    ...
    '2. ÁNH SÁNG: 30-45 từ riêng, mô tả CỰC KỲ CỤ THỂ (nguồn + hướng + hiệu ứng + màu)',
    '3. NHÂN VẬT: 40-50 từ mô tả đầy đủ 7 điểm, NHẤT QUÁN tuyệt đối xuyên suốt',
    ...
    // ══════════════════════════════════════════════════════════════════════════
    // BUILD NỘI DUNG FILE — CHỈ LẤY BLOCK [Dẫn Truyện]
    // ══════════════════════════════════════════════════════════════════════════
    var txtLines = headerUniversal.slice();

    for (var t = 0; t < timestampLog.length; t++) {
        var entry = timestampLog[t];

        // ── Chỉ xử lý [Dẫn Truyện] — bỏ qua giọng nam/nữ hoàn toàn ──
        ...
        // ── Viết block [Dẫn Truyện] ──
        txtLines.push('[Dẫn Truyện]');
        txtLines.push('startTime: ' + entry.startTime.toFixed(3) + 's');
        txtLines.push('→ duration: ' + entry.duration.toFixed(3) + 's →');
        txtLines.push('[IMAGE PROMPT: CHƯA TẠO]');
        txtLines.push('[FILE: ' + fileName + ']');
        txtLines.push(entry.text);
        txtLines.push('');
    }

    // ── Footer ──
    txtLines.push('=== TỔNG THỜI LƯỢNG: ' + runningTime.toFixed(3) + 's ===');
    ...
    link.href     = url;
    link.download = 'ImagePrompt_' + safeTaskId + '.txt';
    ...
    console.log('✅ Đã xuất 1 file TXT Universal: ImagePrompt_' + safeTaskId + '.txt');
}
