...
async function exportTimestampTxtFiles(timestampLog, runningTime, taskId) {
    ...
    SEP80,
    '',
    'MỖI PROMPT VIẾT THEO THỨ TỰ SAU — TỐI ĐA 150 TỪ:',
'',
'  ⚠️  QUAN TRỌNG: STYLE TAGS PHẢI Ở ĐẦU TIÊN — ANIMAGINE CHỈ ĐỌC 75 TOKEN ĐẦU',
'  ⚠️  Nếu style tags ở cuối → bị cắt → ảnh ra phẳng, thiếu 3D, thiếu màu sắc',
'',
'  [1] MODEL TAG — Bắt buộc: [MODEL:animagine]',
'',
'  [2] STYLE + QUALITY — ĐẶT LÊN ĐẦU NGAY SAU MODEL TAG (20-25 từ):',
...
'',
'  [3] SUBJECT + ACTION — Chủ thể và hành động CỤ THỂ (25-35 từ):',
'      • Nhân vật: giới tính, tư thế, hành động chính',
'      • Cảnh quan: chi tiết địa hình quan trọng nhất',
'      ❌ SAI: "standing"',
'      ✅ ĐÚNG: "1male, young cultivator, right arm extended gripping sword,',
'               lunging forward in battle-ready stance"',
'',
'  [4] APPEARANCE — CHỈ 5 ĐIỂM CỐT LÕI (20-25 từ):',
'      (1) Tóc: màu + kiểu tóc',
'      (2) Mắt: màu + biểu cảm',
'      (3) Trang phục: màu chính + 2 chi tiết nổi bật nhất',
'      (4) Vũ khí / đạo cụ đặc trưng',
'      (5) Đặc điểm nhận diện (scar/birthmark nếu có)',
'',
'  [5] SETTING — Bối cảnh (15-20 từ):',
'      Địa điểm + thời gian + 2 chi tiết môi trường quan trọng nhất',
'',
'  [6] LIGHTING — BẮT BUỘC 25-30 TỪ (CÔNG THỨC 4 BƯỚC):',
'      B1 nguồn: golden sunlight / moonlight / magical energy',
'      B2 hướng: from behind and above / from right side / from below',
'      B3 hiệu ứng: volumetric god rays / rim lighting / deep shadows',
'      B4 màu: warm amber highlights against cool blue shadows',
'',
'  [7] COMPOSITION — Góc máy (10-15 từ):',
'      [góc máy] shot, subject [vị trí frame], dramatic depth of field',
'',
'  [8] PARTICLE FX — Hiệu ứng (8-10 từ):',
'      glowing spirit particles / embers / motion blur / mist',
'',
'  [9] NO TEXT — Bắt buộc cuối prompt (cố định):',
'      NO text, NO watermark, NO logo, NO signature, pure illustration only',
'',
'  ══ TỔNG CỘNG KHÔNG VƯỢT QUÁ 150 TỪ ══',
'  ══ STYLE TAGS [2] LUÔN Ở ĐẦU — KHÔNG BAO GIỜ Ở CUỐI ══',
    '',
    SEP80,
    ...
    '',
    SEP80,
    'PHẦN 3 — VÍ DỤ MẪU ANIMAGINE 3D STYLE (~ 130 TỪ)',
    SEP80,
    '',
    SEP50,
'VÍ DỤ 1: TIÊN HIỆP TU LUYỆN — 130 từ — STYLE TAGS Ở ĐẦU',
SEP50,
'',
'[IMAGE PROMPT: [MODEL:animagine]',
'masterpiece, best quality, ultra-detailed, Chinese xianxia CG art style,',
'3D render style, cel shading with depth, volumetric lighting,',
'subsurface scattering on skin, cinematic color grading,',
'vivid saturated colors, sharp crisp details,',
'1female celestial cultivator sitting in perfect lotus meditation posture,',
'both hands forming ethereal lotus seal mudra at chest level,',
'eyes gently closed, serene expression with slight blissful smile,',
'long silver-white hair cascading down back, ornate golden phoenix hairpins,',
'pristine white immortal robes with silver crane embroidery,',
'massive floating jade platform suspended high above sea of clouds,',
'ancient sect mountain peaks visible through layered atmospheric mist,',
'transcendent breakthrough cultivation atmosphere,',
'volumetric god rays from behind and above, divine rim light halo around figure,',
'cool blue ambient mixing with warm golden spiritual energy highlights,',
'epic wide shot from slightly below, subject centered, deep depth of field,',
'thousands of glowing cyan spirit particles floating like fireflies,',
'16:9 aspect ratio, NO text, NO watermark, NO logo, pure illustration only]',
'[NEGATIVE: lowres, flat shading, flat colors, watercolor, 2D flat art,',
'bad anatomy, bad hands, worst quality, low quality, blurry, ugly,',
'deformed face, extra limbs, dark muddy background, dull colors]',
'[FILE: scene_00000.000s.jpg]',
'',
    SEP50,
'VÍ DỤ 2: KIẾM HIỆP CHIẾN ĐẤU — 128 từ — STYLE TAGS Ở ĐẦU',
SEP50,
'',
'[IMAGE PROMPT: [MODEL:animagine]',
'masterpiece, best quality, ultra-detailed, Chinese xianxia CG art style,',
...
'subsurface scattering on skin, cinematic color grading,',
'vivid saturated colors, sharp crisp details,',
'1male young warrior completing powerful horizontal sword slash,',
'right arm extended with crescent-shaped cyan qi blade erupting from silver longsword,',
'body twisted in coiled spring combat form for perfect balance,',
'jet-black hair tied with white silk ribbon whipping in wind pressure,',
'sharp dark brown eyes blazing with battle fury,',
'white flowing hanfu with blue embroidery trim, jade pendant glowing at chest,',
'ancient stone ruins battlefield, broken marble pillars, ground cracking beneath feet,',
'high-stakes battle atmosphere,',
'intense volumetric lighting from golden sunlight through debris clouds from right side,',
'harsh rim light along entire figure edge, warm amber versus cool blue shadows,',
'extreme low angle hero shot, subject left-third frame, shallow depth of field,',
'motion blur on sword trajectory, cyan spirit particles exploding outward,',
'16:9 aspect ratio, NO text, NO watermark, NO logo, pure illustration only]',
'[NEGATIVE: lowres, flat shading, flat colors, watercolor, 2D flat art,',
'bad anatomy, bad hands, worst quality, low quality, blurry, ugly,',
'deformed face, extra limbs, dark muddy background, dull colors]',
...
'',
SEP50,
'VÍ DỤ 3: CẢNH QUAN HOÀNH TRÁNG — 125 từ — STYLE TAGS Ở ĐẦU',
SEP50,
'',
'[IMAGE PROMPT: [MODEL:animagine]',
'masterpiece, best quality, ultra-detailed, Chinese xianxia CG art style,',
'3D render style, cel shading with depth, volumetric lighting,',
'subsurface scattering, cinematic color grading,',
'vivid saturated colors, sharp crisp details,',
'breathtaking panoramic xianxia landscape,',
'hundreds of jagged jade-green mountain peaks stretching to horizon,',
'ancient sect buildings with golden rooftops perched on cliffsides,',
'massive waterfalls cascading into mist-filled chasms below,',
'glowing spiritual energy veins pulsing blue-white through mountain rock,',
'enormous dragon silhouette soaring through distant golden clouds,',
'twilight sky with twin glowing moons rising on horizon,',
'epic grand world-building atmosphere,',
'volumetric god rays from setting twin suns from behind and above,',
'warm golden-orange light on peaks, cool blue-purple shadows in valleys,',
'deep atmospheric perspective with multiple mist layers,',
'epic ultra-wide aerial shot, extreme deep depth of field,',
'thousands of golden light particles and spirit wisps throughout scene,',
'16:9 aspect ratio, NO text, NO watermark, NO logo, pure illustration only]',
'[NEGATIVE: lowres, flat shading, flat colors, watercolor, 2D flat art,',
'worst quality, low quality, blurry, dark muddy background,',
'dull colors, overexposed white sky]',
'[FILE: scene_00000.000s.jpg]',
    '',
    SEP80,
...
'masterpiece, best quality, ultra-detailed,',
'Chinese xianxia CG art style, 3D render style, cel shading with depth,',
'volumetric lighting, subsurface scattering on skin, cinematic color grading,',
'vivid saturated colors, sharp crisp details,',
'[SUBJECT+ACTION 25-35 từ: nhân vật/cảnh + hành động cụ thể],',
'[APPEARANCE 20-25 từ: tóc, mắt, trang phục, vũ khí, đặc điểm],',
'[SETTING 15-20 từ: địa điểm, thời gian, 2 chi tiết môi trường],',
'[ATMOSPHERE 8-10 từ: không khí tổng thể],',
'[LIGHTING 25-30 từ: B1-nguồn, B2-hướng, B3-hiệu ứng, B4-màu],',
'[COMPOSITION 10-15 từ: góc máy, vị trí, depth of field],',
'[PARTICLE FX 8-10 từ: hiệu ứng hạt],',
'16:9 aspect ratio, NO text, NO watermark, NO logo,',
'NO Chinese characters, NO subtitles, pure illustration only]',
'[NEGATIVE: lowres, flat shading, flat colors, watercolor, 2D flat art,',
'bad anatomy, bad hands, worst quality, low quality, blurry, ugly,',
'deformed face, extra limbs, dark muddy background, dull colors, overexposed white]',
